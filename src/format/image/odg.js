...
export class odg extends Format
{
	...
	ext        = [".odg", ".otg", ".fodg"];
	magic      = ["ZIP Format", "ZIP compressed achive", "Zip archive data", "OpenDocument Drawing Zip", "OpenDocument Graphics document", "OpenDocument Drawing Template", "OpenDocument Graphics Template", /^fmt\/(139|296|297)( |$)/];

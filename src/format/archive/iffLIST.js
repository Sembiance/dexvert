...
export class iffLIST extends Format
{
	...
	notes          = xu.trim`
		...
		Since the output IFFs from these are not useful (and it makes a LOT of them) I actually forbid that format from matching this, so it gets properly matched to video/movieSetterSet format.`;
}

...
export class ini extends Format
{
	...
	magic          = [
		...
		"Format: CloneCD Control", "blueMSX Shortcuts", "Quartus Workspace", /^Format: FST$/, "Geany theme", "Total Annihilation campaigns data", "AutoCAD LT settings", "Microsoft Media Browser config",

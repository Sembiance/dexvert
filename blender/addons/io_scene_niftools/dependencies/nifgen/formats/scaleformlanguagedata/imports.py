...
type_module_name_map = {
	...
	'ScaleformlanguagedataRoot': 'nifgen.formats.scaleformlanguagedata.compounds.ScaleformlanguagedataRoot',
	'FontInfo': 'nifgen.formats.scaleformlanguagedata.compounds.FontInfo',
}

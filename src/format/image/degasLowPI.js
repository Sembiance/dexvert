...
export class degasLowPI extends Format
{
	...
	ext       = [".pi1"];
	magic     = ["Degas (Low Resolution) :degas:"];
	...
	converters = ["recoil2png[format:PI1]", "wuimg[format:degas][hasExtMatch]", `abydosconvert[format:${this.mimeType}]`, "nconvert[format:degas]"];
}

...
export class macromediaDirector extends Program
{
	...
	osData = r => ({
		timeout : xu.HOUR*1.5,	// Some files can take a LOOONG time to extract. We stop after 1.5 hours, which allows at least some of the files to be extracted. This also prevents the possibility of it hanging forever due to a bug or something
		script : `

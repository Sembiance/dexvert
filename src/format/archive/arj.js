...
export class arj extends Format
{
	...
	ext            = [".arj", ".exe"];
	forbidExtMatch = [".exe"];
	magic          = ["ARJ compressed archive", "ARJZ compressed archive", "ARJ File Format", "ARJ archive data", "ARJ self-extracting archive", "ARJ Archiv gefunden", "Archive: ARJ", /^ARJ$/, /^fmt\/610( |$)/];

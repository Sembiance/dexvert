...
export class pict extends Format
{
	...
	mimeType       = "image/pict";
	magic          = ["QuickDraw/PICT", "Macintosh Quickdraw/PICT", "Claris clip art", "Macintosh Pict image (MacBinary)", "Mac PICT bitmap", "image/x-pict", "piped qdraw sequence (qdraw_pipe)", /^fmt\/341( |$)/, /^x-fmt\/80( |$)/];

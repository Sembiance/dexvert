...
# col3 times are from dexdrone1 Jun 14, 2024

dra testMany.js --format=executable	#     25s        25s	    27s
dra testMany.js --format=font		#  1m 25s     1m 45s	 1m 38s
dra testMany.js --format=text		#  2m  9s     1m 50s	 2m 34s
dra testMany.js --format=other		#  2m  0s     2m 36s	 3m 45s
dra testMany.js --format=video		# 15m 54s    11m 51s	12m  1s
dra testMany.js --format=poly		#     44s    16m 10s	18m 24s

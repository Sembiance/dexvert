...
export class zip extends Format
{
	...
	ext            = [".zip", ".exe"];
	magic          = ["ZIP compressed archive", "Zip archive data", "ZIP Format", /^PKZIP (mini-)?self-extracting 16bit DOS executable$/, /ZIP self-extracting archive/, "Zip multi-volume archive data", /^Zip$/, "Self-extracting zip", "ZIP Archiv gefunden", /^x-fmt\/263( |$)/];

...
export class wav extends Format
{
	...
	magic        = [/^RIFF.*WAV[Ee].*[aA]udio/, "Waveform Audio (PCMWAVEFORMAT)", "Wave Musikdatei (WAV)", "Broadcast Wave File audio", "RIFF audio data (WAV)", "Rockwell ADPCM audio", "audio/vnd.wave", /^fmt\/(6|141|142|703)( |$)/];

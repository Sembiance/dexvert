...
export class swf extends Format
{
	...
	magic          = [
		...
		"SWF (ShockWave Flash) (swf)", "Macromedia Flash SWF/Scaleform GFX Video (ZLIB compressed)", "archive:Macromedia.SwfOpener",
		/^SWF$/, /^fmt\/(104|105|106|107|108|109|110|505|506|507|757|758|759|760|761|762|763|764|766|767|768|769|770|771|774|775)( |$)/];

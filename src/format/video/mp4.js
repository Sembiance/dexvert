...
export class mp4 extends Format
{
	...
	magic            = [
		// generic
		/MP4 Base Media/, "MPEG-4 Media File", /^ISO Media.*M4V/, "ISO Media, MP4", "video/mp4", "ISO Media, MPEG v4 system", "MP4 v2 container video", /^Format: MP4 Video\[.*mp4[12]/, /^fmt\/199( |$)/,

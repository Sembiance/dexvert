...
archive | [AIN Archive](http://fileformats.archiveteam.org/wiki/AIN) | .ain | [4 sample files](https://telparia.com/fileFormatSamples/archive/ain/)
...
archive | [Amiga Disk Format (OFS)](http://fileformats.archiveteam.org/wiki/ADF_(Amiga)) | .adf | [13 sample files](https://telparia.com/fileFormatSamples/archive/adfOFS/) - Some Amiga disks (such as voyager.adf) are non DOS (NDOS) disks with custom filesystems. These cannot be mounted by the amiga nor extracted with unar/unadf/adf-extractor These are custom disk formats that demo and game coders came up with to squeeze data out of em. Sadly there isn't really any way to extract files from these disks, as they might not even have a concept of files at all.
...
archive | [Cabinet](http://fileformats.archiveteam.org/wiki/CAB2) | .cab | [9 sample files](https://telparia.com/fileFormatSamples/archive/cab/)
archive | [CD Disc Image](http://fileformats.archiveteam.org/wiki/ISO_image) | .iso .bin .hfs .ugh | [20 sample files](https://telparia.com/fileFormatSamples/archive/iso/) - Multiple CD formats are supported including: Photo CD, Video CD, Audio CD and CD-ROM (including HFS Mac filesystem support w/ resource forks). Multi-track (such as Audio and Data) are also supported.
...
archive | [Disk Image](http://fileformats.archiveteam.org/wiki/Disk_Image_Formats) | .img | [3 sample files](https://telparia.com/fileFormatSamples/archive/diskImage/)
archive | EDI Install LZS Compressed Data | $ | [6 sample files](https://telparia.com/fileFormatSamples/archive/ediInstallLZS/)
...
archive | [Genus Graphics Library Compressed Archive](http://fileformats.archiveteam.org/wiki/Genus_Graphics_Library) | .gx .gxl | [11 sample files](https://telparia.com/fileFormatSamples/archive/gxlib/)
archive | [GZip archive](http://fileformats.archiveteam.org/wiki/GZ) | .gz .gzip .z | [10 sample files](https://telparia.com/fileFormatSamples/archive/gz/)
...
archive | [InstallShield Z Archive](http://fileformats.archiveteam.org/wiki/InstallShield_Z) | .z | [10 sample files](https://telparia.com/fileFormatSamples/archive/installShieldZ/)
archive | [LBR Archive](http://fileformats.archiveteam.org/wiki/LBR) | .lbr | [6 sample files](https://telparia.com/fileFormatSamples/archive/lbr/)
...
archive | [Mac Compact Pro Archive](http://fileformats.archiveteam.org/wiki/Compact_Pro) | .cpt | [3 sample files](https://telparia.com/fileFormatSamples/archive/compactPro/)
...
archive | [NPack Archive](http://fileformats.archiveteam.org/wiki/NPack) | .$ | [10 sample files](https://telparia.com/fileFormatSamples/archive/npack/)
archive | [OS/2 Bitmap Array](http://fileformats.archiveteam.org/wiki/OS/2_Bitmap_Array) | .bga .bmp .ico | [13 sample files](https://telparia.com/fileFormatSamples/archive/os2BitmapArray/)
...
archive | [Stuffit Archive](http://fileformats.archiveteam.org/wiki/SIT) | .sit | [7 sample files](https://telparia.com/fileFormatSamples/archive/sit/)
...
audio | [Covox ADPCM Encoded Audio](https://wiki.multimedia.cx/index.php/Covox_ADPCM) | .v8 .cvx | [10 sample files](https://telparia.com/fileFormatSamples/audio/covoxADPCM/)
...
audio | [Sun Microsystems Audio File](http://fileformats.archiveteam.org/wiki/AU) | .au .snd | [12 sample files](https://telparia.com/fileFormatSamples/audio/au/)
audio | [Waveform Audio File Format](http://fileformats.archiveteam.org/wiki/WAV) | .wav | [10 sample files](https://telparia.com/fileFormatSamples/audio/wav/)
...
document | [Cardfile Document](http://fileformats.archiveteam.org/wiki/Cardfile) | .crd | [11 sample files](https://telparia.com/fileFormatSamples/document/cardfile/)
document | dBASE Multiple Index | .mdx | [4 sample files](https://telparia.com/fileFormatSamples/document/dBASEMultipleIndex/)
document | [dBase/FoxBase/XBase Database File](http://fileformats.archiveteam.org/wiki/DBF) | .dbf | [11 sample files](https://telparia.com/fileFormatSamples/document/dbf/)
...
document | [Excel Spreadsheet](http://fileformats.archiveteam.org/wiki/XLS) | .xls | [11 sample files](https://telparia.com/fileFormatSamples/document/xls/)
document | FrameworkDocument | .fw2 .fw3 | [6 sample files](https://telparia.com/fileFormatSamples/document/frameworkDocument/)
document | [Help Librarian Help File](http://fileformats.archiveteam.org/wiki/Help_Librarian) | .hlp | [10 sample files](https://telparia.com/fileFormatSamples/document/helpLibrarian/)
...
document | [IBM Storyboard Text Maker Document](https://winworldpc.com/product/ibm-storyboard/) | .txm | [8 sample files](https://telparia.com/fileFormatSamples/document/ibmStoryboardDocument/) - Storboard 1.0.1 text maker can open these, but I didn't see any way to convert them to TXT nor 'print' them. So we just use strings which is pretty good at getting the text out.
...
document | [Macintosh Word Document](http://fileformats.archiveteam.org/wiki/Microsoft_Word_for_Macintosh) |  | [6 sample files](https://telparia.com/fileFormatSamples/document/wordMac/)
document | MicroHelp | .slb | [8 sample files](https://telparia.com/fileFormatSamples/document/microHelp/)
document | [Norton Guide](https://en.wikipedia.org/wiki/Norton_Guides) | .ng | [3 sample files](https://telparia.com/fileFormatSamples/document/nortonGuide/)
...
document | [PageStream Document](https://en.wikipedia.org/wiki/PageStream) | .pgs | [19 sample files](https://telparia.com/fileFormatSamples/document/pageStreamDocument/)
...
document | PC-Type Document | .pct | [4 sample files](https://telparia.com/fileFormatSamples/document/pcTypeDocument/)
...
executable | Superbase Program | .sbp | [6 sample files](https://telparia.com/fileFormatSamples/executable/superbaseProgram/)
...
font | [Amiga Bitmap Font](http://fileformats.archiveteam.org/wiki/Amiga_bitmap_font) | .font | [30 sample files](https://telparia.com/fileFormatSamples/font/amigaBitmapFont/)
font | Atari FontMaker | .fn2 .fnt .fn8 | [10 sample files](https://telparia.com/fileFormatSamples/font/fn2/)
...
font | [TrueType Font](http://fileformats.archiveteam.org/wiki/TTF) | .ttf | [15 sample files](https://telparia.com/fileFormatSamples/font/ttf/)
...
image | [Art Director](http://fileformats.archiveteam.org/wiki/Art_Director) | .art | [10 sample files](https://telparia.com/fileFormatSamples/image/artDirector/)
...
image | [AutoCAD Drawing](http://fileformats.archiveteam.org/wiki/DWG) | .dwg .dwt | [12 sample files](https://telparia.com/fileFormatSamples/image/dwg/)
...
image | [Computer Graphics Metafile](http://fileformats.archiveteam.org/wiki/CGM) | .cgm | [11 sample files](https://telparia.com/fileFormatSamples/image/cgm/) - Test file input.cgm fails to convert
...
image | [CorelDraw Document](http://fileformats.archiveteam.org/wiki/CorelDRAW) | .cdr .cdt .cdx .cpx | [14 sample files](https://telparia.com/fileFormatSamples/image/cdr/)
...
image | [Dali](http://fileformats.archiveteam.org/wiki/Dali) | .sd0 .sd1 .sd2 .hpk .lpk .mpk | [14 sample files](https://telparia.com/fileFormatSamples/image/dali/)
...
image | [Degas High Resolution Picture](http://fileformats.archiveteam.org/wiki/DEGAS_image) | .pc3 | [14 sample files](https://telparia.com/fileFormatSamples/image/degasHi/)
image | [Degas High Resolution Picture (PI)](http://fileformats.archiveteam.org/wiki/DEGAS_image) | .pi3 .suh | [12 sample files](https://telparia.com/fileFormatSamples/image/degasHiPI/)
image | [Degas Low Resolution Picture](http://fileformats.archiveteam.org/wiki/DEGAS_image) | .pc1 | [20 sample files](https://telparia.com/fileFormatSamples/image/degasLow/)
image | [Degas Low Resolution Picture (PI)](http://fileformats.archiveteam.org/wiki/DEGAS_image) | .pi1 | [15 sample files](https://telparia.com/fileFormatSamples/image/degasLowPI/)
...
image | [Degas Medium Resolution Picture (PI)](http://fileformats.archiveteam.org/wiki/DEGAS_image) | .pi2 | [13 sample files](https://telparia.com/fileFormatSamples/image/degasMedPI/)
...
image | [Dr. Halo](http://fileformats.archiveteam.org/wiki/Dr._Halo) | .cut .pal .pic | [7 sample files](https://telparia.com/fileFormatSamples/image/drHalo/)
...
image | [Encapsulated PostScript](http://fileformats.archiveteam.org/wiki/EPS) | .eps .epsf .epsi .epi .ept | [10 sample files](https://telparia.com/fileFormatSamples/image/eps/) - Sometimes it's a vector based image, sometimes not. Haven't determined a way to differeentiate. So we just convert to PNG with nconvert and also to SVG with inkscape.
...
image | [Falcon True Color](http://fileformats.archiveteam.org/wiki/Falcon_True_Color) | .ftc | [14 sample files](https://telparia.com/fileFormatSamples/image/ftc/)
...
image | [FastCAD](https://fastcad2.com/) | .fcd | [5 sample files](https://telparia.com/fileFormatSamples/image/fastCAD/)
...
image | [FLI Profi](http://fileformats.archiveteam.org/wiki/FLI_Profi) | .fpr .flp | [1 sample file](https://telparia.com/fileFormatSamples/image/fpr/)
...
image | [GEM-View Dither](https://www.atariuptodate.de/en/768/gem-view) | .dit | [5 sample files](https://telparia.com/fileFormatSamples/image/gemViewDither/)
...
image | [Graphic Workship Thumbnail](http://fileformats.archiveteam.org/wiki/Graphic_Workshop_Thumbnail) | .thn | [6 sample files](https://telparia.com/fileFormatSamples/image/graphicWorkshopThumbnail/)
...
image | [IFF Interleaved Bitmap Image](http://fileformats.archiveteam.org/wiki/ILBM) | .lbm .ilbm .iff .beam .dhr .dr .mp .dctv | [62 sample files](https://telparia.com/fileFormatSamples/image/iffILBM/) - Some ILBM files were only used to hold a palette and nothing more. This won't convert those. Others have EMPTY (zeros) CMAP palettes which confuse the converter programs. So I detect this and remove the CMAP entry which allows the converters to fallback to a default converter. DPPS chunk - Present in some files and they don't convert correctly. Probably a 'Deluxe Paint' chunk of some sort. CRNG chunk - Used for color shifting. Abydos supports some of these (used by Deluxe Paint)
...
image | [Kisekae Set System Cell](http://fileformats.archiveteam.org/wiki/KiSS_CEL) | .cel .kcf | [6 sample files](https://telparia.com/fileFormatSamples/image/kissCel/)
...
image | [LEADTools Compressed Image](http://fileformats.archiveteam.org/wiki/CMP) | .cmp | [7 sample files](https://telparia.com/fileFormatSamples/image/cmp/)
...
image | [Microsoft Windows Metafile](http://fileformats.archiveteam.org/wiki/WMF) | .wmf .apm .wmz | [14 sample files](https://telparia.com/fileFormatSamples/image/wmf/) - This is a vector format, but 'convert' doesn't support exporting it to svg. So if uniconvertor fails, we'll just get a PNG out instead of an SVG.
...
image | [Multi-Page PCX](http://fileformats.archiveteam.org/wiki/DCX) | .dcx | [4 sample files](https://telparia.com/fileFormatSamples/image/dcx/)
...
image | [NeoDesk Icon](http://fileformats.archiveteam.org/wiki/NeoDesk_icon) | .nic | [34 sample files](https://telparia.com/fileFormatSamples/image/neoDeskIcon/)
...
image | [OS/2 Icon File](http://fileformats.archiveteam.org/wiki/OS/2_Icon) | .ico | [11 sample files](https://telparia.com/fileFormatSamples/image/icoOS2/)
...
image | [PaintPro](http://fileformats.archiveteam.org/wiki/PaintPro) | .pic | [12 sample files](https://telparia.com/fileFormatSamples/image/paintPro/)
...
image | [Planetary Data System](http://fileformats.archiveteam.org/wiki/PDS) | .imq .img .pds | [10 sample files](https://telparia.com/fileFormatSamples/image/pds/)
...
image | [Portable Bitmap](http://fileformats.archiveteam.org/wiki/PBM) | .pbm | [8 sample files](https://telparia.com/fileFormatSamples/image/pbm/)
...
image | [Portable Pixmap](http://fileformats.archiveteam.org/wiki/Netpbm_formats) | .ppm | [5 sample files](https://telparia.com/fileFormatSamples/image/ppm/)
...
image | [PostScript](http://fileformats.archiveteam.org/wiki/Postscript) | .ps | [12 sample files](https://telparia.com/fileFormatSamples/image/ps/)
...
image | [PrintMaster Shape](http://fileformats.archiveteam.org/wiki/PrintMaster) | .shp | [12 sample files](https://telparia.com/fileFormatSamples/image/printMasterShape/)
...
image | [Public  Painter](http://fileformats.archiveteam.org/wiki/Public_Painter) | .cmp | [7 sample files](https://telparia.com/fileFormatSamples/image/publicPainter/)
...
image | [QuickBasic BSAVE Image](http://fileformats.archiveteam.org/wiki/BSAVE_Image) | .art .pic .scn .bsv .cgx .pix .dat .pkx | [10 sample files](https://telparia.com/fileFormatSamples/image/bsave/)
...
image | [RUN Paint](http://fileformats.archiveteam.org/wiki/RUN_Paint) | .rpm .rph .rpo | [5 sample files](https://telparia.com/fileFormatSamples/image/runPaint/)
...
image | [SGX Graphics File Format](http://fileformats.archiveteam.org/wiki/SGX) | .sgx .svg | [3 sample files](https://telparia.com/fileFormatSamples/image/sgx/) - Some image files are not yet supported such as testimg-lz77.sgx
...
image | [Spectrum 512 Compressed](http://fileformats.archiveteam.org/wiki/Spectrum_512_formats) | .spc | [10 sample files](https://telparia.com/fileFormatSamples/image/spectrum512C/)
image | [Spectrum 512 Extended](http://fileformats.archiveteam.org/wiki/Spectrum_512_formats) | .spx | [5 sample files](https://telparia.com/fileFormatSamples/image/spectrum512X/)
...
image | [Spectrum 512 Uncompressed](http://fileformats.archiveteam.org/wiki/Spectrum_512_formats) | .spu | [5 sample files](https://telparia.com/fileFormatSamples/image/spectrum512U/)
...
image | [STAD PAC](http://fileformats.archiveteam.org/wiki/STAD_PAC) | .pac .seq | [11 sample files](https://telparia.com/fileFormatSamples/image/stadPAC/)
...
image | [STOS Memory Bank](http://fileformats.archiveteam.org/wiki/STOS_memory_bank) | .mbk .mbs | [10 sample files](https://telparia.com/fileFormatSamples/image/stosBank/)
image | [STOS Picture Packer](http://fileformats.archiveteam.org/wiki/Picture_Packer) | .pp3 | [4 sample files](https://telparia.com/fileFormatSamples/image/picturePackerHiRes/)
image | [STOS Picture Packer](http://fileformats.archiveteam.org/wiki/Picture_Packer) | .pp1 | [11 sample files](https://telparia.com/fileFormatSamples/image/picturePackerLowRes/)
image | [STOS Picture Packer](http://fileformats.archiveteam.org/wiki/Picture_Packer) | .pp2 | [6 sample files](https://telparia.com/fileFormatSamples/image/picturePackerMedRes/)
...
image | [Tagged Image File Format](http://fileformats.archiveteam.org/wiki/TIFF) | .tif .tiff | [26 sample files](https://telparia.com/fileFormatSamples/image/tiff/)
...
image | [True Colour Sprites](http://fileformats.archiveteam.org/wiki/Spooky_Sprites) | .trs | [4 sample files](https://telparia.com/fileFormatSamples/image/trs/)
...
image | [Windows Clipboard](http://fileformats.archiveteam.org/wiki/Windows_clipboard) | .clp | 
...
image | [XGA](http://fileformats.archiveteam.org/wiki/XGA_(Falcon)) | .xga | [6 sample files](https://telparia.com/fileFormatSamples/image/xga/)
...
image | [Zoner Zebra](http://fileformats.archiveteam.org/wiki/ZBR_(Zoner_Zebra)) | .zbr | [5 sample files](https://telparia.com/fileFormatSamples/image/zbr/) - recConverter is the only program I know of that can convert to SVG but it fails to do so with QEMU WinXP 32bit (used to work in wine). So for now, we just convert to PNG.
...
music | [Extended MIDI](http://fileformats.archiveteam.org/wiki/XMI_(Extended_MIDI)) | .xmi | [8 sample files](https://telparia.com/fileFormatSamples/music/xmi/)
...
music | [Human Machine Interfaces MIDI Format](http://fileformats.archiveteam.org/wiki/HMI) | .hmi .hmp | [3 sample files](https://telparia.com/fileFormatSamples/music/hmi/)
music | [MIDI Music File](http://fileformats.archiveteam.org/wiki/MIDI) | .mid | [11 sample files](https://telparia.com/fileFormatSamples/music/mid/) - Default instrument library used is 'eaw'. Others available: fluid, roland, creative, freepats, windows
...
other | MS Visual FoxPro App | .app .fxp | [7 sample files](https://telparia.com/fileFormatSamples/other/msVisualFoxProApp/)
...
other | [PrintMaster Shape Names](http://fileformats.archiveteam.org/wiki/PrintMaster) | .sdr | [12 sample files](https://telparia.com/fileFormatSamples/other/printMasterShapeNames/)
other | QuickBASIC Tokenized Source | .bas | [4 sample files](https://telparia.com/fileFormatSamples/other/quickBasicTokenizedSource/)
other | Turbo Basic Chain module | .tbc | [10 sample files](https://telparia.com/fileFormatSamples/other/turboBASICChainModule/)
...
other | [Visual Basic Project](http://fileformats.archiveteam.org/wiki/Visual_Basic_project_file) | .mak | [11 sample files](https://telparia.com/fileFormatSamples/other/visualBasicProject/)
other | Windows Program Group | .grp | [10 sample files](https://telparia.com/fileFormatSamples/other/windowsProgramGroup/)
...
text | [Makefile](http://fileformats.archiveteam.org/wiki/Makefile) | .mak .mk | [11 sample files](https://telparia.com/fileFormatSamples/text/Makefile/)
...
text | [PGP Public Key](http://fileformats.archiveteam.org/wiki/PGP_public_key) | .asc .aexpk .pgp .pub | [2 sample files](https://telparia.com/fileFormatSamples/text/pgpPublicKey/)
...
text | [Text File](http://fileformats.archiveteam.org/wiki/Text) |  | [13 sample files](https://telparia.com/fileFormatSamples/text/txtByFilename/)
...
video | [Apple QuickTime movie](http://fileformats.archiveteam.org/wiki/MOV) | .mov | [11 sample files](https://telparia.com/fileFormatSamples/video/mov/)
video | [Audio Video Interleaved Video](http://fileformats.archiveteam.org/wiki/AVI) | .avi | [6 sample files](https://telparia.com/fileFormatSamples/video/avi/)

...
export default
{
	archive :
	{
		...
		wordPerfectInstallArchive    : {name : "WordPerfect install archive", magic : ["WordPerfect compressed install archive (Win)"]},
	...
	document :
	{
		...
		amigaBaseDB             : {name : "AmigaBase Database", magic : ["AmigaBase data base (v2.x)"]},
	...
	other :
	{
		...
		mcAfeeVirusScanData             : {name : "McAfee VirusScan data", ext : [".dat"], magic : ["McAfee VirusScan data (generic)"]},

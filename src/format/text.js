...
export default
{
	text :
	{
		...
		visualBasicProjectGeneric                : {name : "VisualBasic Project (Generic)", ext : [".vbp"], magic : [/^VisualBasic Project \(v4\.x|ActiveX DLL|Controll|EXE|generic\)/, /^fmt\/1573( |$)/], weakMagic : true},

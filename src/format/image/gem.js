...
export class gem extends Format
{
	...
	magic    = ["GEM bitmap", "GEM HYPERPAINT Image data", "GEM Image data", "Extended GEM bitmap", /^GEM .{4} Image data/, /^x-fmt\/159( |$)/];
	...
	converters = ["recoil2png", `abydosconvert[format:${this.mimeType}]`, "deark", "nconvert", "hiJaakExpress[strongMatch]", "pv[strongMatch]", "corelPhotoPaint[strongMatch]"];
}

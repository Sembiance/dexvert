...
export class mka extends Format
{
	...
	ext              = [".mka"];
	magic            = ["Matroska Video stream", "Matroska data", "EBML file, creator matroska", "Extensible Binary Meta Language / Matroska stream", "application/x-matroska", "Matroska / WebM (matroska,webm)", "deark: ebml", /^fmt\/569( |$)/];

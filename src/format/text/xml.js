...
const _XML_MAGIC = [
	...
	"Mac OS installable Keyboard Layout", "QuarkXPress Color Library UI specs", "Nmap scan results (XML)", "PAM Dataset", "Havok XML format", "Maple XML Worksheet", "Okteta grammar (XML)", "Code::Blocks wxSmith resource",

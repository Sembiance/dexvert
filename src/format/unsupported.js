...
export default
{
	...
	document :
	{
		...
		persuasionPresentation            : {name : "Persuasion presentation", ext : [".at3", ".at4", ".pr3", ".pn4"], magic : [/^Persuasion Presentation \((Mac|Win)\)/, /^fmt\/1707( |$)/], weakMagic : true},
	...
	other :
	{
		...
		freelanceGraphicsSmartmaster             : {name : "Freelance Graphics Smartmaster", ext : [".mas", ".pre"], magic : ["Freelance Graphics Smartmaster"]},

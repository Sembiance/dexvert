...
export class jpg extends Format
{
	...
	mimeType         = "image/jpeg";
	magic            = ["JFIF JPEG bitmap", "JPEG image data", "JPEG bitmap", "JPEG File Interchange Format", "JFIF-EXIF JPEG Bitmap", "Macintosh JPEG bitmap (MacBinary)", "HSI JPEG bitmap", /^fmt\/(41|42|43|44)( |$)/];
	...
	converters       = dexState =>
	{
		...
		// some jpgs are corrupt (image5.jpg, mpfeif07.jpg, ring_mo4.jpg) but these programs can handle it
		r.push("imageAlchemy", "pv[matchType:magic]", "photoDraw");
		return r;
	};
}

...
export default
{
	...
	executable :
	{
		...
		elf                                  : {name : "ELF Executable", magic : ["ELF Executable and Linkable format", /^ELF,? \d\d-bit [LM]SB (MIPS-II?I? )?(\*unknown arch[^*]+\*)?(executable|relocatable|shared object)/, "Executable and Linkable Format", /^Unix\/Linux \d+-Bit/, /^fmt\/(688|689|690)( |$)/]},

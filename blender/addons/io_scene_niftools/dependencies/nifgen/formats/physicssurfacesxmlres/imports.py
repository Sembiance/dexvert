...
type_module_name_map = {
	...
	'PhysicsSurfaceXMLResRoot': 'nifgen.formats.physicssurfacesxmlres.compounds.PhysicsSurfaceXMLResRoot',
	'SurfacePhysicsInfo': 'nifgen.formats.physicssurfacesxmlres.compounds.SurfacePhysicsInfo',
	'EmptyStruct': 'nifgen.formats.physicssurfacesxmlres.compounds.EmptyStruct',
}

...
export class fileMakerPro extends Format
{
	...
	ext            = [".fp3"];
	forbidExtMatch = true;
	magic          = ["FileMaker Pro 3 database", "Filemaker Pro (generic)", "FileMaker Pro database", "FileMaker Pro 1 database", /^x-fmt\/(318|319)( |$)/, /^fmt\/(194|1059|1072|1237)( |$)/];
	idMeta         = ({macFileType, macFileCreator}) => ["FMP3", "FMP5", "FMP7"].includes(macFileType) ||

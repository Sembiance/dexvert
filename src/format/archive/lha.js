...
export class lha extends Format
{
	...
	magic = ["LHARC/LZARK compressed archive", /^LHa .*archive data/, "LHA File Format", "LHARK compressed archive", "LHA self-extracting", "LHarc self-extracting archive", "LZH Archiv gefunden", /^LHarc .*archive data/, "LArc compressed archive", /^Self-extracting LZH$/, /^LZH$/, /^fmt\/626( |$)/];
	...
	converters = ["lha", "sevenZip", "deark[module:lha][opt:lha:lhark]", "deark[module:car_lha] -> lha", "deark[module:lharc_sfx_com]", "unar", "sqc", "UniExtract[matchType:magic]", "izArc", "lhark", "uaeunp"];
}

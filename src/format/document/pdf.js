...
export class pdf extends Format
{
	...
	magic        = [
		"Adobe Portable Document Format", "PDF document", "Adobe Portable Document (PDF) Datei", "Format: PDF", "application/pdf", /^PDF$/, /Acrobat PDF.* Portable Document Format$/, "Portable Document Format :pdf:",

...
export class dll extends Format
{
	...
	ext          = [".dll"];
	forbiddenExt = [".exe"];
	magic        = ["Win32 Dynamic Link Library", "PE32 executable (DLL)", "PE32+ executable (DLL)", "MS-DOS executable, NE for MS Windows 3.x (DLL or font)", "PE Unknown PE signature 0 (DLL)"];

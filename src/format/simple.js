...
export default
{
	document :
	{
		...
		dacEasyWordDocument      : {name : "Dac-Easy Word Document", ext : [".doc"], magic : ["Dac-Easy Word Document"], weakMagic : true},
		...
		dBaseMultipleIndex       : {name : "dBase Multiple Index", ext : [".mdx"], magic : ["dBASE IV Multiple index", "FoxBase MDX"], weakMagic : true, idMeta : ({macFileType, macFileCreator}) => macFileType==="dNDX" && macFileCreator==="dBAS"},
		...
		epocDatabase             : {name : "EPOC Database", magic : ["Psion Series 5 database Data file", "EPOC Data database", /^Psion Series 5 database Address book/]},
		...
		instaCalcSpreadsheet     : {name : "InstaCalc spreadsheet", ext : [".ins"], magic : ["InstaCalc spreadsheet"], weakMagic : true},
		...
		oberonDocument           : {name : "Oberon Document", ext : [".odc"], magic : ["Oberon/F Document"], idMeta : ({macFileType, macFileCreator}) => macFileType==="oODC" && ["armc", "obnF"].includes(macFileCreator)},
		oberonText               : {name : "Oberon Text", ext : [".mod"], magic : ["Oberon V4 text format"], idMeta : ({macFileType, macFileCreator}) => macFileType===".Ob." && [".Ob2", ".Ob3", ".Ob4", ".Ob5", ".Ob6", ".Ob*"].includes(macFileCreator)},
		...
		palmJFileProDatabase     : {name : "Palm JFile Pro database", ext : [".pdb"], magic : ["Palm JFile Pro database", /^JFile Pro PalmOS document/], idMeta : ({macFileType, macFileCreator}) => macFileType==="JFL4" && macFileCreator==="Ko05"},
		...
		rapidFileMemo            : {name : "RapidFile Memo", ext : [".mmo"], magic : ["RapidFile Memo"], weakMagic : true},
		...
		textEngine               : {name : "Text Engine Document", ext : [".std"], magic : ["TextEngine document (generic)", /^TextEngine document \(v[45]/]},
		...
		theWorksSpreadsheet      : {name : "The Works! Spreadsheet", ext : [".sht"], magic : ["The Works! Spreadsheet", "Analyze! Spreadsheet"]},
		...
		varsityScripsitDocument  : {name : "Varsity Scripsit Document", ext : [".doc"], magic : ["Varsity Scripsit Document"], weakMagic : true},
	...
	other :
	{
		...
		atariSTGuideHypertext            : {name : "Atari ST Guide Hypertext", ext : [".hyp"], magic : ["Atari ST Guide Hypertext document", "Atari ST Guide Hypertext", /^ST-Guide file/]},
		atariSTGuideREF                  : {name : "Atari ST Guide REF Links", ext : [".ref"], magic : ["Atari ST Guide ref links", /^ST-Guide reference file/]},
		...
		corelPlanPerfect                 : {name : "Corel Plan Perfect", ext : [".pln"], magic : ["Corel Plan Perfect", "PlanPerfect spreadsheet", "WordPerfect Executive / PlanPefect Spreadsheet"]},
		...
		desqviewXHelp                    : {name : "DESQview/X Help", ext : [".hlp"], magic : ["DESQview/X Help"], weakMagic : true},
		...
		jazzJackrabbit2LanguageStrings   : {name : "Jazz Jackrabbit 2 language Strings", ext : [".j2s"], magic : ["Jazz Jackrabbit 2 language Strings"], weakMagic : true},
		lapLinkHelp                      : {name : "LapLink Help", ext : [".hlp"], magic : ["LapLink Editor Help", "LapLink Pro 4 Help", "LapLink 5 Help"]},
		...
		msVisualFoxProApp                : {name : "MS Visual FoxPro App", ext : [".app", ".fxp"], magic : ["Generated application MS Visual FoxPro 7"], idMeta : ({macFileType, macFileCreator}) => ["FAPP", "FFXP", "FQPX", "FSPX"].includes(macFileType) && macFileCreator==="FOXX"},
		...
		showPartnerAnimatorHelp          : {name : "Show Partner Animator Help", ext : [".hlp"], magic : ["Show Partner Animator Help"], weakMagic : true},
		...
		sybaseIAnywhereIndex             : {name : "Sybase iAnywhere Index", ext : [".cdx"], magic : ["Sybase iAnywhere index files", "xBase compound index"], idMeta : ({macFileType, macFileCreator}) => macFileType==="FCDX" && macFileCreator==="FOXX"},
		...
		tmtPascalHelpSystem              : {name : "TMT Pascal Help System", ext : [".hdx"], magic : ["TMT Pascal Help System"], weakMagic : true},

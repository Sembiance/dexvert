...
export class interpaint extends Format
{
	...
	weakMagic      = true;
	converters     = ["recoil2png[format:IPT,IPH,HRE,LRE]", "nconvert[format:ciph]", "nconvert[format:cipt]", "view64"];	// abydos also supports, but has different mime types per sub-format
}

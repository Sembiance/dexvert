...
export class quarkXPress extends Format
{
	...
	safeExt    = "";
	magic      = ["Quark XPress document", "QuarkXpress project", "QuarkXPress Tags", "Intel Quark Express Document", /Quark Express Document/, /^fmt\/(650|1317|1318|1319|1323|1325|1442|1443|1444)( |$)/];

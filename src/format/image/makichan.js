...
export class makichan extends Format
{
	...
	converters     = ["recoil2png[format:MAX.Mag,MAG,MKI]", "wuimg[format:mag]", "wuimg[format:maki]", "deark[module:makichan]", "nconvert[format:mag]"];		// deark & wuimg gets some dimensions wrong but nconvert messes up the output a good bit

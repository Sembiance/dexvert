...
type_module_name_map = {
	...
	'Vector3': 'nifgen.formats.trackedridecar.compounds.Vector3',
	...
	'TrackedRideCarRoot': 'nifgen.formats.trackedridecar.compounds.TrackedRideCarRoot',
	'TrackedRideCarSub': 'nifgen.formats.trackedridecar.compounds.TrackedRideCarSub',
}

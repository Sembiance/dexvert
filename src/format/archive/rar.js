...
export class rar extends Format
{
	...
	magic          = ["RAR archive data", "RAR compressed archive", "RAR Archive", "DOS RAR SFX Executable", "Installer: WinRAR Installer", "WinRAR Self Extracting archive", /RAR self-extracting archive/, /^RAR$/, /^RAR 5$/,

...
type_module_name_map = {
	...
	'Vector3': 'nifgen.formats.wsm.compounds.Vector3',
	'Vector4': 'nifgen.formats.wsm.compounds.Vector4',
	...
	'WsmHeader': 'nifgen.formats.wsm.compounds.WsmHeader',
	'Wsm': 'nifgen.formats.wsm.compounds.Wsm',
}

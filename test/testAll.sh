...
dra testMany.js --format=executable	#     25s        25s	    32s
dra testMany.js --format=text		#  2m  9s     1m 50s	 2m 31s
dra testMany.js --format=font		#  1m 25s     1m 45s	 2m 16s
dra testMany.js --format=other		#  2m  0s     2m 36s	 2m 44s

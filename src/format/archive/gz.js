...
export class gz extends Format
{
	...
	magic        = [
		// general gzip
		"gzip compressed data", "GZipped data", "gzip: Deflate", "GZip Archiv gefunden", "gzip-compressed data", "Archive: GZIP", "Gzip (Self-extracting)", "application/gzip", /^Gzip$/, "deark: gzip", /^geArchive: GZ( |$)/,
		/^idarc: (GZIP\/Comp \d\.\d|TGZ)( |$)/, /^x-fmt\/266( |$)/,

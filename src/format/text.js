...
export default
{
	text :
	{
		...
		pemCertificate                          : {name : "PEM Certificate", ext : [".cer"], magic : ["PEM certificate", "Internet Security Certificate"], website : "http://fileformats.archiveteam.org/wiki/PEM_encoded_certificate"},

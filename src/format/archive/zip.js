...
export class zip extends Format
{
	...
	magic          = [
		...
		"Midtown Madness 2 car data", "Rainlendar 2 Skin", "Rainlendar 2 Skin", "KWord document", "PowerPoint Macro-enabled Open XML add-in", "Maxthon skin (MX2)", "Total Commander language pack",
		/^fmt\/(424|524|595|627|628|633|937|942|943|999|1184)( |$)/,

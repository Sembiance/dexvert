...
export class msCompress extends Format
{
	...
	magic          = ["MS Compress archive data", "Microsoft SZDD compressed", "Microsoft KWAJ compressed", "MS DOS Compression Format", "Microsoft Compress", "MSC Archiv gefunden", "Archive: KWAJ", "Archive: SZDD", /^fmt\/(462|469)( |$)/];

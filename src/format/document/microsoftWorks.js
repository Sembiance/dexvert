...
export class microsoftWorks extends Format
{
	...
	ext                = [".wps", ".wp", ".doc", ".xlr"];
	forbidExtMatch     = true;
	magic              = ["Microsoft Works", "Microsoft Works for Mac document", "Composite Document File", "Works 4.0 for Macintosh", /^OLE 2 Compound Document.* Microsoft Works.* document/, "Microsoft Works Spreadsheet", /^fmt\/(163|166|233|258|901)( |$)/];
	weakMagicSensitive = true;	// Microsoft Works for Mac document

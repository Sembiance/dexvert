...
export class zip extends Format
{
	...
	magic          = [
		...
		"Call Of Duty map - game data archive", "Rainlendar 2 Language", "Desktop Sidebar skin", "OpenDocument Formula", "SysMetrix skin", "WindowBlinds Progress Anim theme", "Aston 2 Menu",

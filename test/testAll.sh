...
dra testMany.js --format=executable	#  1m 11s	    23s		    25s
dra testMany.js --format=poly		#     38s	    48s		    44s
dra testMany.js --format=font		#  1m 29s	 1m 22s		 1m 25s
...
dra testMany.js --format=music		# 20m 28s	24m 17s		23m 28s
dra testMany.js --format=document	# 20m 45s	26m 44s		26m 34s
dra testMany.js --format=image		# 36m 34s	36m  3s		37m 10s
dra testMany.js --format=archive	# 30m 38s	41m  5s		37m 20s

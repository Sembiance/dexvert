...
export default
{
	archive :
	{
		...
		neoLitePacked         : {name : "NeoLite Packed", magic : ["Packer: NeoLite"], notes : "Tried (see sandbox/app): RL!dePacker 1.4 & Neo-Executable-Decompressor & neolte20.zip"},
	...
	executable :
	{
		...
		atariSTExe                           : {name : "Atari ST Executable", magic : ["Atari ST TOS executable", "Atari ST M68K contiguous executable", "Atari 68xxx executable", /Atari ST .*program\/executable/, /(compressed|compiled|packed) Atari ST program/, "Atari ST M68K non-contig executable", "Format: Atari ST TOS executable"], weakMagic : ["Atari ST M68K non-contig executable"]},
	...
	other :
	{
		...
		windowsHelpSearchIndex           : {name : "Windows Help Full Text Search Index", ext : [".fts"], magic : ["Windows Help Full-Text Search index", "MS Windows help Full Text Search index"]},

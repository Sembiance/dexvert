...
const _MOV_MAGIC = ["Apple QuickTime movie", "QuickTime Movie", "Mac QuickTime video", "ISO Media, Apple QuickTime movie", "Apple QuickTime Film", /^MacBinary II.+'MooV'/, /Format: MP4 Video\[qt\s*]/, /^x-fmt\/384( |$)/];

...
export default
{
	...
	executable :
	{
		...
		proPackPackedExe                     : {name : "Pro-Pack Packed Executable", magic : ["Packer: PRO-PACK", "16bit DOS EXE RMC / PRO-PACK compressed"]},
	...
	other :
	{
		...
		linuxKernel                      : {name : "Linux Kernel", filename : [/^vmlinuz$/, /^bzImage$/], magic : [/^Linux kernel$/, /^Linux kernel .*boot executable/, /^Linux .+kernel root/, "Linux style boot sector", "Linux x86 boot sector", "Linux kernel/bootloader/tools x86 bootable", "Linux kernel from prehistoric times", "Linux kernel version 1.3.79 or older"]},
		...
		pascalCompiledUnit               : {name : "Pascal Compiled Unit", ext : [".tpu", ".ppu"], magic : ["Borland Turbo Pascal compiled Unit", "FreePascal compiled Unit", "Pascal unit", "FPK Pascal 3. Unit", /^(Borland )?Turbo Pascal [\d. ]+(compiled )?Unit/]},

...
export default
{
	text :
	{
		...
		awk                                      : {name : "AWK Script", ext : [".awk"], magic : ["a /bin/awk", "Shell Skript: '/bin/awk", /^Executable script, shebang: "(\/usr)?(\/local)?\/bin\/awk/, "text/x-nawk", "awk or perl script", /^a awk script/, /^((new|GNU) )?awk script text executable/, "application/x-awk"], weakMagic : ["awk or perl script"], website : "http://fileformats.archiveteam.org/wiki/AWK"},

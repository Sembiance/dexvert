...
export class derCertificate extends Format
{
	...
	ext            = [".cer", ".der", ".crt"];
	forbidExtMatch = true;
	magic          = ["DER encoded X509 Certificate", "Certificate, Version=3", "DER Encoded Key Pair", "Certificate in DER format", "DER Encoded Certificate request", /^DER verschl.sseltes, bin.res X\.509 Zertifikat/];

...
export class sit extends Format
{
	...
	ext        = [".sit"];
	magic      = ["StuffIt compressed archive", "Macintosh StuffIt Archive", "Mac StuffIt Self-Extracting Archive", "application/x-stuffit", /^Archive: SIT$/, /^StuffIt( \d)?$/, /^StuffIt Archive/, /^fmt\/(399|1459|1460)( |$)/];

...
type_module_name_map = {
	...
	'Ppuipkgfile': 'nifgen.formats.ppuipkg.compounds.Ppuipkgfile',
	'UserInterfaceIconData': 'nifgen.formats.ppuipkg.compounds.UserInterfaceIconData',
	'PPUIPKGRoot': 'nifgen.formats.ppuipkg.compounds.PPUIPKGRoot',
}

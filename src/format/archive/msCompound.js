...
export class msCompound extends Format
{
	...
	magic            = [
		...
		// app specific
		"Shell Scrap object", "StormFront skin", "Ulead PhotoImpact Object(s)", "Designworks Template (v3.5)", "Easy CD Creator's Jewel case", "STATISTICA Workbook", /^fmt\/1303( |$)/, /^x-fmt\/243( |$)/
	];

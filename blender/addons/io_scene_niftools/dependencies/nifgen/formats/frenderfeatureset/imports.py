...
type_module_name_map = {
	...
	'FRenderFeatureSetRoot': 'nifgen.formats.frenderfeatureset.compounds.FRenderFeatureSetRoot',
	'FeatureSetItem': 'nifgen.formats.frenderfeatureset.compounds.FeatureSetItem',
}

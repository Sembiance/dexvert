...
export class zip extends Format
{
	...
	magic          = [
		...
		"Chamaleon Clock wallpaper clock skin", "Google Gadget", "Proteus Project", "Amiga WHDLoad package (zipped)", "MIUI Theme", "Pencil stencil", "TwinCAT Compiled-Library", "LimeWire theme", "EncryptOnClick encrypted",

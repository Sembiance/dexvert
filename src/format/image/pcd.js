...
export class pcd extends Format
{
	...
	metaProvider = ["image"];
	converters   = ["pcdtojpeg", "convert", `abydosconvert[format:${this.mimeType}]`, "nconvert", "hiJaakExpress", "picturePublisher", "corelPhotoPaint", "canvas", "tomsViewer", "pv[matchType:magic]"];

...
export class macPaint extends Format
{
	...
	metaProvider   = ["image"];
	converters     = ["deark[module:macpaint][mac][matchType:magic]", `abydosconvert[format:${this.mimeType}]`, "convert", "hiJaakExpress", "pv[matchType:magic]", "corelPhotoPaint", "tomsViewer"];

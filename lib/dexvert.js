...
exports.process = function process(inputFilePath, outputDirPath, {tmpDirPath=os.tmpdir(), verbose=0, brute=false, keepGoing=false, alwaysBrute=false, brutePrograms=false}, cb)
{

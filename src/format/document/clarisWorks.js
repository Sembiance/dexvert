...
export class clarisWorks extends Format
{
	...
	ext            = [".cwk", ".cws"];
	forbidExtMatch = true;
	magic          = [/AppleWorks\/ClarisWorks .+Document/, "Claris Works document", "AppleWorks CWK Document", /^fmt\/(736|737|738|739|740|741|742|743|744|745|746|747|748|749|750|751|752|845|846|847|849)( |$)/];

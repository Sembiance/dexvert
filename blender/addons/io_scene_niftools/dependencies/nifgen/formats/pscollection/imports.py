...
type_module_name_map = {
	...
	'PscollectionRoot': 'nifgen.formats.pscollection.compounds.PscollectionRoot',
	'PreparedStatement': 'nifgen.formats.pscollection.compounds.PreparedStatement',
	'Arg': 'nifgen.formats.pscollection.compounds.Arg',
}

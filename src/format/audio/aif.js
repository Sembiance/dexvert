...
export class aif extends Format
{
	...
	ext          = [".aif", ".aiff", ".aff"];
	magic        = [
		"AIFF Audio Interchange File Format", "IFF data, AIFF audio", "Audio Interchange File Format", "IFF data, AIFF-C compressed audio", "AIFF audio data", "AIFF-C", "audio/x-aiff", "audio/x-aifc", "Audio IFF (aiff)", /^soxi: aiff?$/,
		/^fmt\/414( |$)/, /^x-fmt\/136( |$)/
	];

...
export class drHalo extends Format
{
	...
	converters   = ["deark[module:drhalocut]", "deark[module:drhalopic]", "convert", "recoil2png", `abydosconvert[format:${this.mimeType}]`, "hiJaakExpress", "pv"];	// pv can produce very dark, nearly black images (KLINGON.CUT)
	metaProvider = ["image"];

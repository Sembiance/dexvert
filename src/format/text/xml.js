...
const _XML_MAGIC = [
	...
	"JavaHelp TOC", "JBuilder Project", "JavaHelp map", "Wireless Markup Language", "NetBeans project Attributes", "Xcode Scheme", "Compass and Ruler Job", "OpenStreetMap XML Data", "Route 66 Landmarks", "Fritzing Bin module", "OpenRocket project (XML",
	...
	"application/x-glade", "Open Office XML Relationships", "Game Definition File", "Windows Composite Font", "WCF Configuration Snapshot", "Saved WCF Configuration Information", "application/x-drgeo", "Hydrogen Song", "BORGChat smiles",
	"Maven Project Object Model", "ADO.NET Conceptual Schema Definition Language", "ADO.NET Store Schema Definition Language", "Entity Data Model", "VisualStudio MyApp", "JetBrains solution Settings", "LandXML", "Zope Configuration Mark-up Language",
	...
	"iOS App Zip archive data", "Open Virtualization Format descriptor", "Borland Group Project", "FastReport 3 report", "XML Bookmark Exchange Language", "ttx font format", "Eclipse Extension Point Schema", "BORGChat configuration",
	...
	"Fabmetheus model format", "Qt Help Collection Project", "MusicXML", "SOAP Envelope", "Windows 7 Task Scheduler job", "GnuCash data", "GnuCash file", "AlgoBox Algorithm", "Anjuta IDE project", "ISE XReport", "UniHighlighter Highlighter definition",
	...
	"IAR Embedded Workbench Debug info", "Xilinx ISE Messages", "VMware supplemental team member configuration", "Microsoft Visual Studio project template", "PRONOM file format report", "Flex configuration", "XEphem gallery info", "XEphem lunar DB",
	...
	"Sandcastle Help File Builder Project", "Battlefield 2 mod Description", "Qt Help Project", "RoboHelp XML Project", "Rosegarden note style", "TextMate Preferences", "TextMate Project", "OmniOutliner document", "Styled Layer Descriptor",
	...
	"MiSTer Game Launcher", "XML Data Package", "SPSS Analysis Plan", "SPSS Sampling Plan", "DeleD scene", "Net2Plan Network design", "MAME software list", "Mathcad XML based worksheet", /^PowerDesigner (Conceptual )?(Model|WorkSpace)$/, "GRAMPS XML",
	"SQL Server Data Tools Database info", "VideoWave Movie Project", "Autodesk Inventor Project", "FxCop project", "EtherPeek/AiroPeek/OmniPeek capture file", /^DITA (Map|structure)/, "Traktor Settings", "NI MASCHINE template", "OpenCV XML storage",
	...
	"KAT Workspace",
	/^Ghost Recon Engine (Actor|Environment|Game Type File|Gun|Item|Kit|Mission|Projectile|sounds volume)( restriction [lL]ist)?$/,

...
export default
{
	...
	document :
	{
		...
		dbVISTADB               : {name : "db_VISTA Database", magic : [/db_VISTA (data|keys|structure)/]},
	...
	other :
	{
		...
		finalLiberationArchive       : {name : "Final Liberation: Warhammer Epic 40K game data archive", ext : [".muk"], magic : ["Final Liberation: Warhammer Epic 40K game data archive"]},
		...
		holisticDesignGameArchive    : {name : "Holistic Design game data archive", ext : [".muk"], magic : ["Holistic Design game data archive (generic)"]},
		...
		wordPerfectDictionary            : {name : "WordPerfect Disctionary", ext : [".lex"], magic : ["WordPerfect dictionary", /^Wordperfect .*rterbuch Datei$/], weakMagic : true},

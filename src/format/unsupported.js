...
export default
{
	...
	other :
	{
		...
		coreFile                             : {name : "Core File", filename : [/^core$/], weakFilename : true, ext : [".core"], magic : [/^(AIX|ELF|Linux\/i386|NetBSD|SunOS).* core file/, /^core file \(Xenix\)/, "Unix/Linux 32-Bit Core Datei"], weakMagic : true},

...
export class zip extends Format
{
	...
	magic          = [
		...
		"Aston Shell theme", "Numbers spreadsheet", "TuneUp Styler Logo Animation", "Automise Project (compressed) (gen)", "Karbon drawing", "application/x-karbon", "MSIX Windows app package",

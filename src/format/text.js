...
export default
{
	text :
	{
		...
		pgpMessage                         : {name : "PGP Message", website : "http://fileformats.archiveteam.org/wiki/PGP", magic : ["PGP signed message", "PGP clear text signed message", "PGP ASCII-Armor", "PGP message, ASCII text", "PGP armored data", "PGP signature", "PGP Nachricht", /^PGP message$/, /^PGP armored data, (signed )?message/]},
		...
		windowsURLShortcut                 : {name : "Windows URL shortcut", ext : [".url"], magic : ["Windows URL shortcut", "URL Datei", "MS Windows 95 Internet shortcut", /^fmt\/454( |$)/]},

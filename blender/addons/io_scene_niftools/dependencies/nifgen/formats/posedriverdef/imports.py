...
type_module_name_map = {
	...
	'PoseDriverDefRoot': 'nifgen.formats.posedriverdef.compounds.PoseDriverDefRoot',
	'Driver': 'nifgen.formats.posedriverdef.compounds.Driver',
	'Data': 'nifgen.formats.posedriverdef.compounds.Data',
}

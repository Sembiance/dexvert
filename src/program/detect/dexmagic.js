...
const DEXMAGIC_CHECKS = {
	...
	"Blood & Lace Compressed"            : [{offset : 0, match : "JFX1"}],
	"Blood & Lace Compressed TGA"        : [{offset : 0, match : "JGF5"}],
	"C-DILLA Packed File"                : [{offset : 0, match : [0x47, 0xF4, 0x62, 0xAF, 0xC2, 0x51, 0x05, 0xF4]}],
	...
	"Crusade VDF"                        : [{offset : 0, match : "Crusade "}],
	"Cryo Archive (BigFile variant)"     : [{offset : 0, match : "BigFile 1.00"}],
	"D.i.G demo FL2"                     : [{offset : 0, match : "FL2."}],
	"Digital Pictures FCAT"              : [{offset : 0, match : "FCAT"}],
	"Eclipse Voice Archive"              : [{offset : 0, match : "FVT"}, {offset : 5, match : "ECLIPSE"}],
	...
	"Guts'n'Garters Compressed File"     : [{offset : 0, match : [0x11, 0x11, 0x11, 0x11, 0x02, 0x00, 0x00, 0x00]}],
	"Haynes Software Sprite Archive"     : [{offset : 0, match : "Copyright (c) Haynes Software"}],
	...
	"Knowledge Adventure Archive"        : [{offset : 0, match : "KA Archive"}],
	...
	"Microsoft MediaView"                : [{offset : 0, match : [0x3F, 0x5F, 0x04]}],
	"MINICAT Archive"                    : [{offset : 0, match : "MINICAT"}],
	"MMFW Movies Archive"                : [{offset : 0, match : "MMFW Movies"}],
	"MSZP Compressed File"               : [{offset : 0, match : "mszp"}],
	"My Inno Setup Extensions Data"      : [{offset : 0, match : "My Inno Setup Extensions Setup Data"}],
	...
	"Obfuscated AVI"                     : [{offset : 0, match : [0xAD, 0xB6, 0xB9, 0xB9]}, {offset : 8, match : [0xBE, 0xA9, 0xB6, 0xDF]}],
	"Obfuscated AVI Variant 2"           : [{offset : 0, match : "FMF0"}],
	"Obfuscated AVI Variant 3"           : [{offset : 12, match : "SJGG"}, {offset : 20, match : "BWJ!"}],
	...
	"Sirtech BLAH"                       : [{offset : 0, match : "BLAH"}],
	"Softdisk for Windows Setup"         : [{offset : 0, match : [0x4D, 0x5A, 0x44, 0x01]}, {offset : 0x0080, match : [0x4E, 0x45, 0x05, 0x3C, 0x07, 0x01, 0x09, 0x00]}, {offset : 0x0128, match : [0x07, 0x49, 0x4E, 0x53, 0x54, 0x41, 0x4C, 0x4C, 0x00, 0x00, 0x0F, 0x5F, 0x5F, 0x5F, 0x45, 0x58]}],
	"Softdisk for Windows Setup (Alt 1)" : [{offset : 0, match : [0x4D, 0x5A]}, {offset : 0x47D, match : "INSTALL"}],
	"Softdisk for Windows Setup (Alt 2)" : [{offset : 0, match : [0x4D, 0x5A]}, {offset : 0x129, match : "INSTALL"}],
	...
	"Mohawk WAVE File"               : [{offset : 0, match : "MHWK"}, {offset : 8, match : "WAVE"}],
	"RedSpark Audio"                 : [{offset : 0, match : "RSD"}, {offset : 3, match : [["1", "2", "3", "4", "5", "6", "7", "8", "9", "0"]]}],
	"Sirtech NSRS Audio"             : [{offset : 0, match : "NSRS"}],
	...
	"DocBook Book"                            : [{size : 256, match : "DOCTYPE book"}],
	...
	"Flogiciels Image"                : [{offset : 0, match : "FLOGICIELS OU IMAGE"}],
	...
	"Polyray Scene"         : [{offset : 0, match : "// Polyray"}],
	"Polyray Scene (Alt0)"  : [{offset : 0, match : "// Generic Polyray"}],
	"Polyray Scene (Alt1)"  : [{offset : 0, match : "// Sample Polyray"}],
	"Polyray Scene (Alt2)"  : [{offset : 0, match : "# Polyray"}],
	"Polyray Scene (Alt3)"  : [{offset : 0, match : "# Generic Polyray"}],
	...
	"Ascaron animation"                        : [{offset : 0, match : "ANI\x09"}],
	"AVF Video (old)"                          : [{offset : 0, match : "ALG"}],
	"CRH Video"                                : [{offset : 0, match : [0x01, 0x00, 0x22, 0x56]}],
	"Crusade FPK Video"                        : [{offset : 0, match : "FPK_V1.0"}],
	"Digital Integration Q3"                   : [{offset : 0, match : "ANIM"}],
	...
	"Elige Tu Muerte FX WEAK"                  : [{offset : 0, match : "FX"}],
	...
	"Gunmetal SBV Video"                       : [{offset : 0, match : "SBV0"}],
	...
	"Knowledge Adventure MOV v2"               : [{offset : 0, match : "LzH2"}],
	"Little Big Adventure FLA Video"           : [{offset : 0, match : "V1.3"}],
	"Machine Hunter FMV Video"                 : [{offset : 0, match : "AFMV"}],
	"Microids GRN Video"                       : [{offset : 0, match : "ANIM"}],
	"Moving Puzzles Video"                     : [{offset : 4, match : [0x26, 0x00, 0x00, 0x00, 0x64, 0x68, 0x76, 0x6D]}],
	...
	"Powerslave LMF"                           : [{offset : 0, match : "LMF "}],
	...
	"Whale's Voyage II LSD"                    : [{offset : 0, match : "LSDF"}, {offset : 8, match : "GLBL"}],
	"World Fair Tales IBM WEAK"                : [{offset : 0, match : "IBM "}],

...
type_module_name_map = {
	...
	'GuestOnRideAnimSettingsRoot': 'nifgen.formats.guestonrideanimsettings.compounds.GuestOnRideAnimSettingsRoot',
	'GuestOnRideAnimSettingsChild': 'nifgen.formats.guestonrideanimsettings.compounds.GuestOnRideAnimSettingsChild',
}

...
class SizedString16(BaseStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		# The string length.
		self.length = name_type_map['Ushort'](self.context, 0, None)
	...
	def _get_attribute_list(cls):
		...
		yield 'length', name_type_map['Ushort'], (0, None), (False, None), (None, None)
		yield 'value', Array, (0, None, (None,), name_type_map['Char']), (False, None), (None, None)

	@classmethod
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		yield from super()._get_filtered_attribute_list(instance, include_abstract)
		yield 'length', name_type_map['Ushort'], (0, None), (False, None)

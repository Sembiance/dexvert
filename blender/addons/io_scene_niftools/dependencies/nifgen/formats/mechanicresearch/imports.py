...
type_module_name_map = {
	...
	'ResearchRoot': 'nifgen.formats.mechanicresearch.compounds.ResearchRoot',
	'Research': 'nifgen.formats.mechanicresearch.compounds.Research',
	'NextResearch': 'nifgen.formats.mechanicresearch.compounds.NextResearch',
}

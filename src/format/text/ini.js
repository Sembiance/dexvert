...
export class ini extends Format
{
	...
	magic          = [
		...
		"Affymetrix Chip Definition File (Text)", "CANopen Electronic Data Sheet", "Trend Micro Internet Security Tasks", "MMCDDA Audio CD track descriptor", "MinGW Developer Studio Project",

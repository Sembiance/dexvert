...
## Install
Download the 12GB <a href="${RELEASE.WEBSITE_PREFIX}/dexvert-intel-${RELEASE.VERSION}.tar.bz2">dexvert-intel-${RELEASE.VERSION}.tar.bz2</a> and extract it (42GB)
...
**A:** MANY files require auxiliary files to convert. Such as .bin/.cue, archives may be multi-part files, images may require palette files, music files may require samples/instruments, etc. There is no way to know ahead of time which other files might be needed, so all files in the input file directory are also sent to the QEMU server.

...
export default
{
	text :
	{
		...
		drumatixCompleteProject                    : {name : "Drumatix complete project", ext : [".dal"], magic : ["dal complete project"]},
		...
		pemCertificate                             : {name : "PEM Certificate/Request", ext : [".cer", ".pem"], magic : ["PEM certificate", "Internet Security Certificate", "Certificate Signing Request", "RFC1421 Security Certificate Signing Request", "application/pkix-cert+pem", /^Security Certificate$/], website : "http://fileformats.archiveteam.org/wiki/PEM_encoded_certificate"},
		pemPrivateKey                              : {name : "PEM private key/CRL", ext : [".pem"], magic : ["ASCII armored RSA Private Key", "application/x-pem-key", /^PEM ([DR]SA|EC|PKCS#?8) private key/, /^OpenSSH private key/, "OpenSSL PEM private key", /^application\/.+\+pem$/], website : "http://fileformats.archiveteam.org/wiki/PEM_encoded_RSA_private_key"},
		...
		quartusBlockDesignFile                     : {name : "Quartus Block Design File", ext : [".bdf"], magic : ["Quartus Block Design File"], weakMagic : true},
		...
		vCard                                      : {name : "vCard", website : "http://fileformats.archiveteam.org/wiki/VCard", ext : [".vcf", ".vcard"], magic : ["vCard - Business Card", "vCard visiting card", "Virtual Card Datei (VCF)", "text/vcard", /^vCard$/, /^fmt\/(395|1879|1880)( |$)/]},
		...
		visualizationToolkitFormat                 : {name : "Visualization Toolkit format", ext : [".vtk"], magic : ["Visualization Toolkit format", /^fmt\/2011( |$)/], weakMagic : true},

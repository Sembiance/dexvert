...
export class zip extends Format
{
	...
	magic          = [
		...
		"Zip archive, with extra data prepended", "End of Zip archive", /^x-fmt\/263( |$)/, "overlay: archive/zip", /^idarc: ZIP( |$)/, /^geArchive: ZIP_PK( |$)/, "archive:PkWare.ZipOpener (ZIP)",
		...
		"Installer: AutoPlay Media Studio", "Visual Studio Extension", "Spring Engine Zipped mod", "Presonus Studio One Song", "RetroPlatform Player archive", "OpenRocket project (zipped)", "eMule skin profile packages (ZIP)", "DCS Mission",
		"Creative Commons Module music", "Beyond Compare Settings Package",
	...
	converters     = () =>
	{
		...
		// If we are japanese, unar works best

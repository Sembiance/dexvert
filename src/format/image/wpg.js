...
export class wpg extends Format
{
	...
	ext          = [".wpg"];
	magic        = ["WordPerfect Graphics bitmap", "WordPerfect graphic image", "WordPerfect graphics", "Wordperfect Bild (WPG) Datei", "deark: wpg", /^fmt\/1042( |$)/, /^x-fmt\/395( |$)/];
	...
	metaProvider = ["image"];
	converters   = [
		"convert", "deark[module:wpg]", "nconvert", `abydosconvert[format:${this.mimeType}]`,

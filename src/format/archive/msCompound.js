...
export class msCompound extends Format
{
	...
	magic            = [
		...
		"Drafix Symbol Library", "WebLab Viewer Molecule", "Camtasia Studio Screen Recording", "Encrypted OLE2 / Multistream Compound File (ECP v1.0)", "Microsoft Visual Studio binary macro project",

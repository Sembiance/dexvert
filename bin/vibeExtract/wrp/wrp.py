...
def extract_wrp(input_path, output_dir):
    ...
    Produces:
      - out.adf: the reconstructed Amiga disk image (901120 bytes)
      - extra_N.bin: any non-track data blocks (if present)
    """
    ...
    for i, block in enumerate(extra_blocks):
        extra_path = output_dir / f"extra_{i}.bin"

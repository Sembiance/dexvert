...
class NiFloatsExtraData(NiExtraData):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.num_floats = name_type_map['Uint'](self.context, 0, None)
	...
	def _get_attribute_list(cls):
		...
		yield 'num_floats', name_type_map['Uint'], (0, None), (False, None), (None, None)
		yield 'data', Array, (0, None, (None,), name_type_map['Float']), (False, None), (None, None)

	@classmethod
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		yield from super()._get_filtered_attribute_list(instance, include_abstract)
		yield 'num_floats', name_type_map['Uint'], (0, None), (False, None)
		yield 'data', Array, (0, None, (instance.num_floats,), name_type_map['Float']), (False, None)

...
if(argv.delete && path.resolve(Deno.cwd())!=="/home/sembiance/Downloads")
	Deno.exit(1, xlog.error`For safety, you can only delete files automatically if ran from: /home/sembiance/Downloads`);

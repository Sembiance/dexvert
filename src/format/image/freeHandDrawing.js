...
export class freeHandDrawing extends Format
{
	...
	idMeta     = ({macFileType, macFileCreator}) => ["FH80", "FHD2", "FHD3", "FHT3"].includes(macFileType) || (["AGD1", "AGD2", "AGD3", "AGD4"].includes(macFileType) && ["FHA3", "FH40", "FH50", "FH70", "FH80", "FH90"].includes(macFileCreator));

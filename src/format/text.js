...
export default
{
	text :
	{
		...
		openSSLPEMPublicKey                      : {name : "OpenSSL PEM public key", ext : [".key", ".pem"], magic : ["OpenSSL PEM public key"], weakMagic : true},
		...
		rendermanCompiledShaderObject            : {name : "Renderman compiled Shader object", ext : [".slo"], magic : ["Renderman compiled Shader object"], idMeta : ({macFileType, macFileCreator}) => macFileType==="RSLO" && macFileCreator==="RINI"},

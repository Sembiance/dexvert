...
export class swf extends Format
{
	...
	magic          = [
		...
		/^SWF$/, /^fmt\/(104|105|106|107|108|109|110|505|506|507|757|758|759|760|761|762|763|764|766|767|768|770|771)( |$)/];
	idMeta     = ({macFileType, macFileCreator}) => (macFileType==="SWFL" && ["SWF2", "TVOD"].includes(macFileCreator)) || (macFileType==="MMCH" && macFileCreator==="MSIE");

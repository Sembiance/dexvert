...
exports.steps =
[
	(state0, p0) => p0.util.flow.serial([].pushSequence(1, (state0.input.meta.sid.subSongCount || 1)).map(sidSubTune => state => ({program : "sidplay2", stateFlags : {sidSubTune, sidSongLength : (state.input.meta.sid.songLengths || [])[(sidSubTune)-1] || "3:0"}}))),

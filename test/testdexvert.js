...
const DISK_FAMILY_FORMAT_MAP = [
	...
	[/text\/rubySource\/(action|alphafill|extconf|shape|test)\.rb$/, "text", "txt"],
	...
	[/archive\/clickTeam\/2773_4012\.exe$/, "executable", "exe"],
	[/archive\/bitRock\/removeAdAppMgr\.exe$/, "executable", "exe"],
	[/archive\/createInstall\/14_gea_verified_fallback_mademo\.exe$/, "executable", "exe"],
	[/archive\/macOSInstallTome\/(AppleVision Tome 2|Installation Tome)$/i, "archive", "macBinary"],
	[/archive\/pcInstall\/(167vr04ots\.exe|SETUP95\.EXE)$/, "executable", "exe"],

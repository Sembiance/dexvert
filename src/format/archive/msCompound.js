...
export class msCompound extends Format
{
	...
	magic            = [
		...
		"Minitab Portable Worksheet", "Windows 7 Jump List", "Microsoft RSS Feeds Store", "Combit List and Label printer setup file", "Visual Pinball Table",
		/^fmt\/(877|916|971|1213|1303|1360|1431|1432|1648|1878)( |$)/, /^x-fmt\/(151|243)( |$)/
	];

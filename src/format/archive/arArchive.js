...
export class arArchive extends Format
{
	...
	magic          = ["current ar archive", "ar archive", "Debian binary package", "Debian Linux Package", "Archive: Debian Software package", "BSD library", "Archive: The archiver", /^MIPS archive with MIPSEL members/, /^Ar$/, /^archive$/, /^fmt\/1835( |$)/];

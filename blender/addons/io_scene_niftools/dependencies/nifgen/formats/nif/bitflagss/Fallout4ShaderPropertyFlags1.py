...
class Fallout4ShaderPropertyFlags1(BasicBitfield):

	"""
	Fallout 4 Shader Property Flags 1
	"""

	__name__ = 'Fallout4ShaderPropertyFlags1'
	_storage = Uint
	SPECULAR = 2 ** 0
	SKINNED = 2 ** 1
	TEMP_REFRACTION = 2 ** 2
	...
	rgb_falloff = BitfieldMember(pos=8, mask=0x100, return_type=bool)
	cast_shadows = BitfieldMember(pos=9, mask=0x200, return_type=bool)
	face = BitfieldMember(pos=10, mask=0x400, return_type=bool)
	ui_mask_rects = BitfieldMember(pos=11, mask=0x800, return_type=bool)
	...
	skin_tint = BitfieldMember(pos=21, mask=0x200000, return_type=bool)
	...
	tessellate = BitfieldMember(pos=25, mask=0x2000000, return_type=bool)
	...
	character_lighting = BitfieldMember(pos=28, mask=0x10000000, return_type=bool)

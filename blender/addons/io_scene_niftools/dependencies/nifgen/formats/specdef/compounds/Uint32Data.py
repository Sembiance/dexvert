...
class Uint32Data(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.imin = name_type_map['Uint'](self.context, 0, None)
		self.imax = name_type_map['Uint'](self.context, 0, None)
		self.ivalue = name_type_map['Uint'](self.context, 0, None)
	...
	def _get_attribute_list(cls):
		...
		yield 'imin', name_type_map['Uint'], (0, None), (False, None), (None, None)
		yield 'imax', name_type_map['Uint'], (0, None), (False, None), (None, None)
		yield 'ivalue', name_type_map['Uint'], (0, None), (False, None), (None, None)
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		yield 'imin', name_type_map['Uint'], (0, None), (False, None)
		yield 'imax', name_type_map['Uint'], (0, None), (False, None)
		yield 'ivalue', name_type_map['Uint'], (0, None), (False, None)

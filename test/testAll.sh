...
dra testMany.js --format=music		# 20m 28s	24m 17s
dra testMany.js --format=document	# 20m 45s	26m 44s
dra testMany.js --format=archive	# 30m 38s	41m  5s
dra testMany.js --format=image		# 36m 34s	36m  3s

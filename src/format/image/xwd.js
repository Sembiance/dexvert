...
export class xwd extends Format
{
	...
	magic        = ["X-Windows screen dump", "X-Window screen dump image data", "XWD X Windows Dump image data", "piped xwd sequence (xwd_pipe)", "deark: xwd", /^fmt\/401( |$)/];
	metaProvider = ["image"];
	...
	converters = ["gimp", "iio2png", "deark[module:xwd]", "wuimg", "imconv[format:xwd][matchType:magic]", "nconvert", "ffmpeg[format:xwd_pipe][outType:png]", `abydosconvert[format:${this.mimeType}]`, "convert", "hiJaakExpress[matchType:magic][hasExtMatch]"];

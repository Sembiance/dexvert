...
export class starOfficeSpreadsheet extends Format
{
	...
	ext            = [".sdc", ".stc", ".sxc", ".vor"];
	forbidExtMatch = true;
	magic          = ["StarOffice StarCalc spreadsheet", /^OLE 2 Compound Document.* StarCalc.* spreadsheet/, "StarOffice Calc spreadsheet", "application/vnd.sun.xml.calc", /^fmt\/808( |$)/, /^x-fmt\/359( |$)/];

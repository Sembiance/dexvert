...
Deno.test("create", async () =>
{
	...
	await fileUtil.writeTextFile("/mnt/compendium/DevLab/dexvert/test/files/noSuchDir/noSuchFile.txt", "some random\ndata");
	await a.calcStats();
	assertStrictEquals(a.isFile, true);
	assertStrictEquals(a.isDirectory, false);
	assertStrictEquals(a.isSymlink, false);
...
{
	const a = await DexFile.create("/mnt/compendium/DevLab/dexvert/test/files/some.big.txt.file.txt");
	assertStrictEquals(JSON.stringify(a.serialize()), `{"root":"/mnt/compendium/DevLab/dexvert/test/files","rel":"some.big.txt.file.txt","absolute":"/mnt/compendium/DevLab/dexvert/test/files/some.big.txt.file.txt","base":"some.big.txt.file.txt","dir":"/mnt/compendium/DevLab/dexvert/test/files","name":"some.big.txt.file","ext":".txt","preExt":".some","preName":"big.txt.file.txt","isFile":true,"isDirectory":false,"isSymlink":false,"size":6,"ts":1635688339000}`);
});

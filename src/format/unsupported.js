...
export default
{
	...
	font :
	{
		...
		borlandGraphicsFont        : {name : "Borland Graphics Font", ext : [".chr", ".bgi"], magic : ["Borland font BGI Stroked Font", "BGI (Borland Graphics Interface) font", "Borland font"], website : "http://fileformats.archiveteam.org/wiki/CHR_(Borland_font)"},
	...
	other :
	{
		...
		impulseTrackerSoundDriver        : {name : "Impulse Tracker Advanced Sound Driver", ext : [".drv"], magic : ["Impulse Tracker Advanced Sound Driver"]},

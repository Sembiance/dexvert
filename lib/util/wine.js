...
exports.run = function run({cmd, args, cwd, delay=XU.SECOND*5, timeout=XU.MINUTE*2, recordVideo, autoItScript, preWineCleanup, isolate})
{
	return (state, p, cb) =>
	{
		...
		tiptoe(
			...
			function launchWine()
			{
				...
				XU.log`cmdFilePath ${cmdFilePath}`;

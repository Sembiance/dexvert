...
export class bz2 extends Format
{
	...
	ext        = [".bz2", ".bzip2"];
	packed     = true;
	magic      = ["bzip2 compressed data", "bzip2 compressed archive", "BZIP2 Compressed Archive", "bz2: bzip2", "BZ Archiv gefunden", "bzip2-compressed data", "Archive: BZip2", "application/x-bzip2", /^Bzip2$/, /^x-fmt\/268( |$)/];

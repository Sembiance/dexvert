...
export default
{
	text :
	{
		...
		windowsURLShortcut                         : {name : "Windows URL shortcut", ext : [".url"], magic : ["Windows URL shortcut", "URL Datei", "MS Windows 95 Internet shortcut", "application/x-mswinurl", /^x-fmt\/454( |$)/], idMeta : ({macFileType, macFileCreator}) => (macFileType==="AURL" && macFileCreator==="Arch") || (macFileType?.startsWith("URL") && macFileCreator==="MOSS")},

...
export default
{
	...
	other :
	{
		...
		geoWorksGEOSSoundDriver            : {name : "GeoWorks GEOS sound driver", ext : [".geo"], magic : ["GeoWorks GEOS sound driver"]},
		geoWorksGEOSVideoDriver            : {name : "GeoWorks GEOS video driver", ext : [".geo"], magic : ["GeoWorks GEOS video driver"]},

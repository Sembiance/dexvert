...
export class zip extends Format
{
	...
	magic          = [
		...
		"MindManager Brainstorm and Process Control Map", "SubEthaEdit Mode", "Moodle Backup", "PulseView sigrok dump", "Siren Jukebox Skin", "Storyist project", "Brother P-touch Editor Label", "Alice 2 World", "Kivio Flowchart",

...
export default
{
	...
	executable :
	{
		...
		elf                          : {name : "ELF Executable", magic : ["ELF Executable and Linkable format", /^ELF,? \d\d-bit [LM]SB (executable|relocatable|shared object)/, "Executable and Linkable Format", "Unix/Linux 32-Bit ausf", /^fmt\/688( |$)/]},

...
export class iso extends Format
{
	...
	magic = [
		...
		"ISO9660 file system", "UDF file system", "FM Towns bootable disk image", "Toast disk image", "BeOS BFS", "Xbox DVD file system", "deark: iso9660", "application/x-c2d", "Easy CD Creator disk image",

...
// A list of family types. Order is the order they will be matched in the case of multiple matches across categories
C.FAMILIES = ["archive", "document", "audio", "database", "3d", "font", "video", "image", "other", "executable", "rom", "text"];

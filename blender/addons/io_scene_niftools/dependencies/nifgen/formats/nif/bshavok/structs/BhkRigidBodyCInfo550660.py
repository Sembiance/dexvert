...
class BhkRigidBodyCInfo550660(BaseStruct):

	__name__ = 'bhkRigidBodyCInfo550_660'
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.unused_05 = Array(self.context, 0, None, (0,), name_type_map['Byte'])
		if set_default:
			self.set_defaults()
	...
	def _get_attribute_list(cls):
		...
		yield 'unused_01', Array, (0, None, (4,), name_type_map['Byte']), (False, None), (lambda context: context.version >= 167837696, None)
		yield 'havok_filter', name_type_map['HavokFilter'], (0, None), (False, None), (lambda context: context.version >= 167837696, None)
		yield 'unused_02', Array, (0, None, (4,), name_type_map['Byte']), (False, None), (lambda context: context.version >= 167837696, None)
		yield 'collision_response', name_type_map['HkResponseType'], (0, None), (False, name_type_map['HkResponseType'].RESPONSE_SIMPLE_CONTACT), (lambda context: context.version >= 167837696, None)
		yield 'unused_03', name_type_map['Byte'], (0, None), (False, None), (lambda context: context.version >= 167837696, None)
		yield 'process_contact_callback_delay', name_type_map['Ushort'], (0, None), (False, 65535), (lambda context: context.version >= 167837696, None)
		...
		yield 'max_linear_velocity', name_type_map['Float'], (0, None), (False, 104.4), (lambda context: context.version >= 167837696, None)
		yield 'max_angular_velocity', name_type_map['Float'], (0, None), (False, 31.57), (lambda context: context.version >= 167837696, None)
		yield 'penetration_depth', name_type_map['Float'], (0, None), (False, 0.15), (lambda context: context.version >= 167837696, None)
		...
		yield 'unused_05', Array, (0, None, (12,), name_type_map['Byte']), (False, None), (None, None)
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		yield 'unused_05', Array, (0, None, (12,), name_type_map['Byte']), (False, None)

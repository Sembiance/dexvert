...
export default
{
	...
	executable :
	{
		...
		elf                                  : {name : "ELF Executable", magic : ["ELF Executable and Linkable format", /^ELF,? \d\d-bit [LM]SB (MIPS-I )?(executable|relocatable|shared object)/, "Executable and Linkable Format", "Unix/Linux 32-Bit", /^fmt\/(688|689)( |$)/]},

...
export default
{
	archive :
	{
		...
		asPackPacked                  : {name : "ASPack Packed", magic : ["Packer: ASPack(1.00b-1.07b)"]},
	...
	executable :
	{
		...
		amigaExe                     : {name : "AmigaOS Executable", magic : ["AmigaOS loadseg()ble executable/binary", "Amiga Hunk executable", "Amiga Manx Aztec C compiled executable", /^Amiga .*(compiled|compressed) executable/]},
		...
		elf                          : {name : "ELF Executable", magic : ["ELF Executable and Linkable format", /^ELF,? \d\d-bit [LM]SB (executable|relocatable|shared object)/, "Executable and Linkable Format", "Unix/Linux 32-Bit", /^fmt\/(688|689)( |$)/]},

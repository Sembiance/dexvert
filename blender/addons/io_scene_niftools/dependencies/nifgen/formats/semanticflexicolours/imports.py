...
type_module_name_map = {
	...
	'SemanticFlexiColoursRoot': 'nifgen.formats.semanticflexicolours.compounds.SemanticFlexiColoursRoot',
	'Colourname': 'nifgen.formats.semanticflexicolours.compounds.Colourname',
}

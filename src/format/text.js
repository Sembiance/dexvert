...
export default
{
	text :
	{
		...
		hpME10Database                             : {name : "HP ME10 database", ext : [".mi"], magic : ["HP ME10 database (ASCII)"]},
		...
		pepakuraDesignerWork                       : {name : "Pepakura Designer work", ext : [".pdo"], magic : ["Pepakura Designer work"], weakMagic : true},

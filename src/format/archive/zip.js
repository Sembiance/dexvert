...
export class zip extends Format
{
	...
	magic          = [
		...
		"Theme Manager / WinStyles theme", "Adobe InDesign Markup Language", "TuneUp Style Boot Screen", "TIP Archiv gefunden (Auflistung ist deaktiviert)", /^IOS\/iPadOS IPA file/,

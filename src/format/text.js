...
export default
{
	text :
	{
		...
		linuxMakeConfig                     : {name : "Linux make config build", filename : [/^config$/i], magic : ["Linux make config build file"], weakMagic : true},
		...
		visualBasicProjectGeneric           : {name : "VisualBasic Project (Generic)", ext : [".vbp"], magic : ["VisualBasic Project (generic)", "VisualBasic Project (v4.x)"], weakMagic : true},
		...
		debBuildControl                       : {name : "DEB build control", filename : [/^control$/i], magic : ["DEB build control"], weakMagic : true},
		...
		linuxKernelSymbolMap                  : {name : "Linux kernel symbol map", filename : [/system\.map/i], ext : [".map"], magic : ["Linux kernel symbol map, ASCII text"], weakMagic : true},
		...
		magicTextFile                         : {name : "magic text file", filename : [/^magic$/i], magic : ["magic text file for file"], weakMagic : true},

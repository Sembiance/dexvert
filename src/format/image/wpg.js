...
export class wpg extends Format
{
	...
	metaProvider = ["image"];
	converters   = ["convert & convert[outType:svg]", "deark", "nconvert", `abydosconvert[format:${this.mimeType}]`, "hiJaakExpress", "corelPhotoPaint", "pv[matchType:magic]", "canvas[matchType:magic][nonRaster]"];
}

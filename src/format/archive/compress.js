...
export class compress extends Format
{
	...
	ext        = [".z", ".tz", ".taz"];
	magic      = [
		"Compress compressed data", "compress'd data", "UNIX compressed data", "Z: Compress", "COMP16 Archiv gefunden", "bar archive compress-compressed data", "Archive: Compress", "application/x-compress", /^compress-compressed/, /^Compress$/, "deark: compress",
		/^fmt\/1671( |$)/
	];

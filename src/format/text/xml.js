...
const _XML_MAGIC = [
	...
	"Windows application Manifest", "OSTA.org MusicPhotoVideo", "BlackBerry Application Loader", "Viewpoint MetaStream scene", "FlashDevelop ActionScript 3 Project", "Windows application Manifest (generic)",

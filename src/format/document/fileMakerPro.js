...
export class fileMakerPro extends Format
{
	...
	idMeta         = ({macFileType, macFileCreator}) => macFileType==="FMP3" || (macFileType==="FMPR" && macFileCreator==="FMPR") || (macFileType==="FMPJ" && macFileCreator==="FMPJ") || (macFileType==="FMK$" && macFileCreator==="FMK4");
	converters     = ["strings"];
}

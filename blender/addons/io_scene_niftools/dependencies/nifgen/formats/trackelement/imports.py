...
type_module_name_map = {
	...
	'TrackElementRoot': 'nifgen.formats.trackelement.compounds.TrackElementRoot',
	'TrackElementData': 'nifgen.formats.trackelement.compounds.TrackElementData',
	'TrackElementSub': 'nifgen.formats.trackelement.compounds.TrackElementSub',
}

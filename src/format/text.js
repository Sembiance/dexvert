...
export default
{
	text :
	{
		...
		verityCollectionIndexPendingTransaction : {name : "Verity Collection Index Pending Transaction", ext : [".trn"], magic : ["Verity Collection Index Pending Transaction"], weakMagic : true},

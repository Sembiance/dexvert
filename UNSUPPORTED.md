...
audio | [DataShow Sound File](http://www.amateur-invest.com/us_datashow.htm) | .snd | No sample files... yet.
...
image | [MLDF File](http://fileformats.archiveteam.org/wiki/MLDF) | .mld | [32 sample files](https://telparia.com/fileFormatSamples/image/mldf/) - It's probably an image format. IFF format FORM with MLDF BMHD. Could not locate any info online about it and I didn't investigate further.

...
exports.wine = () => "DirMaster/DirMaster.exe";
exports.args = (state, p) => (["--exportall", `in${state.input.ext}`]);	// eslint-disable-line no-unused-vars

exports.cwd = state => state.output.absolute;

exports.pre = (state, p, cb) => fs.symlink(state.input.absolute, path.join(state.output.absolute, `in${state.input.ext}`), cb);

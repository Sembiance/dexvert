...
type_module_name_map = {
	...
	'TexAtlasRoot': 'nifgen.formats.texatlas.compounds.TexAtlasRoot',
	'TextureData': 'nifgen.formats.texatlas.compounds.TextureData',
	'AtlasItem': 'nifgen.formats.texatlas.compounds.AtlasItem',
}

...
export class com extends Format
{
	...
	magic          = [
		...
		"DESQview/X Print Manager driver", "16bit COM Factor - FoXCoRe crack", "16bit DOS SCRNCH Command", "16bit DOS FontEdit ][ Command", "16bit COM Demonlord Generic Patcher", "16bit DOS Mouse Systems Corp. menu",
		"16bit DOS Pianoman music player Command",

...
export default
{
	...
	other :
	{
		...
		netwareLoadableModule        : {name : "Netware Loadable Module", ext : [".nlm"], magic : [/^Net[Ww]are Loadable Module/, /^fmt\/1551( |$)/]},
		...
		visualCLibrary               : {name : "Microsoft Visual C/Basic Library", ext : [".lib"], magic : ["Microsoft Visual C Library", "Microsoft Visual C/OMF library", "C++ Bibliotheks Datei", "Microsoft Basic 7.x compiled library", "Microsoft Basic compiled library"]},
		...
		relocatableObjectModule          : {name : "Relocatable Object Module", ext : [".obj", ".o"], magic : ["OMF - Relocatable Object Module Format", "8086 relocatable", "Microsoft Basic 7.1 compiled object code", "Oberon-M Object", /^Microsoft .*DOS Object module/]},

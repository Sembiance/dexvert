...
export default async function buildFormats()
{
	...
	for(const formatFilePath of formatFilePaths)
	{
		...
		if(!(await Deno.readTextFile(formatFilePath)).includes(" extends Format") || (await Deno.readTextFile(formatFilePath)).startsWith("/*"))
			continue;
	...
	await Deno.writeTextFile(path.join(formatDirPath, "formats.js"), `

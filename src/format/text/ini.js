...
export class ini extends Format
{
	...
	magic          = [
		...
		"Windows PROTOCOL.INI", "FL Studio DrumSynth Preset (v2.x)", "jalbum image info", "MASH script", "Micrografx Media Manager Easy Catalog", "Eagle preferences", "WinAPE Profile",

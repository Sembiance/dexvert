...
export class jpg extends Format
{
	...
	magic            = [
		...
		"JPEG Stereoscopic bitmap", "deark: jpeg (JPEG/Exif)", "deark: jpeg (JPEG/JFIF", "deark: jpeg (JPEG (other))", /^JPEG (CMYK|Grayscale|TrueColor) \(v[\d.]+\) :(jpeg|jps|frm):$/, "JPEG based file :*:",

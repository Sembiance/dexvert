...
export default
{
	text :
	{
		...
		tclTkScript                            : {name : "Tcl/Tk script", ext : [".tcl"], magic : ["Tcl/Tk script text executable", /^a .*\/wish[\d.]* script/, /^Executable script, shebang: ".*\/wish[\d.]*"/, /^Shell Skript: '.*\/wish[\d.]*'/], website : "http://fileformats.archiveteam.org/wiki/Tcl"},

...
const _XML_MAGIC = [
	...
	"psitree router configuration", "Rosegarden score (ungzipped)", "Bitz and Pixels XML", "CAPS metadata", "KRadio Preset", "ActiveReports Report", "Help Table of Contents", "Hex Edit binary file format template",

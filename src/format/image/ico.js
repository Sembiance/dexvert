...
export class ico extends Format
{
	...
	converters = [
		"deark[module:ico]", "iio2png", "deark[module:win1ico]", "iconvert", "nconvert[format:ico]", "gimp", "imconv[format:ico][matchType:magic]", "wuimg[format:ico]", "tkimgConvert[matchType:magic]"

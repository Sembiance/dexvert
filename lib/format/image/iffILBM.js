...
exports.steps = [
	// abydosconvert handles IFF files the best, including color cycling animations in WEBP format (AH_Dan, AH_Eye, Watch, DECKER-BattleMech)
	...
	// So we convert with both these programs and it's cool if recoil2png over-writes a PNG produced by abydos as it's more likely to be correct

...
export class accessDatabase extends Format
{
	...
	magic      = ["Microsoft Access Database", "Microsoft Jet DB", "Microsoft Access 2007 Database", "Microsoft Access Datenbank Datei", /^fmt\/(275|1806|1258)( |$)/, /^x-fmt\/(66|238|239|240|241)( |$)/];

...
const _XML_MAGIC = [
	...
	"Linden Lab Structured Data", "Irrlicht 3D scene", "A Vampyre Story save game", "JCross CrossWords puzzle", "FontCreator Pro transform script", "TrID definition! :-)", "Camtasia Studio Project", "MSX software data base",

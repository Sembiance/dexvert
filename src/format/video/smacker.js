...
export class smacker extends Format
{
	...
	ext          = [".smk"];
	magic        = ["Smacker movie/video", "Smacker Video", "video/vnd.radgamettools.smacker", "Smacker (smk)", "Format: Smacker Video", /^geArchive: ZRB_SMK2( |$)/, /^RAD Game Tools Smacker Multimedia .* frames$/, /^fmt\/1234( |$)/];

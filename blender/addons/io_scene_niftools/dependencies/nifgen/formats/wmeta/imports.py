...
type_module_name_map = {
	...
	'WmetasbRoot': 'nifgen.formats.wmeta.compounds.WmetasbRoot',
	'Jwe2WmetasbMain': 'nifgen.formats.wmeta.compounds.Jwe2WmetasbMain',
	'WmetasbMain': 'nifgen.formats.wmeta.compounds.WmetasbMain',
	'MediaEntry': 'nifgen.formats.wmeta.compounds.MediaEntry',
	'EventEntry': 'nifgen.formats.wmeta.compounds.EventEntry',
}

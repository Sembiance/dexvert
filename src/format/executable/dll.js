...
export class dll extends Format
{
	...
	magic        = [
		...
		"ZoneLabs Zone Alarm data", "Aston Shell plugin", /^foobar 2000 (Diskwriter output|Input|generic) component/, "Take Command plugin", "MATLAB Windows 32bit compiled function", "JAJC plugin", "Microsoft Windows Defender Virus Definition Module"
	];

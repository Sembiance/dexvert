...
export class zip extends Format
{
	...
	magic          = [
		...
		"Installer: AutoPlay Media Studio", "Visual Studio Extension", "Spring Engine Zipped mod", "Presonus Studio One Song", "RetroPlatform Player archive", "OpenRocket project (zipped)", "eMule skin profile packages (ZIP)",

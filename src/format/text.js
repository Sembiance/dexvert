...
export default
{
	text :
	{
		...
		pemPrivateKey                           : {name : "PEM private key/CRL", ext : [".pem"], magic : ["ASCII armored RSA Private Key", "application/x-pem-key", /^PEM ([DR]SA|PKCS8) private key/, /^OpenSSH private key/, /^application\/.+\+pem$/], website : "http://fileformats.archiveteam.org/wiki/PEM_encoded_RSA_private_key"},

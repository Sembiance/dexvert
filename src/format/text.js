...
export default
{
	text :
	{
		...
		coldFusionVerityEngineFieldsDefinition : {name : "ColdFusion Verity engine fields definition", ext : [".ddd"], magic : ["ColdFusion Verity engine fields definition"], weakMagic : true},
		...
		neilBrownsAshScript                    : {name : "Neil Brown's ash script", magic : ["Neil Brown's ash script text executable", /^a \/bin\/ash script/, "Shell Skript: '/bin/ash'"]},
		...
		adobePortableDocumentCatalogIndex       : {name : "Adobe Portable Document Catalog Index", ext : [".pdx"], magic : ["Adobe Portable Document Catalog Index"], weakMagic : true},
		...
		pcCalcSpreadsheet                       : {name : "PC-Calc spreadsheet", magic : ["PC-Calc spreadsheet (v3.0)"]},
		...
		verityCollectionIndexAbout              : {name : "Verity Collection Index About", ext : [".abt"], magic : ["Verity Collection Index About"]},

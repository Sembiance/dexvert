...
exports.args = (state, p, r, inPath=state.input.filePath) => (["-s", p.util.wine.winePath(inPath), "-o", p.util.wine.winePath(path.join(state.cwd, `out${r.flags.reaConverterExt || ".png"}`))]);

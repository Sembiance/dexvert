...
export default
{
	...
	executable :
	{
		...
		elf                                  : {name : "ELF Executable", magic : ["ELF Executable and Linkable format", /^ELF,? \d\d-bit [LM]SB (MIPS-II?I? )?(executable|relocatable|shared object)/, "Executable and Linkable Format", "Unix/Linux 32-Bit", /^fmt\/(688|689)( |$)/]},
	...
	other :
	{
		...
		borlandDriver                      : {name : "Borland Graphics Interface Driver", ext : [".bgi"], magic : ["Borland Graphics Interface driver", "Borland device BGI Device Driver", "Borland Graphics printer driver", "Borland BGI Treiber", "TurboC BGI file"]},

...
export class lotus123 extends Format
{
	...
	magic      = ["Lotus 123 Worksheet", /^Lotus 1-2-3 Wor[Kk][Ss]heet/, "Lotus 1-2-3/Symphony worksheet", "Lotus 123/Symphony worksheet", "Lotus unknown worksheet", /^fmt\/(1452|1453)( |$)/, /^x-fmt\/(114|115|116|117)( |$)/];

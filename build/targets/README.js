...
import {OSIDS} from "../../src/osUtil.js";
...
Utilizes [Deno](https://deno.land/) and **${Object.keys(programs).length.toLocaleString()}** helper programs running on **${OSIDS.length}** different operating systems under various emulators

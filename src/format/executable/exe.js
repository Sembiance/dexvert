...
const _INSTALLER_MAGICS = [
	...
	"Installer: BulletProofSoft installer", "Installer: DeployMaster", "Installer: distutils", "Installer: INTENIUM install system", "Installer: CrypKey", "Installer: CSDD's", "Installer: I-D Media installer",
...
export class exe extends Format
{
	...
	magic   = [
		...
		"Win16 Klik'n'Play Executable (generic)",
		...
		"TMT Pascal Compiler 3.90 DOS executable", "16bit DOS Central Point Anti-Virus immunized Executable",

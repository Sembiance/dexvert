...
export class dmg extends Format
{
	...
	magic      = ["Macintosh Disk image", "zlib compressed data", "ZLIB compressed data", "Apple UDIF disk image", "Format: Universal Disk Image Format", "application/x-apple-diskimage", ..._DMG_DISK_IMAGE_MAGIC];
	weakMagic  = true;

...
Array.from(filenames).parallelMap(async filename => await runUtil.run("sldtoppm", ["-lib", filename, argv.inputFilePath], {stdoutEncoding : "binary", stdoutFilePath : path.join(argv.outputDirPath, `${filename}.ppm`)}));

...
export default
{
	...
	other :
	{
		...
		pgpKeyRing                       : {name : "PGP Key Ring", ext : [".key", ".pgp"], magic : [/^Pretty Good Privacy .*Public Keyring/, "OpenPGP Public Key Version"]},
		...
		texFontMetricData                : {name : "TeX Font Metric Data", ext : [".tfm"], magic : ["TeX font metric data", "LaTeX Schriftart Datei"], weakMagic : true},
		...
		uleadImageiioThumbnailInfo       : {name : "Ulead Imageioo Thumbnail Info", ext : [".pe3", ".pe4"], magic : ["Ulead Imageiio/Imaginfo thumbnail", "Ulead Imaginfo thumbnail", /^Ulead Photo Explorer 3/]},

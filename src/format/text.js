...
export default
{
	text :
	{
		...
		bibTeXStyle                                : {name : "BibTeX style", ext : [".bst"], magic : ["BibTeX Style", /^BibTeX ((custom|standard) bibliography )?style text file/], weakMagic : ["BibTeX Style"]},
		...
		windowsURLShortcut                         : {name : "Windows URL shortcut", ext : [".url"], magic : ["Windows URL shortcut", "URL Datei", "MS Windows 95 Internet shortcut", "application/x-mswinurl", /^x-fmt\/454( |$)/], weakMagic : ["Windows URL shortcut"], idMeta : ({macFileType, macFileCreator}) => (macFileType==="AURL" && macFileCreator==="Arch") || (macFileType?.startsWith("URL") && macFileCreator==="MOSS")},

...
const _INSTALLER_MAGICS = [
	...
	"Installer: VMWare Software Installer", "Installer: Excelsior Installer", "Installer: Smart Install Maker", "Installer: Sony Windows Installer", "Installer: Autorun Pro Enterprise II", "Installer: Adobe SVG Installer",
...
export class exe extends Format
{
	...
	magic   = [
		...
		"Graphic Workshop self-displaying picture executable", "PE Unknown PE signature 0 (Control Panel Item)", "GIMP Plugin (Win)", "Total Commander Packer extension (plugin)", "WIFE Font Driver", "PhotoFilter plugin",
		"Total Commander Content plugin", "Total Commander File system extension (plugin)", "Lavasoft Ad-aware 6 plugin", "Find and Run Robot (FARR) plugin", "Microsoft Basic Quick library",

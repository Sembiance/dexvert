...
export class tga extends Format
{
	...
	// Only deark & pv were able to correctly handle flag_b32.tga
	converters = ["deark", "pv[matchType:magic]", "nconvert", "recoil2png", `abydosconvert[format:${this.mimeType}]`, "gimp", "hiJaakExpress", "corelPhotoPaint", "canvas", "picturePublisher"];

...
const _PS_MAGIC = [/^PostScript$/, /^PostScript document/, "PJL encapsulated PostScript document", "Adobe Postscript Datei", "HP Printer Job Language data", "Encapsulated PostScript Interchange", /^x-fmt\/(406|407|408)( |$)/];
const _PS_EXT = [".ps"];

...
export default
{
	text :
	{
		...
		battleForWesnothConfigData          : {name : "The Battle for Wesnoth Configuration game data", ext : [".cfg"], magic : ["The Battle for Wesnoth Configuration game data"]},
		beyondAtlantisSaveGame              : {name : "Beyond Atlantis save game", ext : [".sav"], magic : ["Beyond Atlantis I/II save game"], weakMagic : true},
		bioWareAuroraFormatScript           : {name : "BioWare Aurora Format script", ext : [".baf"], magic : ["BioWare Aurora Format script"], weakMagic : true},
		...
		darwiniaLevelMapData                : {name : "Darwinia level map data", ext : [".txt"], magic : ["Darwinia level map data"]},
		darwiniaLevelMissionData            : {name : "Darwinia level mission data", ext : [".txt"], magic : ["Darwinia level mission data"]},
		darwiniaShape                       : {name : "Darwinia Shape", ext : [".shp"], magic : ["Darwinia Shape"], weakMagic : true},
		deleDMap                            : {name : "DeleD map", ext : [".dmf"], magic : ["DeleD map"], weakMagic : true},
		...
		dominionScenarioDescriptionLanguage : {name : "Dominion Scenario Description Language", ext : [".sdl"], magic : ["Dominion Scenario Description Language"], weakMagic : true},
		...
		everQuestEffect                     : {name : "EverQuest Effect", ext : [".eff"], magic : ["EverQuest Effect"], weakMagic : true},
		...
		gemDemoBenchmarksResults            : {name : "GemDemo benchmarks results", ext : [".fps"], magic : ["GemDemo benchmarks results"]},
		gPoliceConfiguration                : {name : "G-Police Configuration", ext : [".cfg"], magic : ["G-Police Configuration"]},
		...
		jigsawsGalorePieces                 : {name : "Jigsaws Galore Pieces", ext : [".asc"], magic : ["Jigsaws Galore Pieces"]},
		...
		originSystemChecksum                : {name : "ORIGIN System Checksum", ext : [".chk"], magic : ["ORIGIN System Checksum"]},
		...
		piklib8Script                       : {name : "Piklib 8 script", ext : [".class", ".cnv", ".def", ".decoded"], magic : ["Piklib 8 script"], weakMagic : true},
		playStation2SystemConfiguration     : {name : "PlayStation 2 system configuration", ext : [".cnf"], magic : ["PlayStation 2 system configuration"], weakMagic : true},
		...
		quake4AINavigationPathData          : {name : "Quake 4 AI navigation / path data", ext : [".aas32", ".aas48", ".aas96", ".aas128", ".aas250"], magic : ["Quake 4 AI navigation / path data"]},
		quake4CollisionModel                : {name : "Quake 4 Collision Model", ext : [".cm"], magic : ["Quake 4 Collision Model"]},
		quake4PreProcessedMap               : {name : "Quake 4 pre-processed Map", ext : [".proc"], magic : ["Quake 4 pre-processed Map"]},
		quizProQuizData                     : {name : "QuizPro Quiz data", ext : [".qzs", ".qzd", ".qze"], magic : ["QuizPro quiz data"]},
		rapconSectorInfo                    : {name : "RAPCON Sector info", ext : [".sec"], magic : ["RAPCON Sector info"], weakMagic : true},
		...
		robocodeBattle                      : {name : "Robocode Battle", ext : [".battle"], magic : ["Robocode Battle"], weakMagic : true},
		robotArenaHazardConfiguration       : {name : "Robot Arena hazard configuration", ext : [".adf"], magic : ["Robot Arena hazard configuration"]},
		simCity3000FreshnessScore           : {name : "SimCity 3000 Freshness Score", ext : [".fsc"], magic : ["SimCity 3000 Freshness Score"], weakMagic : true},
		simCity4ExemplarText                : {name : "SimCity 4 Exemplar Text", ext : [".ezmp", ".eqzb"], magic : ["SimCity 4 Exemplar (text)"]},
		...
		swordsOfTheStarsShip                : {name : "Swords of the Stars Ship", ext : [".shipsection"], magic : ["Swords of the Stars Ship"], weakMagic : true},
		...
		trainSimulatorSoundManagementSystem : {name : "Train Simulator Sound Management System", ext : [".sms"], magic : ["Train Simulator Sound Management System"]},
		trainSimulatorTrack                 : {name : "Train Simulator Track", ext : [".trk", ".tdb"], magic : ["Train Simulator Track", "Microsoft Train Simulator Track"]},
		trainSimulatorTrafficDefinition     : {name : "Train Simulator Traffic definition", ext : [".trf"], magic : ["Train Simulator Traffic definition"]},
		trainSimulatorWagon                 : {name : "Train Simulator Wagon", ext : [".eng", ".wag"], magic : ["Train Simulator Wagon"]},
		trainSimulatorWorld                 : {name : "Train Simulator World", ext : [".w"], magic : ["Train Simulator World"]},
		ultimateStuntsTrack                 : {name : "Ultimate Stunts Track", ext : [".template", ".track"], magic : ["Ultimate Stunts Track"], weakMagic : true},
		...
		expressionDesignDrawing                : {name : "Expression Design drawing", ext : [".xpr"], magic : ["Expression Design drawing"], idMeta : ({macFileType, macFileCreator}) => macFileType==="XPRF" && macFileCreator==="EXPr"},
		...
		ardenScrypt                              : {name : "ArdenScrypt", ext : [".script", ".npcs"], magic : ["ArdenScrypt"]},
		asm                                      : {name : "Assembly Source File", website : "http://fileformats.archiveteam.org/wiki/Assembly_language", ext : [".asm", ".s"], magic : ["text/x-asm", /^assembler source/], weakMagic : true},
		...
		awk                                      : {name : "AWK Script", ext : [".awk"], magic : ["a /bin/awk", "Shell Skript: '/bin/awk", "text/x-awk", /^Executable script, shebang: "(\/usr)?(\/local)?\/bin\/awk/, "text/x-nawk", "text/x-gawk", "awk or perl script", /^a awk script/, /^((new|GNU) )?awk script text executable/, "application/x-awk"], weakMagic : ["awk or perl script"], website : "http://fileformats.archiveteam.org/wiki/AWK"},
		bas                                      : {name : "BASIC Source File", website : "http://fileformats.archiveteam.org/wiki/BASIC", ext : [".bas"], magic : TEXT_MAGIC, weakMagic : true},
		batDOS                                   : {name : "DOS Batch File", website : "http://fileformats.archiveteam.org/wiki/Batch_file", ext : [".bat"], magic : ["DOS batch file", "BAT/CMD Batch Datei", "application/x-bat", ...TEXT_MAGIC, /^data$/], weakMagic : true},
		bcplSource                               : {name : "BCPL source", ext : [".bcp", ".bpl", ".bcpl"], magic : ["BCPL source"], weakMagic : true},
		blueJClassContext                        : {name : "BlueJ Class context", ext : [".ctxt"], magic : ["BlueJ Class context"], weakMagic : true},
		blueJPackage                             : {name : "BlueJ package", ext : [".pkg"], magic : ["BlueJ package"], weakMagic : true},
		...
		borlandLinkerMappingData                 : {name : "Borland Linker Mapping Data", ext : [".map"], magic : ["Borland Linker Mapping Data"], weakMagic : true},
		...
		fltkUserInterfaceDesigner                : {name : "FLTK User Interface Designer", ext : [".fl"], magic : ["FLTK source code", "application/x-fluid"]},
		forthSource                              : {name : "FORTH Source", ext : [".f", ".fth", ".forth", ".4th", ".fs"], magic : ["FORTH program"], weakMagic : true},
		geniusMenuMakerMenu                      : {name : "Genius Menu Maker Menu", ext : [".gmk"], magic : ["Genius Menu Maker Menu"], weakMagic : true},
		gherkinFeature                           : {name : "Gherkin Feature", ext : [".feature"], magic : ["Gherkin Feature"], weakMagic : true},
		...
		haskellSource                            : {name : "Haskell Source", ext : [".hs", ".lhs"], magic : ["Haskell script executable", "GHC script executable"], weakMagic : true},
		...
		jCreatorWorkspace                        : {name : "JCreator Workspace", ext : [".jcw"], magic : ["JCreator Workspace"]},
		...
		liberyBASICTokenizedSource               : {name : "Libery BASIC tokenized source", ext : [".tkn"], magic : ["Libery BASIC tokenized source"], weakMagic : true},
		...
		microsoftVisualStudioSolution            : {name : "Microsoft Visual Studio Solution", ext : [".sln"], magic : ["Microsoft Visual Studio Solution", "Microsoft Visual Studio Solution Datei", "Format: Visual Studio solution file"]},
		...
		msDeveloperStudioProject                 : {name : "MS Developer Studio Project", ext : [".dsp"], magic : ["MS Developer Studio Project", "text/x-ms-visualstudio.project"]},
		...
		nmake                                    : {name : "NMAKE", ext : [".msc", ".mak"], magic : ["Microsoft Developer Studio Generated NMAKE"]},
		...
		powerBuilderTarget                       : {name : "PowerBuilder Target", ext : [".pbt"], magic : ["PowerBuilder Target"]},
		powerBuilderWorkspace                    : {name : "PowerBuilder Workspace", ext : [".pbw"], magic : ["PowerBuilder Workspace"]},
		programmersNotepadProject                : {name : "Programmer's Notepad Project", ext : [".pnproj"], magic : ["Programmer's Notepad Project"], weakMagic : true},
		programmersNotepadProjectGroup           : {name : "Programmer's Notepad Project Group", ext : [".ppg"], magic : ["Programmer's Notepad Project Group"], weakMagic : true},
		programmersNotepadState                  : {name : "Programmer's Notepad State", ext : [".pnps"], magic : ["Programmer's Notepad State"], weakMagic : true},
		...
		quickBMSScript                           : {name : "QuickBMS script", ext : [".bms"], magic : ["QuickBMS script"], weakMagic : true},
		rDocumentation                           : {name : "R documentation", ext : [".rd"], magic : ["R documentation"], weakMagic : true},
		rebolSourceCode                          : {name : "Rebol source code", ext : [".r"], magic : ["Rebol source code"], weakMagic : true},
		...
		remObjectsDefinitionLanguage             : {name : "RemObjects Definition Language", ext : [".rodl"], magic : ["RemObjects Definition Language"], weakMagic : true},
		...
		scriptlet                                : {name : "Sscriptlet", ext : [".htc"], magic : ["text/scriptlet"], weakMagic : true},
		...
		sgml                                     : {name : "SGML Document", website : "http://fileformats.archiveteam.org/wiki/SGML", ext : [".sgml"], magic : [/^exported SGML (sub)?document/, "HyperText Markup Language"], weakMagic : true},
		...
		sqrScript                                : {name : "SQR script", ext : [".sqr", ".sqc"], magic : ["SQR script"], weakMagic : true},
		...
		systemtapScript                          : {name : "Systemtap script", ext : [".stp"], magic : ["Systemtap script text executable"], weakMagic : true},
		...
		texinfoIndex                             : {name : "Texinfo index", ext : [".cps", ".kys", ".vrs", ".fns", ".pgs", ".tps"], magic : ["Texinfo index"]},
		...
		unityAssetMetaData                       : {name : "Unity asset Meta data", ext : [".meta"], magic : ["Unity asset Meta data"], weakMagic : true},
		...
		visualStudioProjectBuildLog              : {name : "Visual Studio Project build log", ext : [".plg"], magic : ["Visual Studio Project build log"], weakMagic : true},
		...
		w32DasmAsmListFile                       : {name : "W32Dasm Asm List File / project", ext : [".alf"], magic : ["W32Dasm Asm List File / project"]},
		...
		watcomCCPPDebugCommandsSequence          : {name : "Watcom C/C++ Debug commands sequence", ext : [".dbg"], magic : ["Watcom C/C++ Debug commands sequence"]},
		...
		accWareDataDictionary                      : {name : "AccWare Data Dictionary", ext : [".dd"], magic : ["AccWare Data Dictionary"]},
		...
		adobePortableDocumentCatalogIndex          : {name : "Adobe Portable Document Catalog Index", ext : [".pdx"], magic : ["Adobe Portable Document Catalog Index", /^fmt\/(446|447|448|449)( |$)/], weakMagic : true, idMeta : ({macFileType, macFileCreator}) => macFileType==="PDX " && macFileCreator==="CARO"},
		adobePostScriptCharacterMap                : {name : "Adobe PostScript Character Map", ext : [".ps"], magic : ["Adobe PostScript Character Map"]},
		...
		amigaCashProIDSFormat                      : {name : "AmigaCash Pro IDS format", ext : [".ids2", ".ids"], magic : ["AmigaCash Pro IDS format"]},
		...
		aniMagicDVEMap                             : {name : "ANIMagic DVE Map", ext : [".map"], magic : ["ANIMagic DVE Map"], weakMagic : true},
		aniMagicMap                                : {name : "ANIMagic Map", ext : [".map"], magic : ["ANIMagic Map"], weakMagic : true},
		anim8orProject                             : {name : "Anim8or project", ext : [".an8"], magic : ["Anim8or project"], weakMagic : true},
		anjutaProject                              : {name : "Anjuta Project", ext : [".prj"], magic : ["Anjuta Project"], weakMagic : true},
		antiVirJob                                 : {name : "AntiVir Job", ext : [".avj"], magic : ["AntiVir Job"]},
		antiVirProfile                             : {name : "AntiVir Profile", ext : [".avp"], magic : ["AntiVir Profile"]},
		apAssistDocument                           : {name : "ApAssist document", magic : ["ApAssist document"]},
		aPatchDatenDatei                           : {name : "aPatch Daten Datei", ext : [".aps"], magic : ["aPatch Daten Datei"], weakMagic : true},
		appletEffectFactoryConfigFile              : {name : "Applet Effect Factory Config File", ext : [".data"], magic : [/^fmt\/1715( |$)/]},
		...
		aptclOutputData                            : {name : "APTCL output data", ext : [".apt"], magic : ["APTCL output data"], weakMagic : true},
		aqTitleSubtitlesAqtitle                    : {name : "AQTitle subtitles", ext : [".sub"], magic : ["AQTitle subtitles (aqtitle)"], weakMagic : true},
		...
		aseam2SystemInputScreenData                : {name : "ASEAM 2 System Input Screen/Data", ext : [".sis"], magic : ["ASEAM 2 System Input Screen/Data"]},
		...
		autoPromptScript                           : {name : "AutoPrompt script", ext : [".pmt"], magic : ["AutoPrompt script"], weakMagic : true},
		...
		avogadroDrawlog                            : {name : "Avogadro Drawlog", ext : [".drawlog", ".ignore"], magic : ["Avogadro Drawlog"], weakMagic : true},
		...
		besiegeMachine                             : {name : "Besiege machine", ext : [".bsg"], magic : ["Besiege machine"]},
		...
		bitTorrentFile                             : {name : "BitTorrent file", ext : [".torrent"], magic : ["BitTorrent file", "application/x-bittorrent", /^Torrent( \(trackerless\))?$/, "Format: Torrent"]},
		...
		bluffTitlerEffect                          : {name : "BluffTitler Effect", ext : [".fx"], magic : ["BluffTitler Effect"], weakMagic : true},
		bluffTitlerShow                            : {name : "BluffTitler Show", ext : [".bt"], magic : ["BluffTitler Show"]},
		bochsKeymap                                : {name : "Bochs keymap", ext : [".map"], magic : ["Bochs keymap"], weakMagic : true},
		borlandGraphicsInterfaceCharactersMapping  : {name : "Borland Graphics Interface characters mapping", ext : [".bgi", ".txt"], magic : ["Borland Graphics Interface characters mapping"]},
		...
		buzzwordsOnLineManualProgramTOC            : {name : "Buzzwords On-Line Manual Program TOC", ext : [".toc"], magic : ["Buzzwords On-Line Manual Program TOC"], weakMagic : true},
		bylineCharsetDefinition                    : {name : "Byline Charset definition", ext : [".chr"], magic : ["Byline Charset definition"], weakMagic : true},
		bylineGraphicConfiguration                 : {name : "Byline Graphic configuration", ext : [".grf"], magic : ["Byline Graphic configuration"], weakMagic : true},
		bylineMessages                             : {name : "Byline Messages", ext : [".msg"], magic : ["Byline Messages"], weakMagic : true},
		bylinePrinterConfiguration                 : {name : "Byline Printer configuration", ext : [".prn"], magic : ["Byline Printer configuration"], weakMagic : true},
		bylinePrinterList                          : {name : "Byline Printer List", ext : [".prl"], magic : ["Byline Printer List"], weakMagic : true},
		bylineVariables                            : {name : "Byline Variables", ext : [".var"], magic : ["Byline Variables"], weakMagic : true},
		cabalInfo                                  : {name : "Cabal info", ext : [".cabal"], magic : ["Cabal info"], weakMagic : true},
		cableNutCustomSettings                     : {name : "CableNut Custom Settings", ext : [".ccs"], magic : ["CableNut Custom Settings"]},
		cabri3DFigure                              : {name : "Cabri 3D Figure", ext : [".fig"], magic : ["Cabri 3D Figure", "application/x-cabri"], weakMagic : true},
		cabri3DLanguage                            : {name : "Cabri 3D Language", ext : [".cgl"], magic : ["Cabri 3D Language"]},
		...
		chemWindowStandardChemistryFile            : {name : "ChemWindow Standard Chemistry File", ext : [".scf"], magic : ["ChemWindow Standard Chemistry File"], weakMagic : true},
		chordTextFile                              : {name : "Chord text file", ext : [".crd"], magic : [/^Chord text file/], weakMagic : true},
		chiWriterDocument                          : {name : "ChiWriter document", ext : [".chi"], magic : ["ChiWriter document", /^ChiWriter file/, /^fmt\/300( |$)/, /^x-fmt\/309( |$)/]},
		circadData                                 : {name : "CIRCAD data", ext : [".tpc", ".tsa", ".tpb", ".tsc", ".pcb", ".tpa", ".tpd", ".tda", ".tsd", ".tdc", ".tsb", ".sch", ".tdb", ".tdd", ".lib"], magic : ["CIRCAD data", "CIRCAD source library"]},
		circuitMakerSchematic                      : {name : "CircuitMaker schematic", ext : [".ckt"], magic : ["CircuitMaker schematic"]},
		clamAntiVirusDatabase                      : {name : "Clam AntiVirus Database Info", ext : [".info", ".cud", ".cld"], magic : ["Clam AntiVirus Database", /^Clam AntiVirus file/], weakMagic : true},
		...
		combustionWorkSpace                        : {name : "Combustion WorkSpace", ext : [".cws"], magic : ["Combustion WorkSpace"], weakMagic : true},
		...
		cpmDisksFormatDescriptions                 : {name : "CP/M disks format descriptions", magic : ["CP/M disks format descriptions"]},
		crossStudioProject                         : {name : "CrossStudio project", ext : [".hzp"], magic : ["CrossStudio project"], weakMagic : true},
		crystallographicInformationFramework       : {name : "Crystallographic Information Framework", ext : [".cif"], magic : [/^fmt\/334( |$)/], weakMagic : true},
		csoundOrchestra                            : {name : "Csound Orchestra", ext : [".orc"], magic : ["Csound Orchestra"], weakMagic : true},
		cubeLUTFormat                              : {name : "Cube LUT format", ext : [".lut", ".cube"], magic : ["Cube LUT format"]},
		...
		cvsPasswordTextFile                        : {name : "CVS password text file", magic : [/^cvs password text file, ASCII text/]},
		cwlsLog                                    : {name : "CWLS Log", ext : [".las"], magic : ["CWLS Log ASCII Standard", /^fmt\/390( |$)/], weakMagic : true},
		dacEasyWordPrinter                         : {name : "Dac-Easy Word Printer", ext : [".prt"], magic : ["Dac-Easy Word Printer"], weakMagic : true},
		...
		dazStudioScript                            : {name : "DAZ Studio script", ext : [".dsa", ".ds"], magic : ["DAZ Studio script"]},
		dbaseWindowsFormFile                       : {name : "dBASE Windows Form File", ext : [".mnu", ".wfm"], magic : [/^fmt\/1728( |$)/]},
		dbTextWorksDatabaseDeferredUpdateDirectory : {name : "DB/TextWorks Database Deferred Update Directory", ext : [".sdo"], magic : ["DB/TextWorks Database Deferred Update Directory"]},
		...
		deriveMathFunctions                        : {name : "Derive Math functions", ext : [".mth"], magic : ["Derive Math functions"], weakMagic : true},
		designRulesCheckRulesExport                : {name : "Design Rules Check Rules export", ext : [".rul"], magic : ["DRC Rules export"]},
		desqviewXColorsConfiguration               : {name : "DESQview/X colors Configuration", ext : [".cfg"], magic : ["DESQview/X colors Configuration"], weakMagic : true},
		desqviewXGroup                             : {name : "DESQview/X Group", ext : [".grp"], magic : ["DESQview/X Group"], weakMagic : true},
		desqviewXLayout                            : {name : "DESQview/X Layout", ext : [".lyt"], magic : ["DESQview/X Layout"], weakMagic : true},
		dgIndexProject                             : {name : "DGIndex project", ext : [".d2v"], magic : ["DGIndex project"]},
		...
		diskTechnicianGoldHelp                     : {name : "Disk Technician Gold Help", ext : [".hlp"], magic : ["Disk Technician Gold Help"], weakMagic : true},
		dkbtraceScene                              : {name : "DKBtrace scene", ext : [".dat", ".inc"], magic : ["DKBtrace scene"], weakMagic : true},
		doodleMationDoodle                         : {name : "Doodle-mation Doodle", ext : [".doo"], magic : ["Doodle-mation Doodle"]},
		doReMIXSong                                : {name : "DoReMIX song", ext : [".dmx"], magic : ["DoReMIX song"], weakMagic : true},
		...
		drumatixCompleteProject                    : {name : "Drumatix complete project", ext : [".dal"], magic : ["dal complete project", "Drumatix complete project"]},
		dtreadTypeDescriptor                       : {name : "dtread Type Descriptor", ext : [".dtyp"], magic : ["dtread Type Descriptor"]},
		duxburyScrubTable                          : {name : "Duxbury Scrub Table", ext : [".sbt"], magic : ["Duxbury Scrub Table"], weakMagic : true},
		dvdJuniorSubtitles                         : {name : "DVD Junior subtitles", ext : [".txt"], magic : ["DVD Junior subtitles"]},
		dvdSubtitleSubtitles                       : {name : "DVDSubtitle subtitles", ext : [".sub", ".out"], magic : ["DVDSubtitle subtitles"]},
		dynamicPublisherText                       : {name : "Dynamic Publisher Text", ext : [".txt"], magic : ["Dynamic Publisher Text"]},
		eagleDesignRules                           : {name : "EAGLE Design Rules", ext : [".dru"], magic : ["EAGLE Design Rules"], weakMagic : true},
		...
		electronicsWorkbenchCircuit                : {name : "Electronics Workbench Circuit", ext : [".ewb"], magic : ["Electronics Workbench Circuit"]},
		...
		ergoProBubbleGEMHelp                       : {name : "ergo!pro BubbleGEM Help", ext : [".bub"], magic : ["ergo!pro BubbleGEM Help"], weakMagic : true},
		ergoProProject                             : {name : "ergo!pro Project", ext : [".prj"], magic : ["ergo!pro Project"]},
		...
		esriArcViewProject                         : {name : "ESRI Arc/View Project", ext : [".apr"], magic : ["ArcView Project", /^fmt\/332( |$)/, /^x-fmt\/317( |$)/]},
		...
		excellonDrillFile                          : {name : "Excellon Drill File", ext : [".drl"], magic : ["application/x-excellon"], weakMagic : true},
		...
		ezEDSElectronicDataSheet                   : {name : "EZ-EDS Electronic Data Sheet", ext : [".eds"], magic : ["EZ-EDS Electronic Data Sheet"]},
		familyOriginsReport                        : {name : "Family Origins Report", ext : [".rpt"], magic : ["Family Origins Report"], weakMagic : true},
		farHelp                                    : {name : "FAR help", ext : [".hlf"], magic : ["Far Manager Help"], weakMagic : true},
		fastBackPlusMacro                          : {name : "FastBack Plus Macro", ext : [".fbm"], magic : ["FastBack Plus Macro"], weakMagic : true},
		fastBackPlusSetup                          : {name : "FastBack Plus setup", ext : [".fb"], magic : ["FastBack Plus setup"], weakMagic : true},
		fastFontSymbolSet                          : {name : "FastFont Symbol Set", ext : [".sym"], magic : ["FastFont Symbol Set"], weakMagic : true},
		ffmpegMetadataInText                       : {name : "FFmpeg metadata in text", ext : [".ffmeta"], magic : ["FFmpeg metadata in text (ffmetadata)"], weakMagic : true},
		...
		fontLabNameMappingRule                     : {name : "FontLab Name mapping rule", ext : [".nam"], magic : ["FontLab Name mapping rule"]},
		fontLabUnicodeRange                        : {name : "FontLab Unicode Range", ext : [".dat"], magic : ["FontLab Unicode Range"]},
		...
		freePCBLibrary                             : {name : "FreePCB Library", ext : [".fpl"], magic : ["FreePCB Library"]},
		...
		fruityLoopsHumanizePreset                  : {name : "FruityLoops Humanize Preset", ext : [".fpr"], magic : ["FruityLoops Humanize Preset"]},
		ftnchekProjectFile                         : {name : "ftncheck project file", ext : [".prj"], magic : [/^project file for ftnchek/], weakMagic : true},
		fxPAINTPen                                 : {name : "fxPAINT pen", magic : ["fxPAINT pen"]},
		gambasForm                                 : {name : "Gambas form", ext : [".form"], magic : ["Gambas form"]},
		gambasProject                              : {name : "Gambas project", magic : ["Gambas project"]},
		gameMakerDocumentObject                    : {name : "GameMaker document/object", ext : [".gmx", ".col"], magic : ["GameMaker document/object"]},
		gapfile                                    : {name : "GAPFile", ext : [".gap"], magic : ["GAPFile (v1.0)"]},
		garminPCX5TrackFile                        : {name : "Garmin PCX5 track file", ext : [".trk"], magic : ["Garmin PCX5 track file"]},
		gcovCoverageReport                         : {name : "GCOV coverage report", ext : [".gcov"], magic : [/^GCOV coverage report/], weakMagic : true},
		...
		gerberPhotoplot                            : {name : "Gerber Photoplot", ext : [".pho"], magic : ["Gerber Photoplot"], weakMagic : true},
		ghemicalProject                            : {name : "Ghemical Project", ext : [".gpr"], magic : ["Ghemical Project"], weakMagic : true},
		...
		gromacsResidueTopology                     : {name : "GROMACS Residue Topology", ext : [".rtp"], magic : ["GROMACS Residue Topology"], weakMagic : true},
		...
		htTrackWebsiteCopierCookies                : {name : "HTTrack Website Copier cookies", ext : [".txt"], magic : ["HTTrack Website Copier cookies"]},
		...
		ibisModel                                  : {name : "IBIS model", ext : [".ibs", ".1"], magic : ["IBIS model"], weakMagic : true},
		iCalendar                                  : {name : "iCalendar/vCalendar", ext : [".ics", ".vcf"], magic : ["iCalendar - vCalendar", "iCalendar Alarm", /^iCalendar calendar file/, /^vCalendar calendar file/, "text/calendar", "Format: iCalendar (.ICS)", /^fmt\/(387|388)( |$)/]},
		...
		iesnaPhotometricData                       : {name : "IESNA Photometric data", ext : [".ies"], magic : ["IESNA Photometric data", "IES LM-63 Photometric data", /^fmt\/1288( |$)/], weakMagic : true},
		igcFlightTrack                             : {name : "IGC Flight Track", ext : [".igc", ".out"], magic : ["IGC Flight Track"], weakMagic : true},
		...
		iriePascalProject                          : {name : "Irie Pascal Project", ext : [".ipj"], magic : ["Irie Pascal Project"]},
		islandWriteDocument                        : {name : "IslandWrite document", ext : [".iwrite"], magic : [/^IslandWrite document/]},
		isoGCodeProgram                            : {name : "ISO G-Code program", magic : ["ISO G-Code program"]},
		...
		jcampDXFormat                              : {name : "JCAMP-DX format", ext : [".jdx", ".dx", ".smp"], magic : ["JCAMP-DX format"], weakMagic : true},
		jeskolaBuzzTheme                           : {name : "Jeskola Buzz theme", ext : [".col"], magic : ["Jeskola Buzz theme"], weakMagic : true},
		jtagChainFile                              : {name : "JTAG Chain File", ext : [".jcf"], magic : ["JTAG Chain File"], weakMagic : true},
		kdeConfigFile                              : {name : "KDE config file", ext : [".kdelnk", ".desktop"], magic : ["KDE config file", "KDE desktop Link", "KDevelop Project (with rem)", "application/x-desktop", "Format: Desktop Entry (.desktop)"]},
		kegsConfiguration                          : {name : "KEGS configuration", ext : [".kegs"], magic : ["KEGS configuration"]},
		keyNoteNotes                               : {name : "KeyNote notes", ext : [".knt"], magic : ["KeyNote note"]},
		keyTronicTrakballProfile                   : {name : "KeyTronic Trakball profile", ext : [".pro", ".fil"], magic : ["KeyTronic Trakball profile"], weakMagic : true},
		kiCadDocumentation                         : {name : "KiCad Documentation", ext : [".dcm"], magic : ["KiCad Documentation", /^KiCad Symbol Library Documentation/]},
		kiCadFootprintInformation                  : {name : "KiCad footprint information", ext : [".cmp"], magic : ["KiCad footprint information"]},
		kiCadModuleLibrary                         : {name : "KiCad Module library", ext : [".mod", ".emp"], magic : ["KiCad Module library"]},
		kiCadNetlist                               : {name : "KiCad Netlist", ext : [".net"], magic : ["KiCad EESchema Netlist", /^KiCad Netlist/]},
		kiCadPartLibrary                           : {name : "KiCad part Library", ext : [".lib"], magic : ["KiCad part Library", /^KiCad Symbol Library/]},
		kiCadPCBNEWPCBLayout                       : {name : "KiCad pcbnew PCB layout", ext : [".brd"], magic : ["KiCad pcbnew PCB layout"]},
		kiCadProject                               : {name : "KiCad Project", ext : [".pro"], magic : ["KiCad Project"]},
		...
		kodakPhotoCDConfiguration                  : {name : "Kodak Photo CD configuration", ext : [".pcd"], magic : ["Kodak Photo CD configuration"], weakMagic : true},
		konquerorCookie                            : {name : "Konqueror cookie", magic : [/^Konqueror cookie/]},
		ksofTCRC32Data                             : {name : "KsofT CRC-32 Data", ext : [".crc", ".dat"], magic : ["KsofT CRC-32 Data"]},
		...
		lightWave3DSaverCapabilityInfo             : {name : "LightWave 3D saver Capability info", ext : [".ca", ".cap"], magic : ["LightWave 3D saver Capability info"]},
		...
		lotusAgendaStructuredTextFile              : {name : "Lotus Agenda Structured Text File", ext : [".stf"], magic : ["Lotus Agenda Structured Text File"], weakMagic : true},
		...
		ltSpiceSymbol                              : {name : "LTSpice Symbol", ext : [".asy"], magic : ["LTSpice Symbol"], weakMagic : true},
		...
		mediaPointPage                             : {name : "MediaPoint page", magic : ["MediaPoint page"]},
		...
		microCap5Circuit                           : {name : "Micro-Cap 5 Circuit", ext : [".cir"], magic : ["Micro-Cap 5 Circuit"], weakMagic : true},
		...
		microFicheFilerPlusDatabase                : {name : "MicroFiche Filer Plus database", ext : [".mff"], magic : ["MicroFiche Filer Plus database", "MicroFiche Filer data base"], weakMagic : true},
		microFicheFilerSettings                    : {name : "MicroFiche Filer settings", ext : [".prefs"], magic : ["MicroFiche Filer settings"], weakMagic : true},
		...
		microsoftKeyboardLayoutCreatorSource       : {name : "Microsoft Keyboard Layout Creator source", ext : [".klc"], magic : ["Microsoft Keyboard Layout Creator source"]},
		...
		microStationMaterialPalette                : {name : "MicroStation Material Palette", ext : [".pal"], magic : [/^fmt\/1183( |$)/]},
		milestonesScheduleData                     : {name : "Milestones Schedule Data", ext : [".mt", ".ml", ".ba", ".ml4", ".mls"], magic : [/^Milestones .*schedule data/]},
		...
		miniOfficeDatabaseTemplate                 : {name : "Mini Office database Template", ext : [".tpl"], magic : ["Mini Office database Template"]},
		miniOfficeGraphData                        : {name : "Mini Office Graph data", ext : [".gra"], magic : ["Mini Office Graph data"]},
		...
		molecule3DCoordinates                      : {name : "Molecule 3D Coordinates", ext : [".koo"], magic : ["Molecule 3D Coordinates"]},
		monarchForDOSHelp                          : {name : "Monarch for DOS Help", ext : [".hlp"], magic : ["Monarch for DOS Help"], weakMagic : true},
		monarchForWindowsModel                     : {name : "Monarch for Windows Model", ext : [".mod", ".mo"], magic : ["Monarch for Windows Model"], weakMagic : true},
		montageColorData                           : {name : "Montage Color data", ext : [".color", ".color1"], magic : ["Montage Color data"], weakMagic : true},
		montagePage                                : {name : "Montage Page", magic : ["Montage Page"]},
		...
		myHouseProject                             : {name : "My House Project", ext : [".prj"], magic : ["My House Project"], weakMagic : true},
		...
		neoNGrafix2DShapeFontAscii                 : {name : "NeoN Grafix 2D Shape/font (ascii)", ext : [".shp"], magic : ["NeoN Grafix 2D Shape/font (ascii)"]},
		...
		nmapScanResults                            : {name : "Nmap scan results", magic : ["Nmap scan results"]},
		...
		nukeScript                                 : {name : "Nuke script", ext : [".nk"], magic : ["Nuke script"]},
		nutsMacro                                  : {name : "NUTS Macro", ext : [".mac"], magic : ["NUTS Macro"], weakMagic : true},
		oberonSystem3TextDocument                  : {name : "Oberon System 3 text document", ext : [".text", ".tool", ".mod"], magic : ["Oberon System 3 text document"], idMeta : ({macFileType, macFileCreator}) => macFileType===".Doc" && macFileCreator===".OS3"},
		...
		onedirPlusGenerateUtilityProgramsList      : {name : "1dir+ Generate Utility programs list", ext : [".fil"], magic : ["1dir+ Generate Utility programs list"]},
		onedirPlusFilesDescriptions                : {name : "1dir+ files Descriptions", ext : [".des"], magic : ["1dir+ files Descriptions"]},
		...
		openFinancialExchange                      : {name : "Open Financial Exchange", ext : [".ofx", ".qfx"], magic : ["Quicken Transfer file", /^fmt\/309( |$)/]},
		...
		openSSLPEMPublicKey                        : {name : "OpenSSL PEM public key", ext : [".key", ".pem"], magic : ["OpenSSL PEM public key", "Format: Privacy-Enhanced Mail (.PEM)(Public Key)", /^OpenSSH public key/, /^PEM RSA public key/, /SSL-RSA public key$/], weakMagic : true},
		...
		opticksObject                              : {name : "Opticks Object", ext : [".obj"], magic : ["Opticks Object"], weakMagic : true},
		opticksScene                               : {name : "Opticks Scene", ext : [".sce", ".bak"], magic : ["Opticks Scene"], weakMagic : true},
		opticksSurface                             : {name : "Opticks Surface", ext : [".srf"], magic : ["Opticks Surface"], weakMagic : true},
		orangeCDTheme                              : {name : "OrangeCD theme", ext : [".dax"], magic : ["OrangeCD theme"], weakMagic : true},
		os2InstallCatalogFile                      : {name : "OS/2 Install Catalog File", ext : [".icf"], magic : ["OS/2 Install Catalog File"], weakMagic : true},
		os2InstallPackageMeta                      : {name : "OS/2 install Package", ext : [".pkg"], magic : ["OS/2 install Package"], weakMagic : true},
		...
		oziExplorerTrackFile                       : {name : "OziExplorer track file", ext : [".plt"], magic : ["OziExplorer track file"]},
		oziExplorerWaypoint                        : {name : "OziExplorer Waypoint", ext : [".wpt"], magic : ["OziExplorer Waypoint"]},
		padsLayoutASCII                            : {name : "PADS Layout ASCII Format", ext : [".asc", ".txt"], magic : ["PADS Layout ASCII Format"], weakMagic : true},
		pageRender3DScript                         : {name : "PageRender3D Script", ext : [".script"], magic : ["PageRender3D Script"], weakMagic : true},
		pageRender3DSetup                          : {name : "PageRender3D Setup", ext : [".setup"], magic : ["PageRender3D Setup"], weakMagic : true},
		pageStreamColorsLibrary                    : {name : "PageStream colors Library", ext : [".library"], magic : ["PageStream colors Library"]},
		palasmMDesignDescription                   : {name : "PALASM Design Description", ext : [".pds"], magic : ["PALASM Design Description"]},
		...
		panoramaDigitalElevationModelSettings      : {name : "Panorama Digital Elevation Model Settings", ext : [".demset"], magic : ["Panorama Digital Elevation Model Settings"], weakMagic : true},
		panoramaSettings                           : {name : "Panorama Settings", ext : [".set"], magic : ["Panorama Settings"], weakMagic : true},
		papagayoLipsyncInfo                        : {name : "Papagayo lipsync info", ext : [".pgo"], magic : ["Papagayo lipsync info"]},
		...
		pcppmieConfig                              : {name : "PCP pmie config", magic : [/PCP pmie config/]},
		...
		painter3DContour                           : {name : "Painter 3D Contour", ext : [".cnt"], magic : ["Painter 3D Contour"], weakMagic : true},
		pemCertificate                             : {name : "PEM Certificate/Request", ext : [".cer", ".pem"], magic : ["PEM certificate", "Internet Security Certificate", "Certificate Signing Request", "RFC1421 Security Certificate Signing Request", "Format: Privacy-Enhanced Mail (.PEM)(Certificate", "application/pkix-cert+pem", /^Security Certificate$/], website : "http://fileformats.archiveteam.org/wiki/PEM_encoded_certificate"},
		pemPrivateKey                              : {name : "PEM private key/CRL", ext : [".pem"], magic : ["ASCII armored RSA Private Key", "application/x-pem-key", /^PEM ([DR]SA|EC|PKCS#?8) private key/, /^OpenSSH private key/, /^Format: Privacy-Enhanced Mail \(.PEM\).*Message\)/, /^Format: Privacy-Enhanced Mail \(\.PEM\)\(Certificate Revocation List \(CRL\)\)$/,  "Format: Privacy-Enhanced Mail (.PEM)(RSA Private Key)", "OpenSSL PEM private key", "Format: Privacy-Enhanced Mail (.PEM)(Private Key)", "Format: Privacy-Enhanced Mail (.PEM)(Encrypted Private Key)", /^application\/.+\+pem$/], website : "http://fileformats.archiveteam.org/wiki/PEM_encoded_RSA_private_key"},
		pepakuraDesignerProject                    : {name : "Pepakura Designer Project", ext : [".pdo"], magic : ["Pepakura Designer project"], weakMagic : true},
		...
		pointCloudData                             : {name : "Point Cloud Data", ext : [".pcd"], magic : ["Point Cloud Data"]},
		...
		pgpPublicKey                               : {name : "PGP Public/Private Key", website : "http://fileformats.archiveteam.org/wiki/PGP_public_key", ext : [".asc", ".aexpk", ".pgp", ".pub"], magic : [/^PGP (public|private) key block/, "PGP armored data, public key block", "application/pgp-keys"], idMeta : ({macFileType, macFileCreator}) => macFileType==="PKey" && ["MPGP", "Safe"].includes(macFileCreator)},
		...
		playmationAction                           : {name : "Playmation Action", magic : ["Playmation Action"], weakMagic : true},
		playmationAttributes                       : {name : "Playmation Attributes", ext : [".att"], magic : ["Playmation Attributes"], weakMagic : true},
		playmationChorData                         : {name : "Playmation Chor data", ext : [".cho"], magic : ["Playmation Chor data"], weakMagic : true},
		playmationFigure                           : {name : "Playmation Figure", ext : [".fig"], magic : ["Playmation Figure"], weakMagic : true},
		playmationSpine                            : {name : "Playmation Spine", ext : [".sp"], magic : ["Playmation Spin"], weakMagic : true},
		...
		plSQLDeveloperTestScript                   : {name : "PL/SQL Developer Test script", ext : [".tst"], magic : ["PL/SQL Developer Test script"]},
		...
		postgreSQLDatabaseDump                     : {name : "PostgreSQL database dump", ext : [".sql"], magic : [/^PostgreSQL (custom )?database dump/]},
		...
		pureDataPatch                              : {name : "Pure Data patch", ext : [".pd"], magic : ["Pure Data patch"], weakMagic : true, website : "http://fileformats.archiveteam.org/wiki/Pure_Data"},
		...
		quartusBlockDesignFile                     : {name : "Quartus Block Design File", ext : [".bdf"], magic : ["Quartus Block Design File", "Quartus Block Symbol File"], weakMagic : true},
		quartusCompilerSettingFile                 : {name : "Quartus Compiler Setting File", ext : [".csf"], magic : ["Quartus Compiler Setting File"]},
		quartusDataBaseInfo                        : {name : "Quartus DataBase Info", ext : [".db_info"], magic : ["Quartus DataBase Info"]},
		quartusLibraryMappingFile                  : {name : "Quartus Library Mapping File", ext : [".lmf"], magic : ["Quartus Library Mapping File"], weakMagic : true},
		quartusMemoryInitializationFile            : {name : "Quartus Memory Initialization File", ext : [".mif"], magic : ["Quartus Memory Initialization File"], weakMagic : true},
		quartusSettingFile                         : {name : "Quartus Setting File", ext : [".qsf"], magic : ["Quartus Setting File"], weakMagic : true},
		quartusSimulatorSettingFile                : {name : "Quartus Simulator Setting File", ext : [".ssf"], magic : ["Quartus Simulator Setting File"]},
		quartusSoftwareBuildSettingsFile           : {name : "Quartus Software Build Settings File", ext : [".fsf"], magic : ["Quartus Software Build Settings File"]},
		quartusWaveformSimulation                  : {name : "Quartus Waveform simulation", ext : [".vwf"], magic : ["Quartus Waveform simulation"], weakMagic : true},
		qucsSchematic                              : {name : "Qucs schematic", ext : [".sch", ".dpl"], magic : ["Qucs schematic"]},
		...
		rarRegistrationData                        : {name : "RAR registration data", ext : [".key", ".cfg"], magic : ["RAR registration data", "Format: RAR registration data"]},
		...
		reachOutScript                             : {name : "ReachOut Script", ext : [".ros"], magic : ["ReachOut Script"], weakMagic : true},
		...
		reasonRemoteMapping                        : {name : "Reason Remote Mapping", ext : [".remotemap"], magic : ["Reason Remote Mapping"], weakMagic : true},
		...
		savedAIMBuddyList                          : {name : "Saved AIM Buddy List", ext : [".blt"], magic : ["Saved AIM Buddy List"], weakMagic : true},
		sbaGenBinauralBeatsScript                  : {name : "SBaGen binaural beats script", ext : [".sbg"], magic : ["SBaGen binaural beats script (sbg)"], weakMagic : true},
		...
		sccsChecksum                               : {name : "SCCS checksum", ext : [".chk"], magic : ["SCCS checksum"]},
		scooterCircuitLayout                       : {name : "Scooter circuit layout", ext : [".plt"], magic : ["Scooter circuit layout", "Scooter-PCB circuit layout"]},
		scSpreadsheetCalculatorSpreadsheet         : {name : "sc Spreadsheet Calculator spreadsheet", ext : [".sc", ".ast"], magic : ["sc Spreadsheet Calculator spreadsheet", /^sc spreadsheet file/, "application/x-sc"]},
		...
		sfv32nixChecksum                           : {name : "SFV32nix checksum", ext : [".sfv"], magic : ["SFV32nix checksum"]},
		sgiSoundTrackProjectFile                   : {name : "SGI SoundTrack project file", ext : [".st"], magic : [/^SGI SoundTrack project file/]},
		shaperLUT                                  : {name : "Shaper LUT", ext : [".lut", ".3dl"], magic : ["Shaper LUT"], weakMagic : true},
		sharewareInformationFile                   : {name : "Shareware Information File", ext : [".sif"], magic : ["Shareware Information File"]},
		showMakerDevice                            : {name : "ShowMaker Device", ext : [".smdevice"], magic : ["ShowMaker Device"], weakMagic : true},
		...
		signum3PrinterDriver                       : {name : "Signum 3 Printer Driver", ext : [".trb", ".prt"], magic : ["Signum 3 Printer Driver"]},
		signumFontList                             : {name : "Signum Font List", ext : [".fli"], magic : ["Signum Font List"]},
		signumHelpFile                             : {name : "Signum Help File", ext : [".hlp"], magic : ["Signum Help File"]},
		signumKeyCombinationList                   : {name : "Signum Key-Combination-List", ext : [".ktl"], magic : ["Signum Key-Combination-List"]},
		signumShorthands                           : {name : "Signum Shorthands", ext : [".kue"], magic : ["Signum Shorthands"]},
		...
		skyscraperSimulatorBuildingScript          : {name : "Skyscraper simulator Building script", ext : [".bld"], magic : ["Skyscraper simulator Building script"], weakMagic : true},
		slavaSoftFSUMChecksum                      : {name : "SlavaSoft FSUM checksum", ext : [".sfv", ".txt"], magic : ["SlavaSoft FSUM checksum"]},
		slickEditProject                           : {name : "SlickEdit project", ext : [".vpj"], magic : ["SlickEdit project"]},
		smartCAMManufactureData                    : {name : "SmartCAM manufacture data", ext : [".smf"], magic : ["SmartCAM manufacture data"], weakMagic : true},
		smartSoftwareConfiguration                 : {name : "Smart Software configuration", magic : ["Smart Software configuration"]},
		...
		softdeskAdCADDBorderSheet                  : {name : "Softdesk AdCADD Border sheet", ext : [".brd"], magic : ["Softdesk AdCADD Border sheet"]},
		softdeskAdCADDDefaultData                  : {name : "Softdesk AdCADD default data", ext : [".dat"], magic : ["Softdesk AdCADD default data"]},
		softdeskAdCADDLayerDefault                 : {name : "Softdesk AdCADD layer default", ext : [".ly", ".tut"], magic : ["Softdesk AdCADD layer default"]},
		softdeskAdCADDStyleDefault                 : {name : "Softdesk AdCADD style default", ext : [".dat"], magic : ["Softdesk AdCADD style default"]},
		...
		sonyEricssonMobilePhoneNote                : {name : "Sony Ericsson Mobile Phone Note", ext : [".vnt"], magic : ["Sony Ericsson Mobile Phone Note"]},
		sonyEricssonRemoteControlConfiguration     : {name : "Sony Ericsson remote control configuration", ext : [".kcf"], magic : ["Sony Ericsson remote control configuration"]},
		...
		splashIDVID                                : {name : "SplashID vID", ext : [".vid"], magic : ["SplashID vID"]},
		...
		sshPublicKey                               : {name : "SSH Public key", ext : [".pub"], magic : [/^SSH-.+ Public key/, "SSH/SECSH Public Key File Format", "Format: SSH Public Key", "Format: OpenSSH", /^OpenSSH .+ public key/], weakMagic : true},
		...
		subRipSubtitles                            : {name : "SubRip subtitles", ext : [".srt"], magic : ["SubRip subtitles", "SubRip subtitle (srt)", /^SubRip,/, /^fmt\/1218( |$)/], weakMagic : true},
		...
		superKeyKeyboardLayout                     : {name : "SuperKey keyboard Layout", ext : [".lay"], magic : ["SuperKey keyboard Layout"], weakMagic : true},
		...
		surfcamPostProcessor                       : {name : "SURFCAM post processor", ext : [".m3", ".e4", ".m4", ".e2", ".e", ".l2", ".m", ".l", ".m5"], magic : ["SURFCAM post processor"], weakMagic : true},
		svgaVESAConfiguration                      : {name : "SVGAVESA configuration", ext : [".svc"], magic : ["SVGAVESA configuration"]},
		svnDump                                    : {name : "SVN dump", ext : [".dump"], magic : ["SVN dump format", /^Subversion dumpfile/], weakMagic : true},
		terragenProject                            : {name : "Terragen project", ext : [".tgd"], magic : ["Terragen project"]},
		...
		textGridAnnotation                         : {name : "TextGrid annotation", ext : [".textgrid"], magic : ["TextGrid annotation"], weakMagic : true},
		texTranscript                              : {name : "TeX transcript", ext : [".log"], magic : ["TeX transcript"]},
		thinEdgeModel                              : {name : "thinEdge model", ext : [".m15"], magic : ["thinEdge model"]},
		...
		timingWizardReport                         : {name : "Timing Wizard Report", ext : [".twr"], magic : ["Timing Wizard Report"], weakMagic : true},
		...
		torState                                   : {name : "Tor state", magic : ["Tor state"]},
		totalCommanderCRCFile                      : {name : "Total Commander CRC file", ext : [".crc"], magic : ["Total Commander CRC file"], weakMagic : true},
		...
		triposMol2                                 : {name : "Tripos Mol2", ext : [".mol2"], magic : ["Tripos Mol2"], weakMagic : true},
		trumpetWindsockSettings                    : {name : "Trumpet Windsock settings", ext : [".ini"], magic : ["Trumpet Windsock settings"]},
		tsplibTourSolutionData                     : {name : "TSPLIB Tour Solution data", ext : [".tour"], magic : ["TSPLIB Tour Solution data"], weakMagic : true},
		tsplibTravelingSalesmanProblemData         : {name : "TSPLIB Traveling Salesman Problem data", ext : [".tsp"], magic : ["TSPLIB Traveling Salesman Problem data"], weakMagic : true},
		tsplibVehicleRoutingProblemData            : {name : "TSPLIB Vehicle Routing Problem data", ext : [".vrp"], magic : ["TSPLIB Vehicle Routing Problem data"], weakMagic : true},
		...
		vericutModelFile                           : {name : "VERICUT Model file", magic : ["VERICUT Model file"]},
		...
		vetCRCFileValidationData                   : {name : "VET CRC File Validation data", ext : [".dat"], magic : ["VET CRC File Validation data"]},
		...
		vimSyntax                                  : {name : "Vim syntax", magic : ["Vim syntax"]},
		vistaScript                                : {name : "Vista Script", ext : [".prefs", ".script"], magic : ["Vista Script", "Vista camera Script"]},
		visualizationToolkitFormat                 : {name : "Visualization Toolkit format", ext : [".vtk"], magic : ["Visualization Toolkit format", /^fmt\/(2010|2011)( |$)/], weakMagic : true},
		...
		wddxPacket                                 : {name : "WDDX packet", magic : ["WDDX packet"]},
		...
		willowCreekProgrammersEditorKeyboardDef    : {name : "Willow Creek Programmer's Editor Keyboard Command Definition", ext : [".kcd"], magic : ["Willow Creek Programmer's Editor Keyboard Command Definition"]},
		...
		windowsHostsList                           : {name : "Windows hosts list", filename : [/^hosts$/i], weakFilename : true, magic : ["Windows hosts list"], weakMagic : true},
		...
		windowsSetupINFormation                    : {name : "Windows Setup INFormation", website : "http://fileformats.archiveteam.org/wiki/INF_(Windows)", magic : [/^Windows [Ss]etup I(NF|nf)ormation/, "Windows driver setup Information", "INF Datei [Version]", /^x-fmt\/420( |$)/]},
		windowsSetupTableFile                      : {name : "Windows Setup Table File", ext : [".stf"], magic : ["Windows Setup Table File"]},
		windowsURLShortcut                         : {name : "Windows URL shortcut", ext : [".url"], magic : ["Windows URL shortcut", "URL Datei", "MS Windows 95 Internet shortcut", "application/x-mswinurl", /^x-fmt\/454( |$)/], weakMagic : [/^x-fmt\/454( |$)/], idMeta : ({macFileType, macFileCreator}) => (macFileType==="AURL" && macFileCreator==="Arch") || (macFileType?.startsWith("URL") && macFileCreator==="MOSS")},
		...
		winUAEConfiguration                        : {name : "WinUAE Configuration", ext : [".uae", ".cache"], magic : ["UAE - WinUAE Configuration", "WinUAE configuration Cache"], weakMagic : true},
		...
		wordStarForWindowsMacro                    : {name : "WordStar for Windows Macro", ext : [".wmc"], magic : ["WordStar for Windows Macro"]},
		x509Certificate                            : {name : "X.509 Certificate", magic : ["X.509v3 security certificate", "X.509 Digital Certificate", "application/pkix-cert"]},
		...
		xeroxRoomsSettings                         : {name : "Xerox Rooms settings", ext : [".ini"], magic : ["Xerox Rooms settings"], weakMagic : true},
		xeroxRoomsSuite                            : {name : "Xerox Rooms Suite", ext : [".ste"], magic : ["Xerox Rooms Suite"], weakMagic : true},

...
export class powerPoint extends Format
{
	...
	forbidExtMatch = true;
	magic          = [
		"Microsoft PowerPoint", "PowerPoint Microsoft Office Open XML Format document", "Forethought PowerPoint", "PowerPoint Presentation", "PowerPoint 97 presentation", /^PowerPoint :(ppt|pps):/,

...
export class sgi extends Format
{
	...
	metaProvider = ["image"];
	converters   = ["convert", "deark[module:sgiimage]", "nconvert", "gimp", `abydosconvert[format:${this.mimeType}]`, "ffmpeg[format:sgi_pipe][outType:png]", "hiJaakExpress", "canvas", "tomsViewer"];
}

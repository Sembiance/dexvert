...
const _INSTALLER_MAGICS = [
	...
	"Installer: Multimedia Fusion Installer", "Installer: Multimedia Fusion Installer", "Installer: Blizzard PrePatch(2.xx)", "Installer: Box Stub", "Installer: WiX Toolset installer",
...
export class exe extends Format
{
	...
	magic   = [
		...
		"Total Commander Content plugin", "Total Commander File system extension (plugin)",

...
export class installShieldCAB extends Format
{
	...
	ext          = [".cab"];
	magic        = ["InstallShield CAB", "InstallShield Cabinet archive", "InstallShield Compressed Archive", "ISC Archiv gefunden", "Archive: InstallShield Cabinet File", /^idarc: InstallShield CAB( |$)/, /^geArchive: (CAB_ISC|CAB_ISC_2|CAB_ISC_3)( |$)/];
	keepFilename = true;

...
type_module_name_map = {
	...
	'HbDoorCutout': 'nifgen.formats.habitatboundary.structs.HbDoorCutout',
	'HbPostPos': 'nifgen.formats.habitatboundary.structs.HbPostPos',
	'HbPostSize': 'nifgen.formats.habitatboundary.structs.HbPostSize',
	'HbPhysicsOffsets': 'nifgen.formats.habitatboundary.structs.HbPhysicsOffsets',
	'HbOffsets': 'nifgen.formats.habitatboundary.structs.HbOffsets',
	'HbUiOptions': 'nifgen.formats.habitatboundary.structs.HbUiOptions',
	'HbPropPhysics': 'nifgen.formats.habitatboundary.structs.HbPropPhysics',
	'HabitatBoundaryPropRoot': 'nifgen.formats.habitatboundary.structs.HabitatBoundaryPropRoot',
	'HabitatBoundaryDataRoot': 'nifgen.formats.habitatboundary.structs.HabitatBoundaryDataRoot',
	'ClimbproofDataRoot': 'nifgen.formats.habitatboundary.structs.ClimbproofDataRoot',
}

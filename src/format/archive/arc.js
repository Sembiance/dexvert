...
export class arc extends Format
{
	...
	ext        = [".arc", ".pak"];
	magic      = ["PAK/ARC Compressed archive", "ARC archive data", "16bit DOS EXE ARC self extracting archive", "SDN Project format (PAK)", "application/x-arc", /^ARC$/, /^ARC\+ archive data/];

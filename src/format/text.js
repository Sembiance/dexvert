...
export default
{
	text :
	{
		...
		sshPublicKey                               : {name : "SSH Public key", ext : [".pub"], magic : [/^SSH-.+ Public key/, "SSH/SECSH Public Key File Format", "Format: SSH Public Key", /^OpenSSH .+ public key/], weakMagic : true},

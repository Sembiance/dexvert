...
export class zip extends Format
{
	...
	magic          = [
		...
		"Theme Manager / WinStyles theme", "Adobe InDesign Markup Language", "TuneUp Style Boot Screen", "TIP Archiv gefunden", /^IOS\/iPadOS IPA file/, "Tableau Packaged Workbook", "Maxthon skin (MX1)", "Pencil template",

...
export class lha extends Format
{
	...
	magic = ["LHARC/LZARK compressed archive", /^LHa .*archive data/, "LHA File Format", "LHA self-extracting", "LHarc self-extracting archive", /^LHarc .*archive data/, "LArc compressed archive", /^Self-extracting LZH$/, /^LZH$/, /^fmt\/626( |$)/];

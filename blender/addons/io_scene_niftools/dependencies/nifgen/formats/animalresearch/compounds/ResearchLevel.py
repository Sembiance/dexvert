...
class ResearchLevel(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.next_levels = name_type_map['Pointer'](self.context, self.next_level_count, name_type_map['ZStringList'])
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		yield 'next_levels', name_type_map['Pointer'], (instance.next_level_count, name_type_map['ZStringList']), (False, None)

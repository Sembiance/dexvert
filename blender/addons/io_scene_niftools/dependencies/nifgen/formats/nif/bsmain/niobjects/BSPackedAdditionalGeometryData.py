...
class BSPackedAdditionalGeometryData(AbstractAdditionalGeometryData):
	...
	__name__ = 'BSPackedAdditionalGeometryData'
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.blocks = Array(self.context, 1, None, (0,), name_type_map['NiAGDDataBlocks'])
		if set_default:
			self.set_defaults()
	...
	def _get_attribute_list(cls):
		...
		yield 'blocks', Array, (1, None, (None,), name_type_map['NiAGDDataBlocks']), (False, None), (None, None)
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		yield 'blocks', Array, (1, None, (instance.num_blocks,), name_type_map['NiAGDDataBlocks']), (False, None)

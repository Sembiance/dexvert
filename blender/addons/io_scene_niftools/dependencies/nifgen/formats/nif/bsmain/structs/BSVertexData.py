...
class BSVertexData(BaseStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.vertex = name_type_map['HalfVector3'](self.context, 0, None)
		self.bitangent_x = name_type_map['Hfloat'](self.context, 0, None)
		self.unused_w = name_type_map['Ushort'](self.context, 0, None)
	...
	def _get_attribute_list(cls):
		...
		yield 'vertex', name_type_map['HalfVector3'], (0, None), (False, None), (None, True)
		yield 'bitangent_x', name_type_map['Hfloat'], (0, None), (False, None), (None, True)
		yield 'unused_w', name_type_map['Ushort'], (0, None), (False, None), (None, True)
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		if (instance.arg & 1025) == 1025:
			yield 'vertex', name_type_map['Vector3'], (0, None), (False, None)
		if (instance.arg & 1041) == 1041:
			yield 'bitangent_x', name_type_map['Float'], (0, None), (False, None)
		if (instance.arg & 1041) == 1025:
			yield 'unused_w', name_type_map['Uint'], (0, None), (False, None)
		if (instance.arg & 1025) == 1:
			yield 'vertex', name_type_map['HalfVector3'], (0, None), (False, None)
		if (instance.arg & 1041) == 17:
			yield 'bitangent_x', name_type_map['Hfloat'], (0, None), (False, None)
		if (instance.arg & 1041) == 1:
			yield 'unused_w', name_type_map['Ushort'], (0, None), (False, None)
		if (instance.arg & 2) != 0:

...
export class starWriter extends Format
{
	...
	ext            = [".sdw", ".tpl", ".vor"];
	forbidExtMatch = true;
	magic          = ["StarOffice StarWriter document", "StarOffice Writer document", "StarWriter for MS-DOS document", "StarWriter 2.x Document", "application/vnd.stardivision.writer", /^fmt\/812( |$)/, /^x-fmt\/400( |$)/];

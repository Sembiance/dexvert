...
export default
{
	text :
	{
		...
		pgpPublicKey                               : {name : "PGP Public/Private Key", website : "http://fileformats.archiveteam.org/wiki/PGP_public_key", ext : [".asc", ".aexpk", ".pgp", ".pub"], magic : [/^PGP (public|private) key block/, "PGP armored data, public key block", "application/pgp-keys"], weakMagic : ["application/pgp-keys"]},
		...
		windowsURLShortcut                         : {name : "Windows URL shortcut", ext : [".url"], magic : ["Windows URL shortcut", "URL Datei", "MS Windows 95 Internet shortcut", "application/x-mswinurl", /^x-fmt\/454( |$)/], weakMagic : ["Windows URL shortcut"], idMeta : ({macFileType, macFileCreator}) => macFileType==="AURL" && macFileCreator==="Arch"},

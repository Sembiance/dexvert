...
export default
{
	...
	executable :
	{
		...
		elf                                  : {name : "ELF Executable", magic : ["ELF Executable and Linkable format", /^ELF,? \d\d-bit (N32 )?[LM]SB (MIPS-II?I? )?(\*unknown arch[^*]+\*)?(executable|relocatable|shared object)/, "Executable and Linkable Format", /^Unix\/Linux \d+-Bit/, /^fmt\/(688|689|690)( |$)/]},
	...
	other :
	{
		...
		chessmaster4000ClassicGamesLibrary : {name : "The Chessmaster 4000 classic games library", ext : [".cml", ".dat"], magic : ["The Chessmaster 4000 classic games library"]},

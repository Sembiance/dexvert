...
class Ms3dModel:
    ...
    def read(self, raw_io):
        ...
        try:
            ...
            debug_out.append(f"Ms3dModel.read - exception in optional try block,"
                    f" _progress={_progress}\n  type: '{exc_type}'\n  value: '{format_exc()}'\n"
                    )
    ...
    def write(self, raw_io):
        ...
        try:
            ...
            exc_type, exc_value, exc_traceback = exc_info()
            debug_out.append(f"Ms3dModel.write - exception in optional try block,"
                    f" _progress={_progress}\n  type: '{exc_type}'\n  value: '{format_exc()}'\n"
                    )
            pass

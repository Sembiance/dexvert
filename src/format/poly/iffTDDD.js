...
export class iffTDDD extends Format
{
	...
	ext            = [".iob", ".tdd", ".tddd", ".cel", ".obj"];
	forbidExtMatch = [".cel", ".obj"];
	magic          = ["IFF data, TDDD 3-D rendering", "3D Data Description object", "Impulse 3D Data Description Object", "TurboSilver cell/animation data", /^fmt\/1206( |$)/];

...
export class msCompound extends Format
{
	...
	magic            = [
		...
		"Rockwell Logix 500 SLC-5 Software", "muvee autoProducer Project", "VideoStudio Project", "DesignCAD drawing", "Font FX Template", "Softimage Scene", "Softimage Exported 3D Model", "Ability Office Spreadsheet",

...
export default
{
	text :
	{
		...
		mathematicaNotebook                     : {name : "Mathematica notebook", ext : [".nb", ".nbp"], magic : ["Mathematica notebook", /^Mathematica notebook/], weakMagic : true},
		...
		verityCollectionIndexAbout              : {name : "Verity Collection Index About", ext : [".abt"], magic : ["Verity Collection Index About", /^fmt\/453( |$)/]},

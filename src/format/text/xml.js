...
const _XML_MAGIC = [
	...
	"Sandcastle Help File Builder Project", "Battlefield 2 mod Description", "Visual Studio Publish profile", "Qt Help Project", "RoboHelp XML Project", "Rosegarden note style", "TextMate Preferences", "TextMate Project", "OmniOutliner document (v3-4)",

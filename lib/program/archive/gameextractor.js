...
exports.args = (state, p, inPath=path.join(state.cwd, state.input.filePath), outPath=path.join(state.cwd, state.output.dirPath)) => (["-extract", "-input", inPath, "-output", outPath]);

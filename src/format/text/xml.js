...
const _XML_MAGIC = [
	...
	"DialogBlocks Project", /^FinalBuilder (actions Package|code completion info|Project \(v4\)|Wizard)/, "Adobe Premiere Preset", "Automise Project (v3)", "OWL XML Ontology", /^Gentoo (category|package) metadata file/,

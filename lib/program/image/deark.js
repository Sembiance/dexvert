...
exports.bin = () => "deark";
exports.args = (state, p, r, inPath=state.input.filePath, outPath=state.output.dirPath, outName=state.input.name) => (["-opt", `char:output=${state.dearkCharOutput || "image"}`, "-od", outPath, "-o", outName, inPath]);
exports.post = (state, p, r, cb) =>
{
	...
	else
	{
		tiptoe(
			...
			{
				p.util.program.run("ffmpeg", {stateFlags : {ffmpegExt : ".mp4"}, argsd : [this.data.GIFFilePath]})(state, p, this);
			},

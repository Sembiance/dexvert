...
export class html extends Format
{
	...
	weakFilename   = true;
	mimeType       = "text/html";
	magic          = ["HyperText Markup Language with DOCTYPE", "HTML (Hyper Text Markup Language) Datei", /^Hyper[Tt]ext Markup Language/, /^HTML document/, /^fmt\/(96|97|98|99|100|102|471)( |$)/];
	weakMagic      = true;
	trustMagic     = true;
	untouched      = true;
	metaProvider   = ["text"];

...
export class commodoreTapeImage extends Format
{
	...
	ext     = [".t64"];
	magic   = ["T64 Tape Image", "Commodore 64 Tape container", "C64 Tape image format", "C64 Raw Tape File", /^Commodore (raw )?Tape image/, /^fmt\/(802|820)( |$)/];
	idMeta  = ({macFileType, macFileCreator}) => macFileType==="TAPE" && macFileCreator==="Frdo";

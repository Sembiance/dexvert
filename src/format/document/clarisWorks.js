...
export class clarisWorks extends Format
{
	...
	ext            = [".cwk", ".cws"];
	forbidExtMatch = true;
	magic          = [/AppleWorks\/ClarisWorks .+Document/, "Claris Works document", "AppleWorks CWK Document", /^fmt\/(736|737|738|739|740|741|742|743|744|748|749|750|845|846|847|849)( |$)/];
	idMeta         = ({macFileType, macFileCreator}) => ["CWDB", "CWGR", "CWPT", "CWSS", "CWWP", "lCLW", "sWWP"].includes(macFileType) && macFileCreator==="BOBO";

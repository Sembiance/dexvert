...
const _XML_MAGIC = [
	...
	"SMath Studio document (old)", "XBMC Smart Playlist", "Abstract Markup Language", "WiX Project (UTF-8)", "Code::Blocks lexer", "UpdateStar info", "Lazarus Package", "Code::Blocks lexer",

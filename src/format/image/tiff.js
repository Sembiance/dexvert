...
export class tiff extends Format
{
	...
	converters = ["deark[noThumbs]", "convert", "imageAlchemy", "graphicWorkshopProfessional", "hiJaakExpress", "imjview", "gimp", "corelPhotoPaint", "canvas", "tomsViewer", "picturePublisher", "pv[matchType:magic]"];
}

...
export class iffILBM extends Format
{
	...
	magic          = ["IFF InterLeaved BitMap", "IFF data, ILBM interleaved image", "Interchange File Format Interleaved Bitmap", "IFF ILBM bitmap", "IFF Packed Bitmap", "DCTV encoded ILBM bitmap", "IFF Sliced HAM bitmap", "IFF ILBM (Generic)", /^fmt\/338( |$)/];

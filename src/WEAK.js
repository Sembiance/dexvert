...
[
	...
	// SEEN  ONCE:
	// 		image:Discovery.Pr1Format, image:Sony.TimFormat, image:Elf.RmtFormat, image:Gs.PicFormat, image:Ego.AntFormat, image:Leaf.PxFormat, image:MAGES.BinFormat, image:Mapl.Mi2Format, image:Softpal.PicFormat
	// SEEN TWICE:
	...
	// SEEN TWICE:
	// 		SOL_DISK, PCK_5, PACK_3, PAK_PACK_3, PAK_PACK_4, TEXS_SXET, SFX_DSFX, 000_10, CAR_FRAC, BANK_QL, CDF_TXTR, PAK_50, PRJ_PROJ, SMA_SMA, BANK_RIFF, DAT_100, 000_SFDX, VOL_VOL_3, PSF_PSF, CMF
	...
	// SEEN TWICE: PPMN (Max Smirnov), BOA, QuArk, X1
	/^idarc: ACB( |$)/,
	/^idarc: ARG( |$)/,
	/^idarc: Arhangel( |$)/,
	/^idarc: DitPack( |$)/,
	...
	/^COFF format/,
	/^.* ?[EX]?COFF$/,
	/^.* ?[EX]?COFF (pure )?(NetBSD\/alpha )?(binary|DSP21k|executable|format|object|(not )?stripped)/,
	/^ColoRIX Slideshow$/,
	...
	/^Corel (DataPerfect|DrawPerfect|LetterPerfect|Mail|Printer|Shell|WordPerfect)( Office)?: Unknown filetype/,
	/^Corel loadable file/,
	...
	/^GTA (animation data|archive|audio index data|in-game|script|Windows Frag Type)/,
	/^GTA1 /,
	/^GTA2 /,
	...
	/^Mach-O (arm|armv6|architecture|executable|i\d86|ns32532|universal binary|vax)/,
	/^Mach-O (alpha|i860g|m68k|ns\d+) filetype=\d+/,
	/^magic text fragment/,
	...
	/^Objective-C source/,
	/^Octave binary data/,
	/^Ogg data( UNKNOWN REVISION \d+)?(, ASCII text)?(, with no line terminators)?$/,
	...
	/^User-Mode-Linux's Copy-On-Write/,
	/^v8 bytecode/,
	...
	/^Aegis Impact! Table$/,
	/^Alpha Five Data Dictionary Memo$/,
	...
	/^Chromium PACK resource archive/,
	/^Clonk game data$/,
	...
	/^Cryptic Studios game data \(generic\)$/,
	/^Cydonia game data$/,
	/^Darkmere game data$/,
	/^Denver camera video$/,
	...
	/^Outlook Mac temporary data \(generic\)$/,
	/^OziExplorer Map$/,
	...
	/^Better Working Eight-In-One (Document|spreadsheet)$/,
	/^BGA compressed archive \(Gzip\)$/,
	/^BGI\/Ethornell game engine data \(v1\.0\)$/,
	/^BibTeX (references|Style)/,
	/^Big Mutha Truckers 2 game data Archive$/,
	/^BIGH Electronic Arts game data archive$/,
	/^binpatch format$/,
	...
	/^divANS Intermediate Representation$/,
	/^Diz compressed data$/,
	...
	/^Enter a useful filetype description$/,
	...
	/^Expression Media template index$/,
	...
	/^Feather binary data frame storage$/,
	/^Fenix bytecode$/,
	...
	/^Flask Environment settings \(with rem\)$/,
	/^FlexiDATA Database$/,
	/^FM Towns Palette$/,
	/^foobar2000 component$/,
	/^Free Radical P4CK game data archive$/,
	...
	/^Frogwares Game Development Studio saved game \(generic\)$/,
	/^FromSoftware game data archive$/,
	/^FSEvents Disk Log Stream format \(v2\)$/,
	/^Furnace Instrument \(new\)$/,
	/^Game Boy Advance ROM$/,
	/^GameBox game data package/,
	/^Game Music$/,
	/^GameCube THP video$/,
	/^GameMaps Header \(RLEW compression\)$/,
	/^Garry's Mod Addon$/,
	/^Gazebo model Configuration$/,
	/^GDC compressed disk image$/,
	/^GEM Application \(Intel\)$/,
	/^GenePattern GCT format$/,
	/^Generic (IFF|RIFX) container$/,
	/^Genieous Snapshot$/,
	/^GeoJSON format$/,
	/^Gerber format$/,
	/^GetRight Skin$/,
	...
	/^HTTP Archive( format)?$/,
	/^Huawei firmware partition image$/,
	/^Hugin Project$/,
	/^HydraVision Texture$/,
	/^ICE ECC data \(v2\.x\)$/,
	/^IceTracker module/,
	...
	/^jetAudio skin$/,
	/^JETPilot bitmap$/,
	/^Journey to the Center of the Earth save game$/,
	/^JPC snapsot$/,
	/^JSON (array|object) \(generic\)$/,
	/^JSON Entity Model$/,
	/^JSON Playlist File$/,
	...
	/^Labeler \(v3\.0\) \/ Labels Unlimited \(v2\.0\) Job$/,
	...
	/^LEN Exchange Format$/,
	/^Laser Compact compressed screen$/,
	...
	/^MG!2 compressed$/,
	/^Microbee tape image$/,
	/^Microids LZS compressed game data \(generic\)$/,
	...
	/^Microsoft Test compiled P-Code \(v3\.0\)$/,
	/^Microsoft Works/,	// Ends up matching a bunch of 'file' identifications too, but eh
	/^Microsoft Visio Template$/,
	/^MIDIAN Single Request$/,
	/^Midtown Madness game data archive$/,
	/^Midtown Madness 2 game data archive$/,
	/^MikuMikuDance Model$/,
	/^Milestones \d\.\d schedule data$/,
	...
	/^MSPLOT Plotter PCD source file format \(with rem\)$/,
	...
	/^PinPoint Form$/,
	/^Pixelmator bitmap$/,
	/^PKZIP mini-self-extracting 16bit DOS executable \(variant\)$/,
	/^Playmation Muscle$/,
	/^Playmation Surface$/,
	...
	/^ReqAttack Image$/,
	/^Resume$/,
	/^Rich Game format \((big|little)-endian\)$/,
	/^RichView Format \(Unicode\)$/,
	/^Rigol Binary waveform \(generic\)$/,
	/^Roblox FileMesh \(v1\.00-1\.01\)$/,
	/^Rock Band multi track music$/,
	/^Roland music sequence \(generic\)$/,
	/^ROOT format$/,
	...
	/^Surfer Grid$/,
	/^Sweet Home 3D [Dd]esign \(generic\)$/,
	/^Sybase Data Base$/,
	...
	/^SynWrite Snippet$/,
	/^Taxman's Retro Engine v5 (3D Model|Sprite info)$/,
	...
	/^Total Annihilation game data package$/,
	...
	/^V8 JavaScript Compiled code \(generic\)$/,
	/^Vaulty obscured$/,
	/^VBIN container$/,
	/^VCOM Web Easy album$/,
	...
	/^Windows Bitmap \(generic\)/,
	/^Windows Control Panel Item \(generic\)$/,
	/^Windows Font resource/,
	...
	/^ZTE device configuration \(generic\)$/,
	/^Zuma's Revenge game data archive$/,

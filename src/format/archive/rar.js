...
export class rar extends Format
{
	...
	ext          = [".rar", ".exe"];
	magic        = ["RAR archive data", "RAR compressed archive", "RAR Archive", /RAR self-extracting archive/, /^RAR$/, /^RAR 5$/, "Embedded RAR", "RAR Archiv gefunden", "Archive: RAR", /^fmt\/(411|613)( |$)/, /^x-fmt\/264( |$)/];

...
export class tga extends Format
{
	...
	magic        = ["Truevision TGA", "Targa image data", "image/x-tga", "deark: tga (TGA)", /^Truevision TARGA \(Type \d+\) :tga:$/, /^fmt\/402( |$)/, /^x-fmt\/367( |$)/];
	...
	converters = [
		"deark[module:tga][matchType:magic][opt:tga:trans=0]", "deark[module:tga][matchType:magic][hasExtMatch][opt:tga:trans=0]", "wuimg", "imconv[format:tga][matchType:magic]", "iconvert",
		"imageAlchemy", "paintDotNet[hasExtMatch]",
		"keyViewPro", "corelDRAW[hasExtMatch]", "pv", "photoDraw",
		"nconvert[format:tga]", "recoil2png", "gimp", "iio2png",

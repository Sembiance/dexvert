...
export class jpg extends Format
{
	...
	mimeType         = "image/jpeg";
	magic            = ["JFIF JPEG bitmap", "JPEG image data", "JPEG bitmap", "JPEG File Interchange Format", "JFIF-EXIF JPEG Bitmap", /^fmt\/(41|42|43|44)( |$)/];
	...
	metaProvider     = ["image"];
	converters       = ["imageAlchemy", "pv[matchType:magic]"];	// some jpgs are corrupt (image5.jpg, mpfeif07.jpg, ring_mo4.jpg) but imageAlchemy/pv are flexible and can handle them
}

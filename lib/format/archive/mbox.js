				...
				rl.on("line", line =>
				{
					...
					if(sepMatch && prevLineEmpty)
					{
						if(Object.keys(msg).length>0)
						{
							...
							fs.writeFile(path.join(state.output.absolute, (""+msgCount++).padStart(6, "0") + "_" + msg.meta.sender + "_" + msg.meta.timestamp + ".msg"), msg.lines.join("\r\n"), XU.UTF8, this.parallel());
						}

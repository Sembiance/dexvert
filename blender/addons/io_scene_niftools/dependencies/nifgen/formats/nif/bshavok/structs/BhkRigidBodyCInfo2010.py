...
class BhkRigidBodyCInfo2010(BaseStruct):

	__name__ = 'bhkRigidBodyCInfo2010'
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.time_factor = name_type_map['Float'].from_value(1.0)
	...
	def _get_attribute_list(cls):
		...
		yield 'time_factor', name_type_map['Float'], (0, None), (False, 1.0), (None, None)
		...
		yield 'unused_04', Array, (0, None, (12,), name_type_map['Byte']), (False, None), (None, None)
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		yield 'time_factor', name_type_map['Float'], (0, None), (False, 1.0)
		...
		yield 'unused_04', Array, (0, None, (12,), name_type_map['Byte']), (False, None)

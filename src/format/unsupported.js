...
export default
{
	...
	other :
	{
		...
		linuxKernel                              : {name : "Linux Kernel", filename : [/^vmlinuz$/, /^bzImage$/], weakFilename : true, magic : [/^Linux kernel$/, /^Linux kernel .*boot (executable|image)/, /^Linux kernel build-in loader/, /^Linux kernel.*(bzImage|x86 bootable)/, /^Linux .+kernel root/, "Linux style boot sector", "Linux x86 boot sector", "Linux kernel from prehistoric times", "Linux kernel version 1.3.79 or older"]},

...
exports.args = (state, p, r, inPath=state.input.filePath, outPath=path.join(state.output.dirPath, "outfile.png")) => ([...(state.ansiloveType ? ["-t", state.ansiloveType] : []), "-S", "-i", "-o", outPath, inPath]);

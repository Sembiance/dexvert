...
export default
{
	...
	other :
	{
		...
		borlandDelphiCompiledUnit    : {name : "Borland Delphi Compiled Unit", ext : [".dcu"], magic : ["Borland Delphi .DCU file", "Borland Delphi 6 Library", "Turbo Pascal Delphi 1 Unit", /^Delphi \d+ Compiled Unit/]},
		...
		turboPascalSymbolTable       : {name : "Turbo Pascal Symbol Table", ext : [".psm"], magic : ["Turbo Pascal Symbol Table"], weakMagic : true},

...
type_module_name_map = {
	...
	'Color': 'nifgen.formats.fgm.compounds.Color',
	'AttribData': 'nifgen.formats.fgm.compounds.AttribData',
	'FgmDtype': 'nifgen.formats.fgm.enums.FgmDtype',
	'FgmHeader': 'nifgen.formats.fgm.compounds.FgmHeader',
	'GenericInfo': 'nifgen.formats.fgm.compounds.GenericInfo',
	'TexIndex': 'nifgen.formats.fgm.compounds.TexIndex',
	'TextureInfo': 'nifgen.formats.fgm.compounds.TextureInfo',
	'AttribInfo': 'nifgen.formats.fgm.compounds.AttribInfo',
	'TextureData': 'nifgen.formats.fgm.compounds.TextureData',
}

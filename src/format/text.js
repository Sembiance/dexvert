...
export default
{
	text :
	{
		...
		gimpPalette                  : {name : "GIMP palette", magic : ["GIMP palette data", /^GIMP Palette$/, /^fmt\/1844( |$)/]},
		...
		awk                                    : {name : "AWK Script", ext : [".awk"], magic : ["a /bin/awk", "Shell Skript: '/bin/awk", `Executable script, shebang: "/bin/awk`, "awk or perl script", /^a awk script/, /^(new|GNU)? ?awk script text executable/], weakMagic : ["awk or perl script"]},
		...
		tclTkScript                            : {name : "Tcl/Tk script", ext : [".tcl"], magic : ["Tcl/Tk script text executable", /^a .*\/wish[\d.]* script/, /^Executable script, shebang: ".*\/wish[\d.]*"/, /^Shell Skript: '.*\/wish[\d.]*'/]},
		...
		dataInterchangeFormat                   : {name : "Data Interchange Format", ext : [".dif"], magic : ["Data Interchange Format", /^x-fmt\/41( |$)/], weakMagic : true},
		...
		makerInterchangeFormat                  : {name : "Maker Interchange Format", ext : [".mif"], magic : ["Maker Interchange Format", /^FrameMaker MIF/, "Framemaker Interchange Datei", /^x-fmt\/162( |$)/], weakMagic : true},
		...
		vCard                                   : {name : "vCard", website : "http://fileformats.archiveteam.org/wiki/VCard", ext : [".vcf", ".vcard"], magic : ["vCard - Business Card", "vCard visiting card", /^vCard$/, /^fmt\/(395|1879)( |$)/]},

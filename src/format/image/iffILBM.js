...
export class iffILBM extends Format
{
	...
	converters = [`recoil2png`, "deark", "ffmpeg[format:iff][outType:png]", "convert", `abydosconvert[format:${this.mimeType}][outType:png]`, "iff_convert", "hiJaakExpress", "pv[matchType:magic]", "canvas"];
}

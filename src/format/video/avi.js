...
const _AVI_MAGIC = ["AVI Audio Video Interleaved", /^RIFF.* data, AVI.*/, "Audio/Video Interleaved Format", "Animation Video (AVI)", "Audio Video Interleave video", "Format: AVI", "video/vnd.avi", "AVI (Audio Video Interleaved) (avi)", /^fmt\/5( |$)/];
export {_AVI_MAGIC};

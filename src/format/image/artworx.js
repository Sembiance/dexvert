...
export class artworx extends Format
{
	...
	converters = dexState => (dexState.meta?.formatName==="adf" ? ["ansilove[format:adf]", "ffmpeg[format:adf][outType:png]", "deark[module:artworx_adf]", `abydosconvert[format:${this.mimeType}]`] : []);
}

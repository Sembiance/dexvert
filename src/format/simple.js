...
export default
{
	...
	other :
	{
		...
		visualBasicForm                 : {name : "Visual Basic Form", ext : [".frm", ".frx"], magic : ["Visual Basic Form", "Microsoft Visual Basic Form", /^fmt\/(1541|1542)( |$)/], website : "http://fileformats.archiveteam.org/wiki/VisualBasic_form"},

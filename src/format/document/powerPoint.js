...
export class powerPoint extends Format
{
	...
	forbidExtMatch = true;
	magic          = ["Microsoft PowerPoint", "PowerPoint Microsoft Office Open XML Format document", "Forethought PowerPoint", "PowerPoint Presentation", /^fmt\/(125|126|215|629|1747|1748|1866|1867)( |$)/, /^x-fmt\/88( |$)/];

...
# If need to change floppies, add args: -drive file=Disk01.img,index=0,if=floppy,format=raw -monitor stdio  and then on console type: change floppy0 Disk02.img
# -vnc :14

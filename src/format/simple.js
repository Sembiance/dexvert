...
export default
{
	document :
	{
		...
		amiProWordProDocument     : {name : "Ami Pro/Word Pro document", ext : [".sam"], magic : ["Ami Pro/Word Pro document"], weakMagic : true},
		...
		gnuInfo                   : {name : "GNU Info File", ext : [".info-1", ".info-2", ".info-3", ".info-4", ".info-5", ".info-6", ".info-7", ".info-8", ".info-9"], magic : [/^GNU Info(, ASCII text)?$/]}, // We do NOT include Trid's "GNU Info document" because it's too loose
	...
	other :
	{
		...
		modulaDefinition                      : {name : "Modula Definitions", ext : [".def"], magic : ["Modula Definitionsdatei"]},
		...
		msvcPCH                               : {name : "Microsoft Visual C PCH file", ext : [".pch", ".dbg"], magic : ["Microsoft Visual C .pch", "Microsoft Precompiled Header Datei"]},
		...
		ps2MicroChannelAdapterDescriptionFile : {name : "PS/2 MicroChannel Adapter Description File", ext : [".adf"], magic : ["PS/2 MicroChannel Adapter Description File"], weakMagic : true},
		...
		visualBasicForm                       : {name : "Visual Basic Form", ext : [".frm", ".frx"], magic : ["Visual Basic Form", "VisualBasic Form", "Microsoft Visual Basic Form", /^fmt\/(1541|1542)( |$)/], website : "http://fileformats.archiveteam.org/wiki/VisualBasic_form"},

...
export class tiff extends Format
{
	...
	magic        = [
		// Generic TIFF files
		"Tagged Image File Format", "TIFF image data", "Macintosh TIFF bitmap (MacBinary)", "image/tiff", "piped tiff sequence (tiff_pipe)", "deark: tiff (TIFF)", /^fmt\/(154|155|353)( |$)/, /^x-fmt\/(387|388|399)( |$)/,

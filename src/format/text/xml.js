...
const _XML_MAGIC = [
	...
	"Portable Application Description (UTF-8) (PAD)", "Siemens TIA project (v11)", "DockPanel configuration", "GObject Introspection information", "application/metalink+xml", "ZModeler profile", "Compass and Ruler Macro",

...
exports.bin = () => "scribus";
exports.args = (state, p, inPath="conv.py") => (["--prefs", path.join(__dirname, "..", "..", "..", "scribus"), "-ns", "-py", inPath]);
...
exports.post = (state, p, cb) => p.util.program.run("inkscape", {args : p.program.inkscape.args(state, p, "outfile.eps")})(state, p, cb);

exports.runOptions = () => ({timeout : XU.MINUTE, virtualX : true});

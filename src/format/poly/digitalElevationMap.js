...
export class digitalElevationMap extends Format
{
	...
	unsupported = true;	// AccuTrans3D failed all. So did https://github.com/domlysz/BlenderGIS   and cinema4D427 only opened 1 of my samples, poorly. polyTrans64 didn't work either.
}

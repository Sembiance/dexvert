...
export class hlp extends Format
{
	...
	ext     = [".hlp"];
	magic   = ["Windows HELP File", /^MS Windows 3\.. help/, "Windows Help File", "MS Windows help Bookmark", "Windows 3.x Hilfedatei", "Windows 95/98 Hilfedatei", "Format: MS Help", 	/^MS Windows help annotation/, /^fmt\/474( |$)/];

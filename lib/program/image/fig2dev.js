...
exports.bin = () => "fig2dev";
exports.args = (state, p, inPath=state.input.base, outPath=path.join(state.output.dirPath, `outfile.${state.fig2devType || "svg"}`)) => (["-L", (state.fig2devType || "svg"), inPath, outPath]);

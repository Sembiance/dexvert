...
export class msCompound extends Format
{
	...
	magic            = [
		...
		"WordPerfect Slide Show", "ArcGIS Map project", "JewelCase Maker project", "Corel Gallery", "Serif PhotoPlus Picture (OLE)", "Neato MediaFACE label template",
		/^fmt\/(916|1213|1303|1360|1648)( |$)/, /^x-fmt\/(151|243)( |$)/
	];

...
export default
{
	...
	other :
	{
		...
		threeDCKObject              : {name : "3D Construction Kit Object", ext : [".3od", ".obj"], magic : [/^3D Construction Kit (\d? ?)Object$/]},
		threeDCKShapeData           : {name : "3D Construction Kit Shape Data", ext : [".3sd"], magic : [/^3D Construction Kit \d? ?Shape data$/]},
		threeDCKWorldData           : {name : "3D Construction Kit World Data", ext : [".kit"], magic : [/^3D Construction Kit \d? ?World data$/]},

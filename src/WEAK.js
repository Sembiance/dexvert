...
[
	...
	/^Apache Parquet/,
	/^(apl|APL) workspace/,
	/^[Aa]pollo (a88k|m68k) COFF executable/,
	/^Apollo DBF/,
	...
	/^Matlab v(4|Mat)/,
	/^Matlab (vand|vDIF|vFIR|vis|vpro|vsta) mat-file/,
	/^MAR archive data$/,
	...
	/^MySQL replication log, server id 1/,

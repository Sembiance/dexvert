...
export class faxGroup3 extends Format
{
	...
	metaProvider = ["image"];
	converters   = ["nconvert", "convert"];	// abydos can also convert this, but it will convert garbage files (text/txt/SKILLS1.G3) and produce garbage, where nconvert/convert are more strict

...
export class dll extends Format
{
	...
	magic        = [
		...
		"Pixia filter plugin", "Psycle plugin", "Ultimate Paint Graphics Editor plugin/effect", "Miranda IM plugin", "ACDSee plugin", "DLL PowerBASIC", "Microsoft Input Method Editor"
	];

...
export class msCompound extends Format
{
	...
	magic            = [
		...
		"Blaze Media Pro Skin", "AAF legacy file using MS Structured Storage", "602Tab Workbook", "PROMT document", "Business Objects Report", "Canon Design Essentials template", "Impromptu report", "Flexi Swatch Library",

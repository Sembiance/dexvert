...
class BoneVertDataHalf(BaseStruct):

	"""
	NiSkinData::BoneVertData. A vertex and its weight.
	"""

	__name__ = 'BoneVertDataHalf'
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.weight = name_type_map['Hfloat'](self.context, 0, None)
		if set_default:
			self.set_defaults()
	...
	def _get_attribute_list(cls):
		...
		yield 'weight', name_type_map['Hfloat'], (0, None), (False, None), (None, None)

	@classmethod
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		yield from super()._get_filtered_attribute_list(instance, include_abstract)
		yield 'index', name_type_map['Ushort'], (0, None), (False, None)
		yield 'weight', name_type_map['Hfloat'], (0, None), (False, None)

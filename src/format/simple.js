...
export default
{
	document :
	{
		...
		oberonText               : {name : "Oberon Text", ext : [".mod"], magic : ["Oberon V4 text format"], idMeta : ({macFileType, macFileCreator}) => macFileType===".Ob." && [".Ob2", ".Ob3", ".Ob4", ".Ob5", ".Ob6"].includes(macFileCreator)},

...
export class ini extends Format
{
	...
	magic          = ["Generic INI configuration", "Windows desktop.ini", "InstallShield Setup config", "INF Datei",
		"Microsoft Setup Toolkit for Windows files List", "LapLink 5 settings", "InstallShield Language Identifier", "TagInfo data", "TagInfo, ASCII text"];

...
export class pict extends Format
{
	...
	metaProvider   = ["image"];
	converters     = ["deark", "recoil2png", "nconvert", "qtPicViewer", "soffice[outType:png]", "hiJaakExpress", "convert"];	// convert has a habit of producing just a black square (sample: karo)
}

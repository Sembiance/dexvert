...
export class installerVISE extends Format
{
	...
	ext            = [".mac"];
	forbidExtMatch = true;
	magic          = ["Installer VISE Mac package", "Installer: Vise", "Installer VISE (MacBinary Wrapped)", "Installer VISE (MacBinary)"];
	keepFilename   = true;
	...
	idMeta         = ({macFileCreator}) => macFileCreator?.toLowerCase()==="vis3";

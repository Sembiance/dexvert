...
export class diskDoubler extends Format
{
	...
	idMeta       = ({macFileType, macFileCreator}) => ["DDAR", "DDfb", "DDfc", "DDfj", "DDFL", "DD01", "DDf0", "DDF0", "DDF1", "DDF2", "DDf3", "DDF3", "DDF4", "DDF5", "DDF6", "DDfh", "DDfr"].includes(macFileType) && macFileCreator==="DDAP";

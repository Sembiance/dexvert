...
export class wordDoc extends Format
{
	...
	ext            = [".doc", ".dot"];
	forbidExtMatch = true;
	magic          = ["Microsoft WinWord", "Microsoft Word document", "Microsoft Word for Windows", "CDFV2 Microsoft Word", "Format: MS Office 97-2003", /^Microsoft Word [\d.]+ Document/, /^fmt\/(37|38|39|40|609|754)( |$)/, /^x-fmt\/45( |$)/];
	converters     = [

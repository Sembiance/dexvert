...
const _MACBINARY_MAGIC = ["Macintosh MacBinary", "MacBinary 2", "MacBinary II", "MacBinary, inited", "MacBinary 1", "MacBinary 3", /^MacBinary$/, /^MacBinary, .*19[89]\d, modified .*19[89]\d/, / \(MacBinary\)$/, /^fmt\/(1762|1763)( |$)/];

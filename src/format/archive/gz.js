...
export class gz extends Format
{
	...
	magic        = [
		...
		// app specific gzip
		"bar archive gzip-compressed data", "MFS file system gzip-compressed data", "KOffice KPresenter Presentation", /^application\/x-(killustrator|kontour|kpresenter|kspread|kword)$/, "ReproZip (GZipped)"
	];

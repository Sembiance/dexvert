...
export class openOffice extends Format
{
	...
	forbidExtMatch = true;
	magic          = [/^OpenOffice(\.org ) ?([\dx.]+ )?(Calc|Impress|Writer)/, "OpenOffice Impress presentation", "application/vnd.sun.xml.writer", "application/vnd.sun.xml.impress", /^fmt\/(128|130|136|137)( |$)/];

...
export class corelGallery extends Format
{
	...
	ext        = [".bmf", ".gal"];
	magic      = ["Corel Binary Material Format", "Corel GALLERY Clipart", "deark: corel_bmf", "Corel Flow :cbmf:", /^fmt\/1413( |$)/];
	converters = ["deark[module:corel_bmf]", "nconvert[format:cbmf]"];

...
export class gz extends Format
{
	...
	magic        = [
		...
		// app specific gzip
		"bar archive gzip-compressed data", "MFS file system gzip-compressed data", "application/", "KOffice KPresenter Presentation", /^application\/x-(kontour|kpresenter|kspread|kword)$/
	];

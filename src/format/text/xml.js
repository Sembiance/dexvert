...
const _XML_MAGIC = [
	...
	"Windows application Manifest", "OSTA.org MusicPhotoVideo", "BlackBerry Application Loader", "Viewpoint MetaStream scene", "FlashDevelop ActionScript 3 Project", "Windows application Manifest (generic)", "Morpheus layout - project",
	"Wink Flash Preloader", "Wink Flash Control bar", "MAME Hash", "openMSX machine/device configuration", "ActiveReports Report (UTF-8)", "Papyrus X DB XML", /^VOTable$/, "Audacity Project",
	/^fmt\/(205|243|475|570|896|979|983|986|1134|1219|1357|1474|1677|1729|1776|1796|1825)( |$)/, /^x-fmt\/227( |$)/
];
export {_XML_MAGIC};

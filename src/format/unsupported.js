...
export default
{
	archive :
	{
		...
		relpackPacked                 : {name : "Relpack Packed", magic : ["Packer: Relpack(1.0)[by TurboPower Software]"]},
	...
	other :
	{
		...
		pascalCompiledUnit               : {name : "Pascal Compiled Unit", ext : [".tpu", ".ppu"], magic : ["Borland Turbo Pascal compiled Unit", "FreePascal compiled Unit", "Pascal unit", /^(Borland )?Turbo Pascal [\d. ]+(compiled )?Unit/]},
		...
		typeLibrary                      : {name : "Type Library", ext : [".tlb"], magic : [/^Type Library \(Type[12]\)$/, /^fmt\/1601( |$)/]},

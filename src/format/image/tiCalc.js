...
export class tiCalc extends Format
{
	...
	magic      = ["TI bitmap", "Texas Instruments file format", /^TI-.* Graphing Calculator \(picture\)$/];
	converters = ["deark[module:tivariable]", "nconvert", `abydosconvert[format:${this.mimeType}]`, "tomsViewer[matchType:magic][hasExtMatch]"];
}

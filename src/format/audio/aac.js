...
export class aac extends Format
{
	...
	ext            = [".aac", ".m4a", ".mp4", ".ima"];
	forbidExtMatch = [".ima"];
	magic          = ["MPEG-4 LC-AAC Audio", "MPEG ADTS, AAC", "MPEG-2 LC-AAC Audio", "AAC Audio", "ISO Media, Apple iTunes ALAC/AAC-LC", "audio/aac", "audio/mp4", "raw ADTS AAC (Advanced Audio Coding) (aac)", /^fmt\/2094( |$)/];

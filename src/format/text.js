...
export default
{
	text :
	{
		...
		portableBridgeNotationn            : {name : "Portable Bridge Notation", ext : [".pbn"], magic : ["Portable Bridge Notation"], weakMagic : true},
		...
		fltxUserInterfaceDesigner                : {name : "FLTK User Interface Designer", ext : [".fl"], magic : ["application/x-fluid"]},
		...
		php                                      : {name : "PHP Script", website : "http://fileformats.archiveteam.org/wiki/PHP", ext : [".php", ".phps", ".php3t", ".tst"], magic : ["PHP source", "PHP script", "application/x-php", /^PHP core test/], weakMagic : true},
		...
		qtUserInterface                          : {name : "Qt User Interface", ext : [".ui"], magic : ["Qt User Interface"], weakMagic : true},
		...
		rubySource                               : {name : "Ruby Source", ext : [".rb", ".template"], magic : ["Ruby script", "Ruby script text executable", "application/x-ruby"], weakMagic : true},
		...
		bitTorrentFile                          : {name : "BitTorrent file", ext : [".torrent"], magic : ["BitTorrent file", /^Torrent( \(trackerless\))?$/]},
		...
		chiWriterDocument                       : {name : "ChiWriter document", ext : [".chi"], magic : ["ChiWriter document", /^ChiWriter file/]},
		...
		esriArcInfoExport                       : {name : "ESRI Arc/Info Export", ext : [".e00"], magic : [/^x-fmt\/226( |$)/]},
		esriArcInfoInterchangeFormat            : {name : "ESRI Arc/Info interchange format", ext : [".e00", ".x00"], magic : ["ESRI Arc/Info interchange format"]},
		...
		frameMakerDictionaryText                : {name : "FrameMaker Dictionary text", ext : [".brt"], magic : ["FrameMaker Dictionary text"]},
		frameMakerHyphensDictionary             : {name : "FrameMaker hyphens dictionary", ext : [".brt"], magic : ["FrameMaker hyphens dictionary"]},
		...
		gerber                                  : {name : "Gerber", ext : [".gbx", ".gbr", ".gb"], magic : ["Gerber format", "application/vnd.gerber"], weakMagic : true},
		...
		lightscapeView                          : {name : "Lightscape View", ext : [".dv"], magic : ["Lightscape View"]},
		...
		mozillaMorkDatabase                     : {name : "Mozilla Mork database", ext : [".dat"], magic : [/Mozilla Mork database/]},
		...
		pemCertificate                          : {name : "PEM Certificate/Request", ext : [".cer", ".pem"], magic : ["PEM certificate", "Internet Security Certificate", "Certificate Signing Request", "application/pkix-cert+pem"], website : "http://fileformats.archiveteam.org/wiki/PEM_encoded_certificate"},
		pemPrivateKey                           : {name : "PEM private key", ext : [".pem"], magic : ["ASCII armored RSA Private Key", "application/x-pem-key", /^PEM ([DR]SA|PKCS8) private key/, /^OpenSSH private key/, /^application\/.+\+pem$/], website : "http://fileformats.archiveteam.org/wiki/PEM_encoded_RSA_private_key"},
		...
		sshPublicKey                            : {name : "SSH Public key", ext : [".pub"], magic : [/^SSH-.+ Public key/, "SSH/SECSH Public Key File Format", /^OpenSSH RSA public key/], weakMagic : true},
		...
		subStationAlphaSubtitle                 : {name : "SubStation Alpha Subtitle", ext : [".ssa", ".ass"], magic : ["SubStation Alpha Subtitle", "text/x-ssa"], weakMagic : true},
		...
		text602Document                         : {name : "Text602 document", ext : [".602"], magic : ["Text602 document", "T602 document data", "application/x-t602"], weakMagic : true},

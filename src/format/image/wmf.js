...
export class wmf extends Format
{
	...
	metaProvider = ["image"];
	converters   = ["wmf2svg", "uniconvertor", "soffice[outType:svg]", "convert", "keyViewPro", "corelDRAW", "hiJaakExpress", "corelPhotoPaint", "picturePublisher", "canvas[matchType:magic][nonRaster]"];
}

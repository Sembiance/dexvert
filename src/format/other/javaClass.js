...
export class javaClass extends Format
{
	...
	idMeta         = ({macFileType, macFileCreator}) => (macFileType==="Clss" && ["CWIE", "JAVA", "MWZP"].includes(macFileCreator)) || (["clss", "CLAS", "COåk"].includes(macFileType) && ["java", "Rstr", "Javc"].includes(macFileCreator));

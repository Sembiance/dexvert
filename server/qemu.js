...
const OS =
{
	...
	winxp    : { ram : "2G", cores : 2, extraArgs : ["-nodefaults", "-vga", "cirrus"] },
...
Object.keys(OS).multiSort([v => SUBNET_ORDER.indexOf(v)]).forEach(v => { OS[v].subnet = BASE_SUBNET + SUBNET_ORDER.indexOf(v); });

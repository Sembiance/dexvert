...
export default
{
	text :
	{
		...
		luaScript                                : {name : "Lua script", ext : [".lua"], magic : ["Lua script text executable", "Shell Skript: '/usr/bin/lua"]},
		...
		qtTranslationSource                      : {name : "Qt Translation Source", ext : [".ts"], magic : ["Qt Translation Source"], weakMagic : true},
		...
		iCalendar                               : {name : "iCalendar/vCalendar", ext : [".ics", ".vcf"], magic : ["iCalendar - vCalendar", "iCalendar Alarm", /^iCalendar calendar file/, /^vCalendar calendar file/, /^fmt\/388( |$)/]},
		...
		kdeConfigFile                           : {name : "KDE config file", ext : [".kdelnk"], magic : ["KDE config file", "KDE desktop Link", "KDevelop Project (with rem)"]},
		...
		pemPrivateKey                           : {name : "PEM private key", ext : [".pem"], magic : ["ASCII armored RSA Private Key", /^PEM ([DR]SA|PKCS8) private key/, /^OpenSSH private key/], website : "http://fileformats.archiveteam.org/wiki/PEM_encoded_RSA_private_key"},
		...
		scSpreadsheetCalculatorSpreadsheet      : {name : "sc Spreadsheet Calculator spreadsheet", ext : [".sc", ".ast"], magic : ["sc Spreadsheet Calculator spreadsheet", "sc spreadsheet file"], weakMagic : ["sc spreadsheet file"]},
		...
		sshRSAPublicKey                         : {name : "SSH-RSA Public key", ext : [".pub"], magic : ["SSH-RSA Public key", /^OpenSSH RSA public key/], weakMagic : true},
		...
		subStationAlphaSubtitle                 : {name : "SubStation Alpha Subtitle", ext : [".ssa", ".ass"], magic : ["SubStation Alpha Subtitle"], weakMagic : true},
		...
		windowsMediaPlayerPlaylist              : {name : "Windows Media Player playlist", ext : [".wpl"], magic : ["Windows Media Player playlist", /^fmt\/589( |$)/]},

...
const _XML_MAGIC = [
	...
	"Vikon Skeleton template", "Chemical Markup Language XML document", "m0n0wall configuration", "MLT XML document", "Jahshaka Scene File", "ksudoku puzzle", /^Linden (avatar|skeleton) definition/,

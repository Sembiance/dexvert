...
export class mng extends Format
{
	...
	magic        = ["Multiple-image Network Graphics bitmap", "MNG video data", "video/x-mng", /^Multiple Network Graphics (\(Interlaced\) )?:mng:/, "deark: png (MNG)", "archive:MngOpener", "image:MngFormat (MNG)", /^fmt\/528( |$)/];
	metaProvider = ["image"];

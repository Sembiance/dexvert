...
export class cdr extends Format
{
	...
	ext            = [".cdr", ".cdt", ".cdx", ".cpx"];
	forbidExtMatch = [".cpx"];
	magic          = ["CorelDraw Document", "CorelDraw Drawing", "CorelDRAW for OS/2 drawing", "CorelDraw compressed format", /RIFF Datei: unbekannter Typ 'CDR[ \d]'/, /^fmt\/(464|466)( |$)/, /^x-fmt\/(31|36|291|379)( |$)/];
	converters     = [
		// vector
		"scribus",
